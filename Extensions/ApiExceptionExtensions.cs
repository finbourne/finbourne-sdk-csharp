...
namespace Finbourne.Sdk.Extensions
{
    ...
    public static class ApiExceptionExtensions
    {
        ...
        /// In case the ErrorContent object that gets returned is not a valid deserializable LusidProblemDetails JSON, a null be returned
        /// </summary>
        /// <param name="rawContent">Serialised string that contains might contain LusidProblemDetails</param>
        /// <returns>Further details of the problem</returns>
        public static LusidProblemDetails DeserializeLusidProblemDetails(string rawContent)
        {
            try
            {
                return JsonConvert.DeserializeObject<LusidProblemDetails>(rawContent, new PropertyBasedConverter());
            }
            catch (JsonException)
            {
                return null;
