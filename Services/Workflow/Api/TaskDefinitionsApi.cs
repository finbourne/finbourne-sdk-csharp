...
namespace Finbourne.Sdk.Services.Workflow.Api
{
    ...
    public partial class TaskDefinitionsApi : ITaskDefinitionsApi
    {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfTaskDefinition> localVarResponse = ListTaskDefinitionsWithHttpInfo(asAt, filter, sortBy, limit, page, opts: opts);
            return localVarResponse.Data;
        }
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfTaskDefinition> localVarResponse = await ListTaskDefinitionsWithHttpInfoAsync(asAt, filter, sortBy, limit, page, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
