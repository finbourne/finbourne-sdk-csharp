...
namespace Finbourne.Sdk.Services.Insights.Model
{
    ...
    public partial class AuditEntry : IEquatable<AuditEntry>, IValidatableObject
    {
        /// <summary>
        ...
        public AuditEntry(string id = default(string), DateTimeOffset date = default(DateTimeOffset), AuditProcess process = default(AuditProcess), AuditData data = default(AuditData), List<AuditEntryNote> notes = default(List<AuditEntryNote>))
        {
            ...
            if (process == null)
            {
                throw new ArgumentNullException("process is a required property for AuditEntry and cannot be null");
            }
            this.Process = process;
            // to ensure "data" is required (not null)
            if (data == null)
            {
                throw new ArgumentNullException("data is a required property for AuditEntry and cannot be null");
            }
            this.Data = data;
            this.Notes = notes;
        }
