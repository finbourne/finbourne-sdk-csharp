...
namespace Finbourne.Sdk.Services.Insights.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueriedRequestLog")]
    public partial class QueriedRequestLog : IEquatable<QueriedRequestLog>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueriedRequestLog" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueriedRequestLog() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueriedRequestLog" /> class.
        /// </summary>
        ...
        /// <param name="operation">The API operation invoked by the request. (required).</param>
        ...
        /// <param name="outcome">The outcome of the request: Completed, Errored or Failed..</param>
        /// <param name="duration">The duration of the request in milliseconds..</param>
        /// <param name="httpStatusCode">The status code of the request..</param>
        ...
        public QueriedRequestLog(DateTimeOffset timestamp = default(DateTimeOffset), string id = default(string), string application = default(string), string operation = default(string), string sessionId = default(string), string verb = default(string), string url = default(string), string domain = default(string), string user = default(string), string userType = default(string), string outcome = default(string), decimal? duration = default(decimal?), int? httpStatusCode = default(int?), string errorCode = default(string), string sdkLanguage = default(string), string sdkVersion = default(string), string sourceApplication = default(string), List<string> correlationId = default(List<string>), string impersonatingUser = default(string), List<Link> links = default(List<Link>))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for QueriedRequestLog and cannot be null");
            }
            this.Id = id;
            // to ensure "application" is required (not null)
            if (application == null)
            {
                throw new ArgumentNullException("application is a required property for QueriedRequestLog and cannot be null");
            }
            this.Application = application;
            // to ensure "operation" is required (not null)
            if (operation == null)
            {
                throw new ArgumentNullException("operation is a required property for QueriedRequestLog and cannot be null");
            }
        ...
        {
            return this.Equals(input as QueriedRequestLog);
        }

        /// <summary>
        /// Returns true if QueriedRequestLog instances are equal
        /// </summary>
        /// <param name="input">Instance of QueriedRequestLog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueriedRequestLog input)
        {
            if (input == null)
            {
                return false;
