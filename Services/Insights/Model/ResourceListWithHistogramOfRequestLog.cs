...
namespace Finbourne.Sdk.Services.Insights.Model
{
    ...
    public partial class ResourceListWithHistogramOfRequestLog : IEquatable<ResourceListWithHistogramOfRequestLog>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListWithHistogramOfRequestLog(Histogram histogram = default(Histogram), List<RequestLog> values = default(List<RequestLog>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListWithHistogramOfRequestLog and cannot be null");
            }
            this.Values = values;
