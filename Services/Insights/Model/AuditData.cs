...
namespace Finbourne.Sdk.Services.Insights.Model
{
    ...
    public partial class AuditData : IEquatable<AuditData>, IValidatableObject
    {
        /// <summary>
        ...
        public AuditData(string action = default(string), string category = default(string), string userId = default(string), string message = default(string), Resource resource = default(Resource), string detailsType = default(string), Object details = default(Object))
        {
            ...
            if (action == null)
            {
                throw new ArgumentNullException("action is a required property for AuditData and cannot be null");
            }
            this.Action = action;
            // to ensure "category" is required (not null)
            if (category == null)
            {
                throw new ArgumentNullException("category is a required property for AuditData and cannot be null");
            }
