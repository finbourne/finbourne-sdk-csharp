...
namespace Finbourne.Sdk.Services.Insights.Api
{
    ...
    public interface IAuditingApiSync : IApiAccessor
    {
        ...
        Finbourne.Sdk.Client.ApiResponse<AuditEntry> CreateEntryWithHttpInfo(CreateAuditEntry? createAuditEntry = default(CreateAuditEntry?), int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
        ...
        Finbourne.Sdk.Client.ApiResponse<ResourceListOfAuditProcessSummary> GetProcessesWithHttpInfo(int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
        ...
        Finbourne.Sdk.Client.ApiResponse<ScrollableCollectionOfAuditEntry> ListEntriesWithHttpInfo(string? filter = default(string?), string? sortBy = default(string?), int? size = default(int?), string? state = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface IAuditingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<ResourceListOfAuditProcessSummary>> GetProcessesWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// [EARLY ACCESS] ListEntries: Get the audit entries.
        /// </summary>
        /// <remarks>
    ...
    public partial class AuditingApi : IAuditingApi
    {
        ...
        /// <returns></returns>
        public AuditingApi(Finbourne.Sdk.Client.Configuration configuration)
        {
        ...
        public AuditingApi(Finbourne.Sdk.Client.ISynchronousClient client, Finbourne.Sdk.Client.IAsynchronousClient asyncClient, Finbourne.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<AuditEntry> localVarResponse = CreateEntryWithHttpInfo(createAuditEntry, opts: opts);
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of AuditEntry</returns>
        public Finbourne.Sdk.Client.ApiResponse<AuditEntry> CreateEntryWithHttpInfo(CreateAuditEntry? createAuditEntry = default(CreateAuditEntry?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            localVarRequestOptions.Operation = "AuditingApi.CreateEntry";
            ...
            var localVarResponse = this.Client.Post<AuditEntry, AbstractOpenAPISchema>("/insights/api/auditing/entries", localVarRequestOptions, this.Configuration);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<AuditEntry> localVarResponse = await CreateEntryWithHttpInfoAsync(createAuditEntry, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<AuditEntry>> CreateEntryWithHttpInfoAsync(CreateAuditEntry? createAuditEntry = default(CreateAuditEntry?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<AuditEntry, AbstractOpenAPISchema>("/insights/api/auditing/entries", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ResourceListOfAuditProcessSummary> localVarResponse = GetProcessesWithHttpInfo(opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of ResourceListOfAuditProcessSummary</returns>
        public Finbourne.Sdk.Client.ApiResponse<ResourceListOfAuditProcessSummary> GetProcessesWithHttpInfo(int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            Finbourne.Sdk.Client.RequestOptions localVarRequestOptions = new Finbourne.Sdk.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "AuditingApi.GetProcesses";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ResourceListOfAuditProcessSummary, AbstractOpenAPISchema>("/insights/api/auditing/processes", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ResourceListOfAuditProcessSummary> localVarResponse = await GetProcessesWithHttpInfoAsync(operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (ResourceListOfAuditProcessSummary)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<ResourceListOfAuditProcessSummary>> GetProcessesWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListOfAuditProcessSummary, AbstractOpenAPISchema>("/insights/api/auditing/processes", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ScrollableCollectionOfAuditEntry> localVarResponse = ListEntriesWithHttpInfo(filter, sortBy, size, state, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of ScrollableCollectionOfAuditEntry</returns>
        public Finbourne.Sdk.Client.ApiResponse<ScrollableCollectionOfAuditEntry> ListEntriesWithHttpInfo(string? filter = default(string?), string? sortBy = default(string?), int? size = default(int?), string? state = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            Finbourne.Sdk.Client.RequestOptions localVarRequestOptions = new Finbourne.Sdk.Client.RequestOptions();
            ...
            if (size != null)
            {
                localVarRequestOptions.QueryParameters.Add(Finbourne.Sdk.Client.ClientUtils.ParameterToMultiMap("", "size", size));
            }
            if (state != null)
            {
                localVarRequestOptions.QueryParameters.Add(Finbourne.Sdk.Client.ClientUtils.ParameterToMultiMap("", "state", state));
            }

            localVarRequestOptions.Operation = "AuditingApi.ListEntries";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ScrollableCollectionOfAuditEntry, AbstractOpenAPISchema>("/insights/api/auditing/entries", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ScrollableCollectionOfAuditEntry> localVarResponse = await ListEntriesWithHttpInfoAsync(filter, sortBy, size, state, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<ScrollableCollectionOfAuditEntry>> ListEntriesWithHttpInfoAsync(string? filter = default(string?), string? sortBy = default(string?), int? size = default(int?), string? state = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ScrollableCollectionOfAuditEntry, AbstractOpenAPISchema>("/insights/api/auditing/entries", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
