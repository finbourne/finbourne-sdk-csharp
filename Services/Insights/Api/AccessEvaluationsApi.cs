...
namespace Finbourne.Sdk.Services.Insights.Api
{
    ...
    public interface IAccessEvaluationsApiSync : IApiAccessor
    {
        ...
        Finbourne.Sdk.Client.ApiResponse<AccessEvaluationLog> GetAccessEvaluationLogWithHttpInfo(string id, int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
    ...
    public interface IAccessEvaluationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<AccessEvaluationLog>> GetAccessEvaluationLogWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// [EARLY ACCESS] ListAccessEvaluationLogs: List the logs for access evaluations.
        /// </summary>
        /// <remarks>
    ...
    public partial class AccessEvaluationsApi : IAccessEvaluationsApi
    {
        ...
        /// <returns></returns>
        public AccessEvaluationsApi(Finbourne.Sdk.Client.Configuration configuration)
        {
        ...
        public AccessEvaluationsApi(Finbourne.Sdk.Client.ISynchronousClient client, Finbourne.Sdk.Client.IAsynchronousClient asyncClient, Finbourne.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<AccessEvaluationLog> localVarResponse = GetAccessEvaluationLogWithHttpInfo(id, opts: opts);
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of AccessEvaluationLog</returns>
        public Finbourne.Sdk.Client.ApiResponse<AccessEvaluationLog> GetAccessEvaluationLogWithHttpInfo(string id, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new ArgumentNullException("Missing required parameter 'id' when calling AccessEvaluationsApi->GetAccessEvaluationLog");
            }
            ...
            var localVarResponse = this.Client.Get<AccessEvaluationLog, AbstractOpenAPISchema>("/insights/api/access/{id}", localVarRequestOptions, this.Configuration);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<AccessEvaluationLog> localVarResponse = await GetAccessEvaluationLogWithHttpInfoAsync(id, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (AccessEvaluationLog)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<AccessEvaluationLog>> GetAccessEvaluationLogWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<AccessEvaluationLog, AbstractOpenAPISchema>("/insights/api/access/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ResourceListWithHistogramOfAccessEvaluationLog> localVarResponse = ListAccessEvaluationLogsWithHttpInfo(startAt, endAt, filter, sortBy, limit, page, histogramInterval, opts: opts);
            return localVarResponse.Data;
        }
        ...
        public Finbourne.Sdk.Client.ApiResponse<ResourceListWithHistogramOfAccessEvaluationLog> ListAccessEvaluationLogsWithHttpInfo(DateTimeOffset? startAt = default(DateTimeOffset?), DateTimeOffset? endAt = default(DateTimeOffset?), string? filter = default(string?), string? sortBy = default(string?), int? limit = default(int?), string? page = default(string?), string? histogramInterval = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ResourceListWithHistogramOfAccessEvaluationLog, AbstractOpenAPISchema>("/insights/api/access", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ResourceListWithHistogramOfAccessEvaluationLog> localVarResponse = await ListAccessEvaluationLogsWithHttpInfoAsync(startAt, endAt, filter, sortBy, limit, page, histogramInterval, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<ResourceListWithHistogramOfAccessEvaluationLog>> ListAccessEvaluationLogsWithHttpInfoAsync(DateTimeOffset? startAt = default(DateTimeOffset?), DateTimeOffset? endAt = default(DateTimeOffset?), string? filter = default(string?), string? sortBy = default(string?), int? limit = default(int?), string? page = default(string?), string? histogramInterval = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<ResourceListWithHistogramOfAccessEvaluationLog, AbstractOpenAPISchema>("/insights/api/access", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
