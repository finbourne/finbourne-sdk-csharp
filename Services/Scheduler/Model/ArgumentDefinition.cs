...
namespace Finbourne.Sdk.Services.Scheduler.Model
{
    ...
    public partial class ArgumentDefinition : IEquatable<ArgumentDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        public ArgumentDefinition(string dataType = default(string), bool required = default(bool), string description = default(string), int order = default(int), string constraints = default(string), string passedAs = default(string), string defaultValue = default(string))
        {
            ...
            if (dataType == null)
            {
                throw new ArgumentNullException("dataType is a required property for ArgumentDefinition and cannot be null");
            }
            ...
            if (passedAs == null)
            {
                throw new ArgumentNullException("passedAs is a required property for ArgumentDefinition and cannot be null");
            }
