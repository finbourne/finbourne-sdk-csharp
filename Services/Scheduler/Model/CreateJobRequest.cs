...
namespace Finbourne.Sdk.Services.Scheduler.Model
{
    ...
    public partial class CreateJobRequest : IEquatable<CreateJobRequest>, IValidatableObject
    {
        ...
        public CreateJobRequest(ResourceId jobId = default(ResourceId), string name = default(string), string author = default(string), DateTimeOffset dateCreated = default(DateTimeOffset), string description = default(string), string imageName = default(string), string imageTag = default(string), int ttl = default(int), string minCpu = default(string), string maxCpu = default(string), string minMemory = default(string), string maxMemory = default(string), Dictionary<string, ArgumentDefinition> argumentDefinitions = default(Dictionary<string, ArgumentDefinition>), string commandLineArgumentSeparator = default(string), RequiredResources requiredResources = default(RequiredResources))
        {
            // to ensure "jobId" is required (not null)
            if (jobId == null)
            {
                throw new ArgumentNullException("jobId is a required property for CreateJobRequest and cannot be null");
            }
            this.JobId = jobId;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateJobRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CreateJobRequest and cannot be null");
            }
            this.Description = description;
            // to ensure "imageName" is required (not null)
            if (imageName == null)
            {
                throw new ArgumentNullException("imageName is a required property for CreateJobRequest and cannot be null");
            }
            this.ImageName = imageName;
            // to ensure "imageTag" is required (not null)
            if (imageTag == null)
            {
                throw new ArgumentNullException("imageTag is a required property for CreateJobRequest and cannot be null");
            }
            this.ImageTag = imageTag;
            // to ensure "argumentDefinitions" is required (not null)
            if (argumentDefinitions == null)
            {
                throw new ArgumentNullException("argumentDefinitions is a required property for CreateJobRequest and cannot be null");
            }
