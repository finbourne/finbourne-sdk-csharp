...
namespace Finbourne.Sdk.Services.Scheduler.Model
{
    /// <summary>
    /// Represent a specific job&#39;s run
    /// </summary>
    [DataContract(Name = "JobRunResult")]
    public partial class JobRunResult : IEquatable<JobRunResult>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="imageName">Name of the container image the job ran with.</param>
        /// <param name="imageTag">Tag of the container image the job ran with.</param>
        /// <param name="ttl">TTL (in seconds) that was in effect for this job run.</param>
        /// <param name="userId">UserId of the user that this run was executed as. For manual runs this is the triggering user (or the impersonated user if UseAsAuth was provided); for scheduled runs this is the owner of the Schedule.</param>
        public JobRunResult(string consoleOutputUrl = default(string), string runId = default(string), ResourceId jobId = default(ResourceId), string name = default(string), DateTimeOffset initialisedDate = default(DateTimeOffset), DateTimeOffset? startDate = default(DateTimeOffset?), DateTimeOffset? endDate = default(DateTimeOffset?), Dictionary<string, string> arguments = default(Dictionary<string, string>), Dictionary<string, string> environmentVariables = default(Dictionary<string, string>), string jobStatus = default(string), string description = default(string), ResourceId scheduleId = default(ResourceId), string resultUrl = default(string), string manuallyTriggeredBy = default(string), string message = default(string), string imageName = default(string), string imageTag = default(string), int ttl = default(int), string userId = default(string))
        {
        ...
        /// </summary>
        /// <value>Name of the container image the job ran with</value>
        ...
        /// </summary>
        /// <value>Tag of the container image the job ran with</value>
        ...
        /// </summary>
        /// <value>TTL (in seconds) that was in effect for this job run</value>
        ...
        /// </summary>
        /// <value>UserId of the user that this run was executed as. For manual runs this is the triggering user (or the impersonated user if UseAsAuth was provided); for scheduled runs this is the owner of the Schedule</value>
