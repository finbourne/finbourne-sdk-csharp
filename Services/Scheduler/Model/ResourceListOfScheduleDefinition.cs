...
namespace Finbourne.Sdk.Services.Scheduler.Model
{
    ...
    public partial class ResourceListOfScheduleDefinition : IEquatable<ResourceListOfScheduleDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfScheduleDefinition(List<ScheduleDefinition> values = default(List<ScheduleDefinition>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfScheduleDefinition and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
