...
namespace Finbourne.Sdk.Services.Scheduler.Model
{
    ...
    public partial class UploadImageInstructions : IEquatable<UploadImageInstructions>, IValidatableObject
    {
        /// <summary>
        ...
        public UploadImageInstructions(string dockerLoginCommand = default(string), string buildVersionedDockerImageCommand = default(string), string tagVersionedDockerImageCommand = default(string), string pushVersionedDockerImageCommand = default(string), string tagLatestDockerImageCommand = default(string), string pushLatestDockerImageCommand = default(string), DateTimeOffset? expiryTime = default(DateTimeOffset?))
        {
            ...
            {
                throw new ArgumentNullException("dockerLoginCommand is a required property for UploadImageInstructions and cannot be null");
            }
            this.DockerLoginCommand = dockerLoginCommand;
            // to ensure "buildVersionedDockerImageCommand" is required (not null)
            if (buildVersionedDockerImageCommand == null)
            {
                throw new ArgumentNullException("buildVersionedDockerImageCommand is a required property for UploadImageInstructions and cannot be null");
            }
            ...
            if (tagVersionedDockerImageCommand == null)
            {
                throw new ArgumentNullException("tagVersionedDockerImageCommand is a required property for UploadImageInstructions and cannot be null");
            }
            ...
            if (pushVersionedDockerImageCommand == null)
            {
                throw new ArgumentNullException("pushVersionedDockerImageCommand is a required property for UploadImageInstructions and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "dockerLoginCommand", IsRequired = true, EmitDefaultValue = true)]
        public string DockerLoginCommand { get; set; }

        /// <summary>
        /// Gets or Sets BuildVersionedDockerImageCommand
        /// </summary>
        [DataMember(Name = "buildVersionedDockerImageCommand", IsRequired = true, EmitDefaultValue = true)]
        public string BuildVersionedDockerImageCommand { get; set; }

        /// <summary>
        /// Gets or Sets TagVersionedDockerImageCommand
        /// </summary>
        [DataMember(Name = "tagVersionedDockerImageCommand", IsRequired = true, EmitDefaultValue = true)]
        public string TagVersionedDockerImageCommand { get; set; }

        /// <summary>
        /// Gets or Sets PushVersionedDockerImageCommand
        /// </summary>
        [DataMember(Name = "pushVersionedDockerImageCommand", IsRequired = true, EmitDefaultValue = true)]
