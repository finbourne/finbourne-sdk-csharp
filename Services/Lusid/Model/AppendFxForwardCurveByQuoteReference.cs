...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class AppendFxForwardCurveByQuoteReference : AppendMarketData, IEquatable<AppendFxForwardCurveByQuoteReference>, IValidatableObject
    {
        ...
        public AppendFxForwardCurveByQuoteReference(string tenor = default(string), Dictionary<string, string> quoteReference = default(Dictionary<string, string>), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("marketDataType is a required property for AppendFxForwardCurveByQuoteReference and must be a defined value");
            }
