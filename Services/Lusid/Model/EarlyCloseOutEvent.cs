...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class EarlyCloseOutEvent : InstrumentEvent, IEquatable<EarlyCloseOutEvent>, IValidatableObject
    {
        ...
        public EarlyCloseOutEvent(decimal closeOutAmount = default(decimal), string closeOutCcy = default(string), decimal? closeOutToOtherRate = default(decimal?), DateTimeOffset effectiveDate = default(DateTimeOffset), decimal? closeOutTolerance = default(decimal?), decimal? otherAmount = default(decimal?), string otherCcy = default(string), decimal? otherToCloseOutRate = default(decimal?), string settlementCcy = default(string), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for EarlyCloseOutEvent and must be a defined value");
            }
