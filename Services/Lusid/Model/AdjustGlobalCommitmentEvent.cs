...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class AdjustGlobalCommitmentEvent : InstrumentEvent, IEquatable<AdjustGlobalCommitmentEvent>, IValidatableObject
    {
        ...
        public AdjustGlobalCommitmentEvent(decimal amount = default(decimal), DateTimeOffset date = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for AdjustGlobalCommitmentEvent and must be a defined value");
            }
