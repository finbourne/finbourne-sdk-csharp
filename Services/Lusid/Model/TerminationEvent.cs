...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class TerminationEvent : InstrumentEvent, IEquatable<TerminationEvent>, IValidatableObject
    {
        ...
        public TerminationEvent(DateTimeOffset effectiveDate = default(DateTimeOffset), DateTimeOffset settlementDate = default(DateTimeOffset), string settlementCurrency = default(string), string triggeringEventType = default(string), string triggeringEventId = default(string), string settlementMethod = default(string), decimal? assetSettlementAmount = default(decimal?), decimal? fundingAccruedAmount = default(decimal?), decimal? terminationAmount = default(decimal?), decimal? terminationPrice = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
        ...
        /// </summary>
        /// <value>The basis on which the asset-side settlement amount is computed, determined by the trigger. Required.                Supported string (enumeration) values are: [CurrentNotionalPlusAccrued, CashOfferPlusAccrued, CashOfferPlusRealAccrued, FairValue, CashOffer, PriceReturn]. Available values: CurrentNotionalPlusAccrued, CashOfferPlusAccrued, CashOfferPlusRealAccrued, FairValue, CashOffer, PriceReturn.</value>
