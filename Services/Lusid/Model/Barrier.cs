...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class Barrier : IEquatable<Barrier>, IValidatableObject
    {
        /// <summary>
        ...
        public Barrier(string direction = default(string), decimal level = default(decimal), string monitoring = default(string), string type = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for Barrier and cannot be null");
            }
            this.Type = type;
