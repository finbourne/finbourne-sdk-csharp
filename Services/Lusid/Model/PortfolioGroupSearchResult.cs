...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PortfolioGroupSearchResult : IEquatable<PortfolioGroupSearchResult>, IValidatableObject
    {
        /// <summary>
        ...
        public PortfolioGroupSearchResult(string href = default(string), ResourceId id = default(ResourceId), string displayName = default(string), string description = default(string), DateTimeOffset created = default(DateTimeOffset), List<ResourceId> portfolios = default(List<ResourceId>), List<ResourceId> subGroups = default(List<ResourceId>), ModelVersion varVersion = default(ModelVersion), List<Link> links = default(List<Link>))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PortfolioGroupSearchResult and cannot be null");
            }
            this.Id = id;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for PortfolioGroupSearchResult and cannot be null");
            }
