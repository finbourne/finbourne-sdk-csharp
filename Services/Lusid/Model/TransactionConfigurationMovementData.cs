...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class TransactionConfigurationMovementData : IEquatable<TransactionConfigurationMovementData>, IValidatableObject
    {
        ...
        public TransactionConfigurationMovementData(MovementTypesEnum movementTypes = default(MovementTypesEnum), string side = default(string), int direction = default(int), Dictionary<string, PerpetualProperty> properties = default(Dictionary<string, PerpetualProperty>), List<TransactionPropertyMapping> mappings = default(List<TransactionPropertyMapping>), string name = default(string), List<string> movementOptions = default(List<string>))
        {
            ...
            {
                throw new ArgumentException("movementTypes is a required property for TransactionConfigurationMovementData and must be a defined value");
            }
            ...
            if (side == null)
            {
                throw new ArgumentNullException("side is a required property for TransactionConfigurationMovementData and cannot be null");
            }
            this.Side = side;
