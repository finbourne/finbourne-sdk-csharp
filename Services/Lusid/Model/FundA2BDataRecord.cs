...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FundA2BDataRecord")]
    public partial class FundA2BDataRecord : IEquatable<FundA2BDataRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundA2BDataRecord" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FundA2BDataRecord);
        }

        /// <summary>
        /// Returns true if FundA2BDataRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of FundA2BDataRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundA2BDataRecord input)
        {
            if (input == null)
            {
                return false;
