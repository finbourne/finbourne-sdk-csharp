...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class MbsInterestDeferralEvent : InstrumentEvent, IEquatable<MbsInterestDeferralEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MbsInterestDeferralEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MbsInterestDeferralEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MbsInterestDeferralEvent" /> class.
        /// </summary>
        /// <param name="exDate">The ex date (entitlement date) of the interest payment, usually several weeks prior to the payment date.</param>
        /// <param name="paymentDate">The payment date of the interest that is deferred and capitalised.</param>
        /// <param name="currency">The currency in which the interest amount is notated (required).</param>
        /// <param name="interestPerUnit">The interest amount to be deferred and capitalised for each unit of the instrument held on the ex date.</param>
        /// <param name="instrumentEventType">The Type of Event. Available values: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, TriggerEvent, RawVendorEvent, InformationalErrorEvent, BondCouponEvent, DividendReinvestmentEvent, AccumulationEvent, BondPrincipalEvent, DividendOptionEvent, MaturityEvent, FxForwardSettlementEvent, ExpiryEvent, ScripDividendEvent, StockDividendEvent, ReverseStockSplitEvent, CapitalDistributionEvent, SpinOffEvent, MergerEvent, FutureExpiryEvent, SwapCashFlowEvent, SwapPrincipalEvent, CreditPremiumCashFlowEvent, CdsCreditEvent, CdxCreditEvent, MbsCouponEvent, MbsPrincipalEvent, BonusIssueEvent, MbsPrincipalWriteOffEvent, MbsInterestDeferralEvent, MbsInterestShortfallEvent, TenderEvent, CallOnIntermediateSecuritiesEvent, IntermediateSecuritiesDistributionEvent, OptionExercisePhysicalEvent, OptionExerciseCashEvent, ProtectionPayoutCashFlowEvent, TermDepositInterestEvent, TermDepositPrincipalEvent, EarlyRedemptionEvent, FutureMarkToMarketEvent, AdjustGlobalCommitmentEvent, ContractInitialisationEvent, DrawdownEvent, LoanInterestRepaymentEvent, UpdateDepositAmountEvent, LoanPrincipalRepaymentEvent, DepositInterestPaymentEvent, DepositCloseEvent, LoanFacilityContractRolloverEvent, RepurchaseOfferEvent, RepoPartialClosureEvent, RepoCashFlowEvent, FlexibleRepoInterestPaymentEvent, FlexibleRepoCashFlowEvent, FlexibleRepoCollateralEvent, ConversionEvent, FlexibleRepoPartialClosureEvent, FlexibleRepoFullClosureEvent, CapletFloorletCashFlowEvent, EarlyCloseOutEvent, DepositRollEvent, ConsentEvent, DrawingEvent, CapitalGainsDistributionEvent, ExchangeOfferEvent, DutchAuctionEvent, WorthlessEvent, PutRedemptionEvent, LoanFacilityDelayedCompensationPaymentEvent, InterestPaymentEvent, PriorityIssueEvent, ClassActionEvent, BankruptcyEvent, LiquidationPaymentEvent, PartialDefeasanceEvent, SecurityWriteOffEvent, WarrantsExerciseEvent, PariPassuEvent, ChangeEvent, PikBondCouponEvent, PikBondCashCouponEvent, PikBondInterestCapitalisationEvent, PikBondPrincipalEvent, DelistingEvent, PikBondInterestEvent. (required) (default to InstrumentEventTypeEnum.TransitionEvent).</param>
        public MbsInterestDeferralEvent(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal? interestPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for MbsInterestDeferralEvent and cannot be null");
            }
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for MbsInterestDeferralEvent and must be a defined value");
            }
        ...
        /// </summary>
        /// <value>The payment date of the interest that is deferred and capitalised</value>
        ...
        /// </summary>
        /// <value>The interest amount to be deferred and capitalised for each unit of the instrument held on the ex date</value>
        ...
        {
            return this.Equals(input as MbsInterestDeferralEvent);
        }

        /// <summary>
        /// Returns true if MbsInterestDeferralEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of MbsInterestDeferralEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MbsInterestDeferralEvent input)
        {
            if (input == null)
            {
                return false;
