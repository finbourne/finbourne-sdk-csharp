...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PropertyKeyComplianceParameter : ComplianceParameter, IEquatable<PropertyKeyComplianceParameter>, IValidatableObject
    {
        ...
        public PropertyKeyComplianceParameter(string value = default(string), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for PropertyKeyComplianceParameter and must be a defined value");
            }
