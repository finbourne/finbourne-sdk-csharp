...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ChangeEvent : InstrumentEvent, IEquatable<ChangeEvent>, IValidatableObject
    {
        ...
        public ChangeEvent(DateTimeOffset recordDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), NewInstrument newInstrument = default(NewInstrument), UnitsRatio unitsRatio = default(UnitsRatio), string changeType = default(string), string termTarget = default(string), string termTargetIdentifier = default(string), string additionalInformation = default(string), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for ChangeEvent and must be a defined value");
            }
