...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsentDeniedElection")]
    public partial class ConsentDeniedElection : IEquatable<ConsentDeniedElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsentDeniedElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConsentDeniedElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsentDeniedElection" /> class.
        /// </summary>
        ...
        public ConsentDeniedElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for ConsentDeniedElection and cannot be null");
            }
        ...
        {
            return this.Equals(input as ConsentDeniedElection);
        }

        /// <summary>
        /// Returns true if ConsentDeniedElection instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsentDeniedElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsentDeniedElection input)
        {
            if (input == null)
            {
                return false;
