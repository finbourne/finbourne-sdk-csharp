...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpsertInstrumentEventsResponse")]
    public partial class UpsertInstrumentEventsResponse : IEquatable<UpsertInstrumentEventsResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as UpsertInstrumentEventsResponse);
        }

        /// <summary>
        /// Returns true if UpsertInstrumentEventsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsertInstrumentEventsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsertInstrumentEventsResponse input)
        {
            if (input == null)
            {
                return false;
