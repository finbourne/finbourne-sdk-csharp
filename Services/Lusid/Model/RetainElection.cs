...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RetainElection")]
    public partial class RetainElection : IEquatable<RetainElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RetainElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RetainElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RetainElection" /> class.
        /// </summary>
        ...
        public RetainElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for RetainElection and cannot be null");
            }
        ...
        {
            return this.Equals(input as RetainElection);
        }

        /// <summary>
        /// Returns true if RetainElection instances are equal
        /// </summary>
        /// <param name="input">Instance of RetainElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RetainElection input)
        {
            if (input == null)
            {
                return false;
