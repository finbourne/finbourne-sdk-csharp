...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class BondPrincipalEvent : InstrumentEvent, IEquatable<BondPrincipalEvent>, IValidatableObject
    {
        ...
        /// <param name="exDate">Ex-Dividend date of the principal payment.</param>
        /// <param name="paymentDate">Payment date of the principal payment.</param>
        ...
        public BondPrincipalEvent(string currency = default(string), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), decimal? principalPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for BondPrincipalEvent and must be a defined value");
            }
