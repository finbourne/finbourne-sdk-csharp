...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class StockDividendEvent : InstrumentEvent, IEquatable<StockDividendEvent>, IValidatableObject
    {
        ...
        public StockDividendEvent(DateTimeOffset? announcementDate = default(DateTimeOffset?), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), DateTimeOffset? recordDate = default(DateTimeOffset?), decimal? fractionalUnitsCashPrice = default(decimal?), string fractionalUnitsCashCurrency = default(string), UnitsRatio unitsRatio = default(UnitsRatio), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for StockDividendEvent and must be a defined value");
            }
