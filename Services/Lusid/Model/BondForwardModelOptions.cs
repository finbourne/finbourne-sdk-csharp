...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class BondForwardModelOptions : ModelOptions, IEquatable<BondForwardModelOptions>, IValidatableObject
    {
        ...
        public BondForwardModelOptions(string bondForwardProjectionType = default(string), ModelOptionsTypeEnum modelOptionsType = default(ModelOptionsTypeEnum)) : base()
        {
