...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class FlexibleRepoFullClosureEvent : InstrumentEvent, IEquatable<FlexibleRepoFullClosureEvent>, IValidatableObject
    {
        ...
        public FlexibleRepoFullClosureEvent(DateTimeOffset entitlementDate = default(DateTimeOffset), DateTimeOffset settlementDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for FlexibleRepoFullClosureEvent and must be a defined value");
            }
