...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class IndexProjectionDependency : EconomicDependency, IEquatable<IndexProjectionDependency>, IValidatableObject
    {
        ...
        public IndexProjectionDependency(string currency = default(string), string tenor = default(string), string indexName = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base()
        {
