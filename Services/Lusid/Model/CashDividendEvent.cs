...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CashDividendEvent : InstrumentEvent, IEquatable<CashDividendEvent>, IValidatableObject
    {
        ...
        public CashDividendEvent(DateTimeOffset paymentDate = default(DateTimeOffset), DateTimeOffset exDate = default(DateTimeOffset), List<CashElection> cashElections = default(List<CashElection>), DateTimeOffset? announcementDate = default(DateTimeOffset?), DateTimeOffset? recordDate = default(DateTimeOffset?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for CashDividendEvent and must be a defined value");
            }
