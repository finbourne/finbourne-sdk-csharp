...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class AccumulationEvent : InstrumentEvent, IEquatable<AccumulationEvent>, IValidatableObject
    {
        ...
        public AccumulationEvent(DateTimeOffset? announcementDate = default(DateTimeOffset?), string dividendCurrency = default(string), decimal dividendRate = default(decimal), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for AccumulationEvent and must be a defined value");
            }
