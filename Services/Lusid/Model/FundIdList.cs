...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class FundIdList : ReferenceList, IEquatable<FundIdList>, IValidatableObject
    {
        ...
        public FundIdList(List<ResourceId> values = default(List<ResourceId>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("referenceListType is a required property for FundIdList and must be a defined value");
            }
