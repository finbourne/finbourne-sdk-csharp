...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class EquityVolDependency : EconomicDependency, IEquatable<EquityVolDependency>, IValidatableObject
    {
        ...
        public EquityVolDependency(string code = default(string), string domesticCurrency = default(string), string volType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("dependencyType is a required property for EquityVolDependency and must be a defined value");
            }
