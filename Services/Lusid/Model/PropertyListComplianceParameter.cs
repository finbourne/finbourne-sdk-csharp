...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PropertyListComplianceParameter : ComplianceParameter, IEquatable<PropertyListComplianceParameter>, IValidatableObject
    {
        ...
        public PropertyListComplianceParameter(ResourceId value = default(ResourceId), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for PropertyListComplianceParameter and must be a defined value");
            }
