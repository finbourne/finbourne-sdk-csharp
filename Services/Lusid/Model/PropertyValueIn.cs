...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PropertyValueIn : MatchCriterion, IEquatable<PropertyValueIn>, IValidatableObject
    {
        ...
        public PropertyValueIn(string propertyKey = default(string), List<string> value = default(List<string>), CriterionTypeEnum criterionType = default(CriterionTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("criterionType is a required property for PropertyValueIn and must be a defined value");
            }
