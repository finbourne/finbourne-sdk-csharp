...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// AllocationGroup
    /// </summary>
    [DataContract(Name = "AllocationGroup")]
    public partial class AllocationGroup : IEquatable<AllocationGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllocationGroup" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AllocationGroup() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AllocationGroup" /> class.
        /// </summary>
        ...
        public AllocationGroup(List<AllocationGroupClass> classes = default(List<AllocationGroupClass>), string code = default(string), string name = default(string), string description = default(string), string shareClassShortCode = default(string), AllocationMethodProperty apportionmentMethodProperty = default(AllocationMethodProperty), string formula = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for AllocationGroup and cannot be null");
            }
            this.Name = name;
            // to ensure "shareClassShortCode" is required (not null)
            if (shareClassShortCode == null)
            {
                throw new ArgumentNullException("shareClassShortCode is a required property for AllocationGroup and cannot be null");
            }
        ...
        {
            return this.Equals(input as AllocationGroup);
        }

        /// <summary>
        /// Returns true if AllocationGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of AllocationGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllocationGroup input)
        {
            if (input == null)
            {
                return false;
