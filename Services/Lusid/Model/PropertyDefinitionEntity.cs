...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PropertyDefinitionEntity")]
    public partial class PropertyDefinitionEntity : IEquatable<PropertyDefinitionEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyDefinitionEntity" /> class.
        /// </summary>
        ...
        /// <param name="prevailingPropertyDefinition">prevailingPropertyDefinition.</param>
        /// <param name="deletedPropertyDefinition">deletedPropertyDefinition.</param>
        /// <param name="previewedStatus">The status of the previewed entity..</param>
        /// <param name="previewedPropertyDefinition">previewedPropertyDefinition.</param>
        /// <param name="links">links.</param>
        public PropertyDefinitionEntity(string href = default(string), string entityUniqueId = default(string), int? asAtVersionNumber = default(int?), string status = default(string), DateTimeOffset? asAtDeleted = default(DateTimeOffset?), string userIdDeleted = default(string), string requestIdDeleted = default(string), DateTimeOffset? effectiveAtCreated = default(DateTimeOffset?), PropertyDefinition prevailingPropertyDefinition = default(PropertyDefinition), PropertyDefinition deletedPropertyDefinition = default(PropertyDefinition), string previewedStatus = default(string), PropertyDefinition previewedPropertyDefinition = default(PropertyDefinition), List<Link> links = default(List<Link>))
        {
            // to ensure "href" is required (not null)
            if (href == null)
            {
                throw new ArgumentNullException("href is a required property for PropertyDefinitionEntity and cannot be null");
            }
            this.Href = href;
            // to ensure "entityUniqueId" is required (not null)
            if (entityUniqueId == null)
            {
                throw new ArgumentNullException("entityUniqueId is a required property for PropertyDefinitionEntity and cannot be null");
            }
            this.EntityUniqueId = entityUniqueId;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for PropertyDefinitionEntity and cannot be null");
            }
            this.Status = status;
        ...
        /// </summary>
        [DataMember(Name = "prevailingPropertyDefinition", EmitDefaultValue = false)]
        public PropertyDefinition PrevailingPropertyDefinition { get; set; }

        /// <summary>
        /// Gets or Sets DeletedPropertyDefinition
        /// </summary>
        [DataMember(Name = "deletedPropertyDefinition", EmitDefaultValue = false)]
        public PropertyDefinition DeletedPropertyDefinition { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "previewedPropertyDefinition", EmitDefaultValue = false)]
        public PropertyDefinition PreviewedPropertyDefinition { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrevailingPropertyDefinition: ").Append(PrevailingPropertyDefinition).Append("\n");
            sb.Append("  DeletedPropertyDefinition: ").Append(DeletedPropertyDefinition).Append("\n");
            sb.Append("  PreviewedStatus: ").Append(PreviewedStatus).Append("\n");
            sb.Append("  PreviewedPropertyDefinition: ").Append(PreviewedPropertyDefinition).Append("\n");
        ...
        {
            return this.Equals(input as PropertyDefinitionEntity);
        }

        /// <summary>
        /// Returns true if PropertyDefinitionEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyDefinitionEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyDefinitionEntity input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PrevailingPropertyDefinition == input.PrevailingPropertyDefinition ||
                    (this.PrevailingPropertyDefinition != null &&
                    this.PrevailingPropertyDefinition.Equals(input.PrevailingPropertyDefinition))
                ) && 
                (
                    this.DeletedPropertyDefinition == input.DeletedPropertyDefinition ||
                    (this.DeletedPropertyDefinition != null &&
                    this.DeletedPropertyDefinition.Equals(input.DeletedPropertyDefinition))
                ) && 
                (
                ...
                (
                    this.PreviewedPropertyDefinition == input.PreviewedPropertyDefinition ||
                    (this.PreviewedPropertyDefinition != null &&
                    this.PreviewedPropertyDefinition.Equals(input.PreviewedPropertyDefinition))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrevailingPropertyDefinition != null)
                {
                    hashCode = (hashCode * 59) + this.PrevailingPropertyDefinition.GetHashCode();
                }
                if (this.DeletedPropertyDefinition != null)
                {
                    hashCode = (hashCode * 59) + this.DeletedPropertyDefinition.GetHashCode();
                }
                if (this.PreviewedStatus != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedStatus.GetHashCode();
                }
                if (this.PreviewedPropertyDefinition != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedPropertyDefinition.GetHashCode();
                }
                if (this.Links != null)
                {
