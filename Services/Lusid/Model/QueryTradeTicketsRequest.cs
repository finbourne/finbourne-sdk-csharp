...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueryTradeTicketsRequest")]
    public partial class QueryTradeTicketsRequest : IEquatable<QueryTradeTicketsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryTradeTicketsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QueryTradeTicketsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryTradeTicketsRequest" /> class.
        /// </summary>
        /// <param name="asAt">The time of the system at which to query for tradetickets..</param>
        ...
        public QueryTradeTicketsRequest(DateTimeOffset? asAt = default(DateTimeOffset?), DateTimeOffset windowStart = default(DateTimeOffset), DateTimeOffset windowEnd = default(DateTimeOffset), List<PortfolioEntityId> portfolioEntityIds = default(List<PortfolioEntityId>), ResourceId recipeId = default(ResourceId), DateTimeOffset effectiveAt = default(DateTimeOffset))
        {
            ...
            {
                throw new ArgumentNullException("portfolioEntityIds is a required property for QueryTradeTicketsRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The time of the system at which to query for tradetickets.</value>
        ...
        /// </summary>
        /// <value>The Effective date used in the valuation of the tradetickets.</value>
        ...
        {
            return this.Equals(input as QueryTradeTicketsRequest);
        }

        /// <summary>
        /// Returns true if QueryTradeTicketsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryTradeTicketsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryTradeTicketsRequest input)
        {
            if (input == null)
            {
                return false;
