...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CapitalDistributionEvent : InstrumentEvent, IEquatable<CapitalDistributionEvent>, IValidatableObject
    {
        ...
        public CapitalDistributionEvent(DateTimeOffset? announcementDate = default(DateTimeOffset?), List<CashElection> cashElections = default(List<CashElection>), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), DateTimeOffset? recordDate = default(DateTimeOffset?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for CapitalDistributionEvent and must be a defined value");
            }
