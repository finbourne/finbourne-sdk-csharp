...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class LoanPrincipalRepaymentEvent : InstrumentEvent, IEquatable<LoanPrincipalRepaymentEvent>, IValidatableObject
    {
        ...
        public LoanPrincipalRepaymentEvent(DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), List<LapseElection> lapseElections = default(List<LapseElection>), decimal? fraction = default(decimal?), decimal? amount = default(decimal?), bool withInterest = default(bool), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for LoanPrincipalRepaymentEvent and must be a defined value");
            }
