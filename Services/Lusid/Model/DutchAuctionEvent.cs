...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class DutchAuctionEvent : InstrumentEvent, IEquatable<DutchAuctionEvent>, IValidatableObject
    {
        ...
        public DutchAuctionEvent(DateTimeOffset paymentDate = default(DateTimeOffset), DateTimeOffset marketDeadlineDate = default(DateTimeOffset), string currency = default(string), List<TenderOfferElection> tenderOfferElections = default(List<TenderOfferElection>), List<SecurityOfferElection> securityOfferElections = default(List<SecurityOfferElection>), List<CashAndSecurityOfferElection> cashAndSecurityOfferElections = default(List<CashAndSecurityOfferElection>), List<LapseElection> lapseElections = default(List<LapseElection>), List<MixedLotConstituentsElection> mixedLotConstituentsElections = default(List<MixedLotConstituentsElection>), DateTimeOffset? responseDeadlineDate = default(DateTimeOffset?), DateTimeOffset? earlyResponseDeadline = default(DateTimeOffset?), DateTimeOffset? exDate = default(DateTimeOffset?), DateTimeOffset? recordDate = default(DateTimeOffset?), DateTimeOffset? announcementDate = default(DateTimeOffset?), decimal? targetQuantity = default(decimal?), decimal prorationRate = default(decimal), NewInstrument newInstrument = default(NewInstrument), decimal? fractionalUnitsCashPrice = default(decimal?), string fractionalUnitsCashCurrency = default(string), decimal? bidPrice = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
