...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class GroupFilterStepRequest : ComplianceStepRequest, IEquatable<GroupFilterStepRequest>, IValidatableObject
    {
        ...
        public GroupFilterStepRequest(string label = default(string), ComplianceStepTypeRequestEnum complianceStepTypeRequest = default(ComplianceStepTypeRequestEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceStepTypeRequest is a required property for GroupFilterStepRequest and must be a defined value");
            }
