...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppendFxForwardTenorPipsCurveData")]
    [JsonConverter(typeof(JsonSubtypes), "MarketDataType")]
    public partial class AppendFxForwardTenorPipsCurveData : AppendMarketData, IEquatable<AppendFxForwardTenorPipsCurveData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppendFxForwardTenorPipsCurveData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AppendFxForwardTenorPipsCurveData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AppendFxForwardTenorPipsCurveData" /> class.
        /// </summary>
        ...
        public AppendFxForwardTenorPipsCurveData(string tenor = default(string), decimal pipRate = default(decimal), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base()
        {
            ...
            if (tenor == null)
            {
                throw new ArgumentNullException("tenor is a required property for AppendFxForwardTenorPipsCurveData and cannot be null");
            }
            this.Tenor = tenor;
            ...
            {
                throw new ArgumentException("marketDataType is a required property for AppendFxForwardTenorPipsCurveData and must be a defined value");
            }
        ...
        {
            return this.Equals(input as AppendFxForwardTenorPipsCurveData);
        }

        /// <summary>
        /// Returns true if AppendFxForwardTenorPipsCurveData instances are equal
        /// </summary>
        /// <param name="input">Instance of AppendFxForwardTenorPipsCurveData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppendFxForwardTenorPipsCurveData input)
        {
            if (input == null)
            {
                return false;
