...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ComplianceRuleEntity")]
    public partial class ComplianceRuleEntity : IEquatable<ComplianceRuleEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRuleEntity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ComplianceRuleEntity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRuleEntity" /> class.
        /// </summary>
        ...
        /// <param name="prevailingComplianceRule">prevailingComplianceRule.</param>
        /// <param name="deletedComplianceRule">deletedComplianceRule.</param>
        /// <param name="previewedStatus">The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist..</param>
        /// <param name="previewedComplianceRule">previewedComplianceRule.</param>
        /// <param name="links">links.</param>
        public ComplianceRuleEntity(string href = default(string), string entityUniqueId = default(string), int? asAtVersionNumber = default(int?), string status = default(string), DateTimeOffset? asAtDeleted = default(DateTimeOffset?), string userIdDeleted = default(string), string requestIdDeleted = default(string), DateTimeOffset? effectiveAtCreated = default(DateTimeOffset?), ComplianceRuleResponse prevailingComplianceRule = default(ComplianceRuleResponse), ComplianceRuleResponse deletedComplianceRule = default(ComplianceRuleResponse), string previewedStatus = default(string), ComplianceRuleResponse previewedComplianceRule = default(ComplianceRuleResponse), List<Link> links = default(List<Link>))
        {
            // to ensure "href" is required (not null)
            if (href == null)
            {
                throw new ArgumentNullException("href is a required property for ComplianceRuleEntity and cannot be null");
            }
            this.Href = href;
            // to ensure "entityUniqueId" is required (not null)
            if (entityUniqueId == null)
            {
                throw new ArgumentNullException("entityUniqueId is a required property for ComplianceRuleEntity and cannot be null");
            }
            this.EntityUniqueId = entityUniqueId;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for ComplianceRuleEntity and cannot be null");
            }
            this.Status = status;
        ...
        /// <summary>
        /// Gets or Sets PrevailingComplianceRule
        /// </summary>
        [DataMember(Name = "prevailingComplianceRule", EmitDefaultValue = false)]
        public ComplianceRuleResponse PrevailingComplianceRule { get; set; }

        /// <summary>
        /// Gets or Sets DeletedComplianceRule
        /// </summary>
        [DataMember(Name = "deletedComplianceRule", EmitDefaultValue = false)]
        public ComplianceRuleResponse DeletedComplianceRule { get; set; }
        ...
        /// <summary>
        /// Gets or Sets PreviewedComplianceRule
        /// </summary>
        [DataMember(Name = "previewedComplianceRule", EmitDefaultValue = false)]
        public ComplianceRuleResponse PreviewedComplianceRule { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrevailingComplianceRule: ").Append(PrevailingComplianceRule).Append("\n");
            sb.Append("  DeletedComplianceRule: ").Append(DeletedComplianceRule).Append("\n");
            sb.Append("  PreviewedStatus: ").Append(PreviewedStatus).Append("\n");
            sb.Append("  PreviewedComplianceRule: ").Append(PreviewedComplianceRule).Append("\n");
        ...
        {
            return this.Equals(input as ComplianceRuleEntity);
        }

        /// <summary>
        /// Returns true if ComplianceRuleEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of ComplianceRuleEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComplianceRuleEntity input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PrevailingComplianceRule == input.PrevailingComplianceRule ||
                    (this.PrevailingComplianceRule != null &&
                    this.PrevailingComplianceRule.Equals(input.PrevailingComplianceRule))
                ) && 
                (
                    this.DeletedComplianceRule == input.DeletedComplianceRule ||
                    (this.DeletedComplianceRule != null &&
                    this.DeletedComplianceRule.Equals(input.DeletedComplianceRule))
                ) && 
                (
                ...
                (
                    this.PreviewedComplianceRule == input.PreviewedComplianceRule ||
                    (this.PreviewedComplianceRule != null &&
                    this.PreviewedComplianceRule.Equals(input.PreviewedComplianceRule))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrevailingComplianceRule != null)
                {
                    hashCode = (hashCode * 59) + this.PrevailingComplianceRule.GetHashCode();
                }
                if (this.DeletedComplianceRule != null)
                {
                    hashCode = (hashCode * 59) + this.DeletedComplianceRule.GetHashCode();
                }
                if (this.PreviewedStatus != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedStatus.GetHashCode();
                }
                if (this.PreviewedComplianceRule != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedComplianceRule.GetHashCode();
                }
                if (this.Links != null)
                {
