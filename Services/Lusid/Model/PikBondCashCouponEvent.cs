...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PikBondCashCouponEvent : InstrumentEvent, IEquatable<PikBondCashCouponEvent>, IValidatableObject
    {
        ...
        public PikBondCashCouponEvent(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal? couponPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for PikBondCashCouponEvent and must be a defined value");
            }
