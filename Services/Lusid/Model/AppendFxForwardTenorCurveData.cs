...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class AppendFxForwardTenorCurveData : AppendMarketData, IEquatable<AppendFxForwardTenorCurveData>, IValidatableObject
    {
        ...
        public AppendFxForwardTenorCurveData(string tenor = default(string), decimal rate = default(decimal), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base()
        {
