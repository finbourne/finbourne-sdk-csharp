...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdatePortfolioRequest")]
    public partial class UpdatePortfolioRequest : IEquatable<UpdatePortfolioRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="description">The description of the transaction portfolio..</param>
        public UpdatePortfolioRequest(string displayName = default(string), string description = default(string))
        {
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for UpdatePortfolioRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The description of the transaction portfolio.</value>
