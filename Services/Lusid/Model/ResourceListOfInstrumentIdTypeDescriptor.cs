...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfInstrumentIdTypeDescriptor")]
    public partial class ResourceListOfInstrumentIdTypeDescriptor : IEquatable<ResourceListOfInstrumentIdTypeDescriptor>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfInstrumentIdTypeDescriptor(List<InstrumentIdTypeDescriptor> values = default(List<InstrumentIdTypeDescriptor>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfInstrumentIdTypeDescriptor and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
