...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class IrVolDependency : EconomicDependency, IEquatable<IrVolDependency>, IValidatableObject
    {
        ...
        public IrVolDependency(string currency = default(string), string volType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("dependencyType is a required property for IrVolDependency and must be a defined value");
            }
