...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CleardownModuleDetails : IEquatable<CleardownModuleDetails>, IValidatableObject
    {
        /// <summary>
        ...
        public CleardownModuleDetails(string displayName = default(string), string description = default(string), string status = default(string))
        {
            ...
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for CleardownModuleDetails and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for CleardownModuleDetails and cannot be null");
            }
            this.Status = status;
