...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class BondDefaultEvent : InstrumentEvent, IEquatable<BondDefaultEvent>, IValidatableObject
    {
        ...
        public BondDefaultEvent(DateTimeOffset effectiveDate = default(DateTimeOffset), string defaultReason = default(string), BondDefaultSuppressionDetails suppressionDetails = default(BondDefaultSuppressionDetails), bool? suppressionDetailsSpecified = default(bool?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
