...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class BondDefaultEvent : InstrumentEvent, IEquatable<BondDefaultEvent>, IValidatableObject
    {
        ...
        public BondDefaultEvent(DateTimeOffset effectiveDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for BondDefaultEvent and must be a defined value");
            }
