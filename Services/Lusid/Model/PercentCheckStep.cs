...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PercentCheckStep : ComplianceStep, IEquatable<PercentCheckStep>, IValidatableObject
    {
        ...
        public PercentCheckStep(string label = default(string), List<ComplianceTemplateParameter> limitCheckParameters = default(List<ComplianceTemplateParameter>), List<ComplianceTemplateParameter> warningCheckParameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum)) : base()
        {
