...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CapletFloorletCashFlowEvent : InstrumentEvent, IEquatable<CapletFloorletCashFlowEvent>, IValidatableObject
    {
        ...
        public CapletFloorletCashFlowEvent(DateTimeOffset entitlementDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal cashFlowPerUnit = default(decimal), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for CapletFloorletCashFlowEvent and must be a defined value");
            }
