...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class InformationalEvent : InstrumentEvent, IEquatable<InformationalEvent>, IValidatableObject
    {
        ...
        public InformationalEvent(DateTimeOffset anchorDate = default(DateTimeOffset), ResultValueDictionary diagnostics = default(ResultValueDictionary), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for InformationalEvent and must be a defined value");
            }
