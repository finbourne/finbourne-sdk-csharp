...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class AddressKeyList : ReferenceList, IEquatable<AddressKeyList>, IValidatableObject
    {
        ...
        public AddressKeyList(List<string> values = default(List<string>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("referenceListType is a required property for AddressKeyList and must be a defined value");
            }
