...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ResultValueBool : ResultValue, IEquatable<ResultValueBool>, IValidatableObject
    {
        ...
        public ResultValueBool(bool value = default(bool), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum)) : base()
        {
            
            // to ensure "resultValueType" is a defined enum value
            if (!System.Enum.IsDefined(typeof(ResultValueTypeEnum), resultValueType))
            {
                throw new ArgumentException("resultValueType is a required property for ResultValueBool and must be a defined value");
            }
