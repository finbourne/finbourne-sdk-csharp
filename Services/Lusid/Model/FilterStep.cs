...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class FilterStep : ComplianceStep, IEquatable<FilterStep>, IValidatableObject
    {
        ...
        public FilterStep(string label = default(string), List<ComplianceTemplateParameter> parameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceStepType is a required property for FilterStep and must be a defined value");
            }
