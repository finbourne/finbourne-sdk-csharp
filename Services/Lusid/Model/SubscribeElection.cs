...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SubscribeElection")]
    public partial class SubscribeElection : IEquatable<SubscribeElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscribeElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscribeElection" /> class.
        /// </summary>
        ...
        public SubscribeElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for SubscribeElection and cannot be null");
            }
        ...
        {
            return this.Equals(input as SubscribeElection);
        }

        /// <summary>
        /// Returns true if SubscribeElection instances are equal
        /// </summary>
        /// <param name="input">Instance of SubscribeElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscribeElection input)
        {
            if (input == null)
            {
                return false;
