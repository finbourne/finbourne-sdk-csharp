...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OptionExerciseElection")]
    public partial class OptionExerciseElection : IEquatable<OptionExerciseElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionExerciseElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OptionExerciseElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OptionExerciseElection" /> class.
        /// </summary>
        ...
        public OptionExerciseElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            ...
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for OptionExerciseElection and cannot be null");
            }
        ...
        {
            return this.Equals(input as OptionExerciseElection);
        }

        /// <summary>
        /// Returns true if OptionExerciseElection instances are equal
        /// </summary>
        /// <param name="input">Instance of OptionExerciseElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OptionExerciseElection input)
        {
            if (input == null)
            {
                return false;
