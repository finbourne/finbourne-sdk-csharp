...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class BoolComplianceParameter : ComplianceParameter, IEquatable<BoolComplianceParameter>, IValidatableObject
    {
        ...
        public BoolComplianceParameter(bool value = default(bool), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for BoolComplianceParameter and must be a defined value");
            }
