...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PropertyKeyListComplianceParameter : ComplianceParameter, IEquatable<PropertyKeyListComplianceParameter>, IValidatableObject
    {
        ...
        public PropertyKeyListComplianceParameter(ResourceId value = default(ResourceId), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for PropertyKeyListComplianceParameter and must be a defined value");
            }
