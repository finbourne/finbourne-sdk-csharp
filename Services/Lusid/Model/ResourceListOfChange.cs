...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfChange")]
    public partial class ResourceListOfChange : IEquatable<ResourceListOfChange>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfChange(List<Change> values = default(List<Change>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfChange and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
