...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class SwapPrincipalEvent : InstrumentEvent, IEquatable<SwapPrincipalEvent>, IValidatableObject
    {
        ...
        public SwapPrincipalEvent(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal principalPerUnit = default(decimal), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for SwapPrincipalEvent and must be a defined value");
            }
