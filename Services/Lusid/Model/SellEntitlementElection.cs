...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SellEntitlementElection")]
    public partial class SellEntitlementElection : IEquatable<SellEntitlementElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SellEntitlementElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SellEntitlementElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SellEntitlementElection" /> class.
        /// </summary>
        ...
        public SellEntitlementElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for SellEntitlementElection and cannot be null");
            }
        ...
        {
            return this.Equals(input as SellEntitlementElection);
        }

        /// <summary>
        /// Returns true if SellEntitlementElection instances are equal
        /// </summary>
        /// <param name="input">Instance of SellEntitlementElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SellEntitlementElection input)
        {
            if (input == null)
            {
                return false;
