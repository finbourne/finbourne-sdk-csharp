...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// PreviousNAV
    /// </summary>
    [DataContract(Name = "PreviousNAV")]
    public partial class PreviousNAV : IEquatable<PreviousNAV>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PreviousNAV);
        }

        /// <summary>
        /// Returns true if PreviousNAV instances are equal
        /// </summary>
        /// <param name="input">Instance of PreviousNAV to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PreviousNAV input)
        {
            if (input == null)
            {
                return false;
