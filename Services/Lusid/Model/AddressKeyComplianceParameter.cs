...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class AddressKeyComplianceParameter : ComplianceParameter, IEquatable<AddressKeyComplianceParameter>, IValidatableObject
    {
        ...
        public AddressKeyComplianceParameter(string value = default(string), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for AddressKeyComplianceParameter and must be a defined value");
            }
