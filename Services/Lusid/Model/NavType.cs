...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// NavType
    /// </summary>
    [DataContract(Name = "NavType")]
    public partial class NavType : IEquatable<NavType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NavType" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="NavType" /> class.
        /// </summary>
        /// <param name="status">The Status of the Nav Type. Available values: Active, Inactive. (required).</param>
        ...
        public NavType(string status = default(string), string code = default(string), string displayName = default(string), string description = default(string), ResourceId chartOfAccountsId = default(ResourceId), List<string> postingModuleCodes = default(List<string>), List<string> cleardownModuleCodes = default(List<string>), ResourceId valuationRecipeId = default(ResourceId), ResourceId holdingRecipeId = default(ResourceId), string accountingMethod = default(string), List<string> subHoldingKeys = default(List<string>), string amortisationMethod = default(string), string transactionTypeScope = default(string), string cashGainLossCalculationDate = default(string), ResourceId amortisationRuleSetId = default(ResourceId), string leaderNavTypeCode = default(string), string transactionTemplateScope = default(string))
        {
            ...
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for NavType and cannot be null");
            }
            this.Status = status;
            ...
            {
                throw new ArgumentNullException("valuationRecipeId is a required property for NavType and cannot be null");
            }
            this.ValuationRecipeId = valuationRecipeId;
            // to ensure "holdingRecipeId" is required (not null)
            if (holdingRecipeId == null)
            {
                throw new ArgumentNullException("holdingRecipeId is a required property for NavType and cannot be null");
            }
            this.HoldingRecipeId = holdingRecipeId;
            // to ensure "accountingMethod" is required (not null)
            if (accountingMethod == null)
            {
                throw new ArgumentNullException("accountingMethod is a required property for NavType and cannot be null");
            }
            this.AccountingMethod = accountingMethod;
            // to ensure "amortisationMethod" is required (not null)
            if (amortisationMethod == null)
            {
                throw new ArgumentNullException("amortisationMethod is a required property for NavType and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("transactionTypeScope is a required property for NavType and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The Status of the Nav Type. Available values: Active, Inactive.</value>
        ...
        {
            return this.Equals(input as NavType);
        }

        /// <summary>
        /// Returns true if NavType instances are equal
        /// </summary>
        /// <param name="input">Instance of NavType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NavType input)
        {
            if (input == null)
            {
                return false;
