...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfLegalEntity")]
    public partial class PagedResourceListOfLegalEntity : IEquatable<PagedResourceListOfLegalEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public PagedResourceListOfLegalEntity(string nextPage = default(string), string previousPage = default(string), List<LegalEntity> values = default(List<LegalEntity>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for PagedResourceListOfLegalEntity and cannot be null");
            }
            this.Values = values;
