...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsentAndExchangeElection")]
    public partial class ConsentAndExchangeElection : IEquatable<ConsentAndExchangeElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsentAndExchangeElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ConsentAndExchangeElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ConsentAndExchangeElection" /> class.
        /// </summary>
        ...
        public ConsentAndExchangeElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool), UnitsRatio unitsRatio = default(UnitsRatio))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for ConsentAndExchangeElection and cannot be null");
            }
            this.ElectionKey = electionKey;
            // to ensure "unitsRatio" is required (not null)
            if (unitsRatio == null)
            {
                throw new ArgumentNullException("unitsRatio is a required property for ConsentAndExchangeElection and cannot be null");
            }
        ...
        {
            return this.Equals(input as ConsentAndExchangeElection);
        }

        /// <summary>
        /// Returns true if ConsentAndExchangeElection instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsentAndExchangeElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsentAndExchangeElection input)
        {
            if (input == null)
            {
                return false;
