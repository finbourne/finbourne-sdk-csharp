...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ResultValueInt : ResultValue, IEquatable<ResultValueInt>, IValidatableObject
    {
        ...
        public ResultValueInt(int value = default(int), int? dimension = default(int?), ResultValueTypeEnum resultValueType = default(ResultValueTypeEnum)) : base()
        {
            
            // to ensure "resultValueType" is a defined enum value
            if (!System.Enum.IsDefined(typeof(ResultValueTypeEnum), resultValueType))
            {
                throw new ArgumentException("resultValueType is a required property for ResultValueInt and must be a defined value");
            }
