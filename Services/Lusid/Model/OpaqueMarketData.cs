...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class OpaqueMarketData : ComplexMarketData, IEquatable<OpaqueMarketData>, IValidatableObject
    {
        ...
        public OpaqueMarketData(string document = default(string), string format = default(string), string name = default(string), string lineage = default(string), ModelVersion varVersion = default(ModelVersion), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base()
        {
