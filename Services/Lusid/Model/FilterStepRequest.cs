...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class FilterStepRequest : ComplianceStepRequest, IEquatable<FilterStepRequest>, IValidatableObject
    {
        ...
        public FilterStepRequest(string label = default(string), ComplianceStepTypeRequestEnum complianceStepTypeRequest = default(ComplianceStepTypeRequestEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceStepTypeRequest is a required property for FilterStepRequest and must be a defined value");
            }
