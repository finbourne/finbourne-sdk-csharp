...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class DiscountingDependency : EconomicDependency, IEquatable<DiscountingDependency>, IValidatableObject
    {
        ...
        public DiscountingDependency(string currency = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("dependencyType is a required property for DiscountingDependency and must be a defined value");
            }
