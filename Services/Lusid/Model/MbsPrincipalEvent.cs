...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class MbsPrincipalEvent : InstrumentEvent, IEquatable<MbsPrincipalEvent>, IValidatableObject
    {
        ...
        public MbsPrincipalEvent(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal? principalPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for MbsPrincipalEvent and must be a defined value");
            }
