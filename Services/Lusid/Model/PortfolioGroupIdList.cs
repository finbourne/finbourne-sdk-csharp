...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PortfolioGroupIdList : ReferenceList, IEquatable<PortfolioGroupIdList>, IValidatableObject
    {
        ...
        public PortfolioGroupIdList(List<ResourceId> values = default(List<ResourceId>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("referenceListType is a required property for PortfolioGroupIdList and must be a defined value");
            }
