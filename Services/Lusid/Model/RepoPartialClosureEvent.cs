...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class RepoPartialClosureEvent : InstrumentEvent, IEquatable<RepoPartialClosureEvent>, IValidatableObject
    {
        ...
        public RepoPartialClosureEvent(DateTimeOffset entitlementDate = default(DateTimeOffset), DateTimeOffset settlementDate = default(DateTimeOffset), decimal? cashAmount = default(decimal?), decimal? cashPercentage = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for RepoPartialClosureEvent and must be a defined value");
            }
