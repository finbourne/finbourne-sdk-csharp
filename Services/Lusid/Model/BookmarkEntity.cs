...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// BookmarkEntity
    /// </summary>
    [DataContract(Name = "BookmarkEntity")]
    public partial class BookmarkEntity : IEquatable<BookmarkEntity>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="prevailingBookmark">prevailingBookmark.</param>
        /// <param name="deletedBookmark">deletedBookmark.</param>
        /// <param name="previewedStatus">The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist..</param>
        /// <param name="previewedBookmark">previewedBookmark.</param>
        /// <param name="links">links.</param>
        public BookmarkEntity(string href = default(string), string entityUniqueId = default(string), int? asAtVersionNumber = default(int?), string status = default(string), DateTimeOffset? asAtDeleted = default(DateTimeOffset?), string userIdDeleted = default(string), string requestIdDeleted = default(string), DateTimeOffset? effectiveAtCreated = default(DateTimeOffset?), FundCalendarEntry prevailingBookmark = default(FundCalendarEntry), FundCalendarEntry deletedBookmark = default(FundCalendarEntry), string previewedStatus = default(string), FundCalendarEntry previewedBookmark = default(FundCalendarEntry), List<Link> links = default(List<Link>))
        {
            // to ensure "href" is required (not null)
            if (href == null)
            {
                throw new ArgumentNullException("href is a required property for BookmarkEntity and cannot be null");
            }
            this.Href = href;
            // to ensure "entityUniqueId" is required (not null)
            if (entityUniqueId == null)
            {
                throw new ArgumentNullException("entityUniqueId is a required property for BookmarkEntity and cannot be null");
            }
            this.EntityUniqueId = entityUniqueId;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for BookmarkEntity and cannot be null");
            }
            this.Status = status;
        ...
        /// <summary>
        /// Gets or Sets PrevailingBookmark
        /// </summary>
        [DataMember(Name = "prevailingBookmark", EmitDefaultValue = false)]
        public FundCalendarEntry PrevailingBookmark { get; set; }

        /// <summary>
        /// Gets or Sets DeletedBookmark
        /// </summary>
        [DataMember(Name = "deletedBookmark", EmitDefaultValue = false)]
        public FundCalendarEntry DeletedBookmark { get; set; }
        ...
        /// <summary>
        /// Gets or Sets PreviewedBookmark
        /// </summary>
        [DataMember(Name = "previewedBookmark", EmitDefaultValue = false)]
        public FundCalendarEntry PreviewedBookmark { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrevailingBookmark: ").Append(PrevailingBookmark).Append("\n");
            sb.Append("  DeletedBookmark: ").Append(DeletedBookmark).Append("\n");
            sb.Append("  PreviewedStatus: ").Append(PreviewedStatus).Append("\n");
            sb.Append("  PreviewedBookmark: ").Append(PreviewedBookmark).Append("\n");
        ...
        {
            return this.Equals(input as BookmarkEntity);
        }

        /// <summary>
        /// Returns true if BookmarkEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of BookmarkEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BookmarkEntity input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PrevailingBookmark == input.PrevailingBookmark ||
                    (this.PrevailingBookmark != null &&
                    this.PrevailingBookmark.Equals(input.PrevailingBookmark))
                ) && 
                (
                    this.DeletedBookmark == input.DeletedBookmark ||
                    (this.DeletedBookmark != null &&
                    this.DeletedBookmark.Equals(input.DeletedBookmark))
                ) && 
                (
                ...
                (
                    this.PreviewedBookmark == input.PreviewedBookmark ||
                    (this.PreviewedBookmark != null &&
                    this.PreviewedBookmark.Equals(input.PreviewedBookmark))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrevailingBookmark != null)
                {
                    hashCode = (hashCode * 59) + this.PrevailingBookmark.GetHashCode();
                }
                if (this.DeletedBookmark != null)
                {
                    hashCode = (hashCode * 59) + this.DeletedBookmark.GetHashCode();
                }
                if (this.PreviewedStatus != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedStatus.GetHashCode();
                }
                if (this.PreviewedBookmark != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedBookmark.GetHashCode();
                }
                if (this.Links != null)
                {
