...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CashDependency : EconomicDependency, IEquatable<CashDependency>, IValidatableObject
    {
        ...
        public CashDependency(string currency = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base()
        {
