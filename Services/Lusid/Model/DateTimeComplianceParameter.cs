...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DateTimeComplianceParameter")]
    [JsonConverter(typeof(JsonSubtypes), "ComplianceParameterType")]
    public partial class DateTimeComplianceParameter : ComplianceParameter, IEquatable<DateTimeComplianceParameter>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DateTimeComplianceParameter" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DateTimeComplianceParameter() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DateTimeComplianceParameter" /> class.
        /// </summary>
        ...
        public DateTimeComplianceParameter(DateTimeOffset value = default(DateTimeOffset), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for DateTimeComplianceParameter and must be a defined value");
            }
        ...
        {
            return this.Equals(input as DateTimeComplianceParameter);
        }

        /// <summary>
        /// Returns true if DateTimeComplianceParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of DateTimeComplianceParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DateTimeComplianceParameter input)
        {
            if (input == null)
            {
                return false;
