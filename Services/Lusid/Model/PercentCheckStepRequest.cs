...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PercentCheckStepRequest : ComplianceStepRequest, IEquatable<PercentCheckStepRequest>, IValidatableObject
    {
        ...
        public PercentCheckStepRequest(string label = default(string), ComplianceStepTypeRequestEnum complianceStepTypeRequest = default(ComplianceStepTypeRequestEnum)) : base()
        {
