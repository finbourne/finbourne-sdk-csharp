...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PagedResourceListOfPortfolioSearchResult")]
    public partial class PagedResourceListOfPortfolioSearchResult : IEquatable<PagedResourceListOfPortfolioSearchResult>, IValidatableObject
    {
        /// <summary>
        ...
        public PagedResourceListOfPortfolioSearchResult(string nextPage = default(string), string previousPage = default(string), List<PortfolioSearchResult> values = default(List<PortfolioSearchResult>), string href = default(string), List<Link> links = default(List<Link>))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for PagedResourceListOfPortfolioSearchResult and cannot be null");
            }
            this.Values = values;
