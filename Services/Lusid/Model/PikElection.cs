...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// PIK election.
    /// </summary>
    [DataContract(Name = "PikElection")]
    public partial class PikElection : IEquatable<PikElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PikElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PikElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PikElection" /> class.
        /// </summary>
        /// <param name="electionKey">Unique key associated to this election (the PIK type) (required).</param>
        ...
        public PikElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for PikElection and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Unique key associated to this election (the PIK type)</value>
        ...
        {
            return this.Equals(input as PikElection);
        }

        /// <summary>
        /// Returns true if PikElection instances are equal
        /// </summary>
        /// <param name="input">Instance of PikElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PikElection input)
        {
            if (input == null)
            {
                return false;
