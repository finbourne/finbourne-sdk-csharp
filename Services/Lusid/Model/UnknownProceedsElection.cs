...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UnknownProceedsElection")]
    public partial class UnknownProceedsElection : IEquatable<UnknownProceedsElection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnknownProceedsElection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UnknownProceedsElection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UnknownProceedsElection" /> class.
        /// </summary>
        ...
        public UnknownProceedsElection(string electionKey = default(string), bool isDefault = default(bool), bool isChosen = default(bool))
        {
            // to ensure "electionKey" is required (not null)
            if (electionKey == null)
            {
                throw new ArgumentNullException("electionKey is a required property for UnknownProceedsElection and cannot be null");
            }
        ...
        {
            return this.Equals(input as UnknownProceedsElection);
        }

        /// <summary>
        /// Returns true if UnknownProceedsElection instances are equal
        /// </summary>
        /// <param name="input">Instance of UnknownProceedsElection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnknownProceedsElection input)
        {
            if (input == null)
            {
                return false;
