...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class OpenEvent : InstrumentEvent, IEquatable<OpenEvent>, IValidatableObject
    {
        ...
        public OpenEvent(DateTimeOffset anchorDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for OpenEvent and must be a defined value");
            }
