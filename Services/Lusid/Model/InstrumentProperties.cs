...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InstrumentProperties")]
    public partial class InstrumentProperties : IEquatable<InstrumentProperties>, IValidatableObject
    {
        /// <summary>
        ...
        public InstrumentProperties(string href = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), ModelVersion varVersion = default(ModelVersion), List<Link> links = default(List<Link>))
        {
            this.Href = href;
