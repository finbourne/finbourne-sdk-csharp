...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ValuationPointEntity")]
    public partial class ValuationPointEntity : IEquatable<ValuationPointEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ValuationPointEntity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ValuationPointEntity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ValuationPointEntity" /> class.
        /// </summary>
        ...
        /// <param name="prevailingValuationPoint">prevailingValuationPoint.</param>
        /// <param name="deletedValuationPoint">deletedValuationPoint.</param>
        /// <param name="previewedStatus">The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist..</param>
        /// <param name="previewedValuationPoint">previewedValuationPoint.</param>
        /// <param name="links">links.</param>
        public ValuationPointEntity(string href = default(string), string entityUniqueId = default(string), int? asAtVersionNumber = default(int?), string status = default(string), DateTimeOffset? asAtDeleted = default(DateTimeOffset?), string userIdDeleted = default(string), string requestIdDeleted = default(string), DateTimeOffset? effectiveAtCreated = default(DateTimeOffset?), FundCalendarEntry prevailingValuationPoint = default(FundCalendarEntry), FundCalendarEntry deletedValuationPoint = default(FundCalendarEntry), string previewedStatus = default(string), FundCalendarEntry previewedValuationPoint = default(FundCalendarEntry), List<Link> links = default(List<Link>))
        {
            // to ensure "href" is required (not null)
            if (href == null)
            {
                throw new ArgumentNullException("href is a required property for ValuationPointEntity and cannot be null");
            }
            this.Href = href;
            // to ensure "entityUniqueId" is required (not null)
            if (entityUniqueId == null)
            {
                throw new ArgumentNullException("entityUniqueId is a required property for ValuationPointEntity and cannot be null");
            }
            this.EntityUniqueId = entityUniqueId;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for ValuationPointEntity and cannot be null");
            }
            this.Status = status;
        ...
        /// <summary>
        /// Gets or Sets PrevailingValuationPoint
        /// </summary>
        [DataMember(Name = "prevailingValuationPoint", EmitDefaultValue = false)]
        public FundCalendarEntry PrevailingValuationPoint { get; set; }

        /// <summary>
        /// Gets or Sets DeletedValuationPoint
        /// </summary>
        [DataMember(Name = "deletedValuationPoint", EmitDefaultValue = false)]
        public FundCalendarEntry DeletedValuationPoint { get; set; }
        ...
        /// <summary>
        /// Gets or Sets PreviewedValuationPoint
        /// </summary>
        [DataMember(Name = "previewedValuationPoint", EmitDefaultValue = false)]
        public FundCalendarEntry PreviewedValuationPoint { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrevailingValuationPoint: ").Append(PrevailingValuationPoint).Append("\n");
            sb.Append("  DeletedValuationPoint: ").Append(DeletedValuationPoint).Append("\n");
            sb.Append("  PreviewedStatus: ").Append(PreviewedStatus).Append("\n");
            sb.Append("  PreviewedValuationPoint: ").Append(PreviewedValuationPoint).Append("\n");
        ...
        {
            return this.Equals(input as ValuationPointEntity);
        }

        /// <summary>
        /// Returns true if ValuationPointEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of ValuationPointEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ValuationPointEntity input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PrevailingValuationPoint == input.PrevailingValuationPoint ||
                    (this.PrevailingValuationPoint != null &&
                    this.PrevailingValuationPoint.Equals(input.PrevailingValuationPoint))
                ) && 
                (
                    this.DeletedValuationPoint == input.DeletedValuationPoint ||
                    (this.DeletedValuationPoint != null &&
                    this.DeletedValuationPoint.Equals(input.DeletedValuationPoint))
                ) && 
                (
                ...
                (
                    this.PreviewedValuationPoint == input.PreviewedValuationPoint ||
                    (this.PreviewedValuationPoint != null &&
                    this.PreviewedValuationPoint.Equals(input.PreviewedValuationPoint))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrevailingValuationPoint != null)
                {
                    hashCode = (hashCode * 59) + this.PrevailingValuationPoint.GetHashCode();
                }
                if (this.DeletedValuationPoint != null)
                {
                    hashCode = (hashCode * 59) + this.DeletedValuationPoint.GetHashCode();
                }
                if (this.PreviewedStatus != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedStatus.GetHashCode();
                }
                if (this.PreviewedValuationPoint != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedValuationPoint.GetHashCode();
                }
                if (this.Links != null)
                {
