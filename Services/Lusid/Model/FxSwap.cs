...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class FxSwap : LusidInstrument, IEquatable<FxSwap>, IValidatableObject
    {
        ...
        public FxSwap(FxForward nearFxForward = default(FxForward), FxForward farFxForward = default(FxForward), string notionalSymmetry = default(string), TimeZoneConventions timeZoneConventions = default(TimeZoneConventions), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base()
        {
