...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "VersionedResourceListOfTransaction")]
    public partial class VersionedResourceListOfTransaction : IEquatable<VersionedResourceListOfTransaction>, IValidatableObject
    {
        /// <summary>
        ...
        public VersionedResourceListOfTransaction(ModelVersion varVersion = default(ModelVersion), List<Transaction> values = default(List<Transaction>), string href = default(string), string nextPage = default(string), string previousPage = default(string), List<Link> links = default(List<Link>))
        {
            // to ensure "varVersion" is required (not null)
            if (varVersion == null)
            {
                throw new ArgumentNullException("varVersion is a required property for VersionedResourceListOfTransaction and cannot be null");
            }
            this.VarVersion = varVersion;
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for VersionedResourceListOfTransaction and cannot be null");
            }
            this.Values = values;
            this.Href = href;
