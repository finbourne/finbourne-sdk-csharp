...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class UpsertPersonRequest : IEquatable<UpsertPersonRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpsertPersonRequest(Dictionary<string, Property> identifiers = default(Dictionary<string, Property>), Dictionary<string, Property> properties = default(Dictionary<string, Property>), string displayName = default(string), string description = default(string))
        {
            ...
            if (identifiers == null)
            {
                throw new ArgumentNullException("identifiers is a required property for UpsertPersonRequest and cannot be null");
            }
            this.Identifiers = identifiers;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for UpsertPersonRequest and cannot be null");
            }
