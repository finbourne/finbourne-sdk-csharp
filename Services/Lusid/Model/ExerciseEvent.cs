...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ExerciseEvent : InstrumentEvent, IEquatable<ExerciseEvent>, IValidatableObject
    {
        ...
        public ExerciseEvent(LusidInstrument instrument = default(LusidInstrument), DateTimeOffset anchorDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for ExerciseEvent and must be a defined value");
            }
