...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class UpdateDepositAmountEvent : InstrumentEvent, IEquatable<UpdateDepositAmountEvent>, IValidatableObject
    {
        ...
        public UpdateDepositAmountEvent(DateTimeOffset date = default(DateTimeOffset), decimal amount = default(decimal), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for UpdateDepositAmountEvent and must be a defined value");
            }
