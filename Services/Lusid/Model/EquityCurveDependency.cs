...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class EquityCurveDependency : EconomicDependency, IEquatable<EquityCurveDependency>, IValidatableObject
    {
        ...
        public EquityCurveDependency(string marketIdentifier = default(string), string code = default(string), string curveType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base()
        {
