...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FxForwardCurveData")]
    [JsonConverter(typeof(JsonSubtypes), "MarketDataType")]
    public partial class FxForwardCurveData : ComplexMarketData, IEquatable<FxForwardCurveData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FxForwardCurveData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FxForwardCurveData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FxForwardCurveData" /> class.
        /// </summary>
        ...
        public FxForwardCurveData(DateTimeOffset baseDate = default(DateTimeOffset), string domCcy = default(string), string fgnCcy = default(string), List<DateTimeOffset> dates = default(List<DateTimeOffset>), List<decimal> rates = default(List<decimal>), string lineage = default(string), MarketDataOptions marketDataOptions = default(MarketDataOptions), ModelVersion varVersion = default(ModelVersion), MarketDataTypeEnum marketDataType = default(MarketDataTypeEnum)) : base()
        {
            ...
            if (domCcy == null)
            {
                throw new ArgumentNullException("domCcy is a required property for FxForwardCurveData and cannot be null");
            }
            this.DomCcy = domCcy;
            // to ensure "fgnCcy" is required (not null)
            if (fgnCcy == null)
            {
                throw new ArgumentNullException("fgnCcy is a required property for FxForwardCurveData and cannot be null");
            }
            this.FgnCcy = fgnCcy;
            // to ensure "dates" is required (not null)
            if (dates == null)
            {
                throw new ArgumentNullException("dates is a required property for FxForwardCurveData and cannot be null");
            }
            this.Dates = dates;
            // to ensure "rates" is required (not null)
            if (rates == null)
            {
                throw new ArgumentNullException("rates is a required property for FxForwardCurveData and cannot be null");
            }
            this.Rates = rates;
            ...
            {
                throw new ArgumentException("marketDataType is a required property for FxForwardCurveData and must be a defined value");
            }
        ...
        {
            return this.Equals(input as FxForwardCurveData);
        }

        /// <summary>
        /// Returns true if FxForwardCurveData instances are equal
        /// </summary>
        /// <param name="input">Instance of FxForwardCurveData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FxForwardCurveData input)
        {
            if (input == null)
            {
                return false;
