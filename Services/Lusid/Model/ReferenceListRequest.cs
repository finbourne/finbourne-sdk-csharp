...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ReferenceListRequest")]
    public partial class ReferenceListRequest : IEquatable<ReferenceListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceListRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ReferenceListRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ReferenceListRequest" /> class.
        /// </summary>
        ...
        public ReferenceListRequest(ResourceId id = default(ResourceId), string name = default(string), string description = default(string), List<string> tags = default(List<string>), ReferenceList referenceList = default(ReferenceList))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ReferenceListRequest and cannot be null");
            }
            this.Id = id;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ReferenceListRequest and cannot be null");
            }
            this.Name = name;
            // to ensure "referenceList" is required (not null)
            if (referenceList == null)
            {
                throw new ArgumentNullException("referenceList is a required property for ReferenceListRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as ReferenceListRequest);
        }

        /// <summary>
        /// Returns true if ReferenceListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReferenceListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReferenceListRequest input)
        {
            if (input == null)
            {
                return false;
