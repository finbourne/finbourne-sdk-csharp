...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class FilterPredicateComplianceParameter : ComplianceParameter, IEquatable<FilterPredicateComplianceParameter>, IValidatableObject
    {
        ...
        public FilterPredicateComplianceParameter(string value = default(string), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for FilterPredicateComplianceParameter and must be a defined value");
            }
