...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpsertComplianceRunSummaryRequest")]
    public partial class UpsertComplianceRunSummaryRequest : IEquatable<UpsertComplianceRunSummaryRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertComplianceRunSummaryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpsertComplianceRunSummaryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertComplianceRunSummaryRequest" /> class.
        /// </summary>
        ...
        public UpsertComplianceRunSummaryRequest(ResourceId runId = default(ResourceId), DateTimeOffset instigatedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), string schedule = default(string), List<ComplianceSummaryRuleResultRequest> results = default(List<ComplianceSummaryRuleResultRequest>))
        {
            ...
            if (schedule == null)
            {
                throw new ArgumentNullException("schedule is a required property for UpsertComplianceRunSummaryRequest and cannot be null");
            }
            this.Schedule = schedule;
            // to ensure "results" is required (not null)
            if (results == null)
            {
                throw new ArgumentNullException("results is a required property for UpsertComplianceRunSummaryRequest and cannot be null");
            }
        ...
        public List<ComplianceSummaryRuleResultRequest> Results { get; set; }
        ...
        {
            return this.Equals(input as UpsertComplianceRunSummaryRequest);
        }

        /// <summary>
        /// Returns true if UpsertComplianceRunSummaryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsertComplianceRunSummaryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsertComplianceRunSummaryRequest input)
        {
            if (input == null)
            {
                return false;
