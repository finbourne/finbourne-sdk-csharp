...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CloseEvent : InstrumentEvent, IEquatable<CloseEvent>, IValidatableObject
    {
        ...
        public CloseEvent(DateTimeOffset startDate = default(DateTimeOffset), DateTimeOffset endDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for CloseEvent and must be a defined value");
            }
