...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class SwapCashFlowEvent : InstrumentEvent, IEquatable<SwapCashFlowEvent>, IValidatableObject
    {
        ...
        public SwapCashFlowEvent(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal cashFlowPerUnit = default(decimal), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for SwapCashFlowEvent and must be a defined value");
            }
