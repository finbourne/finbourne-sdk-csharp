...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class DecimalList : ReferenceList, IEquatable<DecimalList>, IValidatableObject
    {
        ...
        public DecimalList(List<decimal> values = default(List<decimal>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("referenceListType is a required property for DecimalList and must be a defined value");
            }
