...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FundA2BMovementRecord")]
    public partial class FundA2BMovementRecord : IEquatable<FundA2BMovementRecord>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundA2BMovementRecord" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as FundA2BMovementRecord);
        }

        /// <summary>
        /// Returns true if FundA2BMovementRecord instances are equal
        /// </summary>
        /// <param name="input">Instance of FundA2BMovementRecord to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundA2BMovementRecord input)
        {
            if (input == null)
            {
                return false;
