...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class FutureExpiryEvent : InstrumentEvent, IEquatable<FutureExpiryEvent>, IValidatableObject
    {
        ...
        public FutureExpiryEvent(DateTimeOffset expiryDate = default(DateTimeOffset), string settlementCurrency = default(string), decimal? notionalAmountPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for FutureExpiryEvent and must be a defined value");
            }
