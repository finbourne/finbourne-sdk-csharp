...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class FlexibleRepoPartialClosureEvent : InstrumentEvent, IEquatable<FlexibleRepoPartialClosureEvent>, IValidatableObject
    {
        ...
        /// <param name="amountType">AmountType of the cash amount to be exchanged as part of a partial closure of the repurchase agreement.  Either percentage or absolute cash amount. Available values: Percentage, Units. (required).</param>
        ...
        public FlexibleRepoPartialClosureEvent(DateTimeOffset entitlementDate = default(DateTimeOffset), DateTimeOffset settlementDate = default(DateTimeOffset), decimal amount = default(decimal), string amountType = default(string), List<PartialClosureConstituent> partialClosureConstituents = default(List<PartialClosureConstituent>), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for FlexibleRepoPartialClosureEvent and must be a defined value");
            }
        ...
        /// </summary>
        /// <value>AmountType of the cash amount to be exchanged as part of a partial closure of the repurchase agreement.  Either percentage or absolute cash amount. Available values: Percentage, Units.</value>
