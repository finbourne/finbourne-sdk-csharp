...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// ComplianceRunInfoV2
    /// </summary>
    [DataContract(Name = "ComplianceRunInfoV2")]
    public partial class ComplianceRunInfoV2 : IEquatable<ComplianceRunInfoV2>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRunInfoV2" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ComplianceRunInfoV2() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ComplianceRunInfoV2" /> class.
        /// </summary>
        ...
        /// <param name="instigatedBy">instigatedBy (required).</param>
        public ComplianceRunInfoV2(ResourceId runId = default(ResourceId), DateTimeOffset instigatedAt = default(DateTimeOffset), DateTimeOffset completedAt = default(DateTimeOffset), string schedule = default(string), string instigatedBy = default(string))
        {
            // to ensure "runId" is required (not null)
            if (runId == null)
            {
                throw new ArgumentNullException("runId is a required property for ComplianceRunInfoV2 and cannot be null");
            }
            this.RunId = runId;
            ...
            if (schedule == null)
            {
                throw new ArgumentNullException("schedule is a required property for ComplianceRunInfoV2 and cannot be null");
            }
            this.Schedule = schedule;
            // to ensure "instigatedBy" is required (not null)
            if (instigatedBy == null)
            {
                throw new ArgumentNullException("instigatedBy is a required property for ComplianceRunInfoV2 and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "instigatedBy", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InstigatedBy: ").Append(InstigatedBy).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ComplianceRunInfoV2);
        }

        /// <summary>
        /// Returns true if ComplianceRunInfoV2 instances are equal
        /// </summary>
        /// <param name="input">Instance of ComplianceRunInfoV2 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ComplianceRunInfoV2 input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.InstigatedBy == input.InstigatedBy ||
                    (this.InstigatedBy != null &&
                    this.InstigatedBy.Equals(input.InstigatedBy))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InstigatedBy != null)
                {
                    hashCode = (hashCode * 59) + this.InstigatedBy.GetHashCode();
                }
                return hashCode;
            }
        }
