...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ComplexMarketDataActivity : NavActivityAdjustment, IEquatable<ComplexMarketDataActivity>, IValidatableObject
    {
        ...
        public ComplexMarketDataActivity(DateTimeOffset asAt = default(DateTimeOffset), DateTimeOrCutLabel effectiveAt = default(DateTimeOrCutLabel), string entityUniqueId = default(string), NavActivityAdjustmentTypeEnum navActivityAdjustmentType = default(NavActivityAdjustmentTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("navActivityAdjustmentType is a required property for ComplexMarketDataActivity and must be a defined value");
            }
