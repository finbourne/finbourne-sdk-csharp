...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ResourceListOfPerson : IEquatable<ResourceListOfPerson>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfPerson(List<Person> values = default(List<Person>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfPerson and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
