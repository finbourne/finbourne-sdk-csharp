...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ResourceListOfScopeDefinition : IEquatable<ResourceListOfScopeDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfScopeDefinition(List<ScopeDefinition> values = default(List<ScopeDefinition>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfScopeDefinition and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
