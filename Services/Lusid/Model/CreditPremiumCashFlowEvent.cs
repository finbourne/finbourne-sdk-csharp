...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CreditPremiumCashFlowEvent : InstrumentEvent, IEquatable<CreditPremiumCashFlowEvent>, IValidatableObject
    {
        ...
        public CreditPremiumCashFlowEvent(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal? cashFlowPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for CreditPremiumCashFlowEvent and must be a defined value");
            }
