...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ResourceListOfLegalEntity : IEquatable<ResourceListOfLegalEntity>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfLegalEntity(List<LegalEntity> values = default(List<LegalEntity>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfLegalEntity and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
