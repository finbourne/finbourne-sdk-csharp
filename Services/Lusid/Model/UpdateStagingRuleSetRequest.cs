...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateStagingRuleSetRequest")]
    public partial class UpdateStagingRuleSetRequest : IEquatable<UpdateStagingRuleSetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateStagingRuleSetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateStagingRuleSetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateStagingRuleSetRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateStagingRuleSetRequest);
        }

        /// <summary>
        /// Returns true if UpdateStagingRuleSetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateStagingRuleSetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateStagingRuleSetRequest input)
        {
            if (input == null)
            {
                return false;
