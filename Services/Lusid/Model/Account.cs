...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class Account : IEquatable<Account>, IValidatableObject
    {
        ...
        /// <param name="type">The Account type. Available values: Asset, Liabilities, Income, Expense, Capital, Revenue. (required).</param>
        /// <param name="status">The Account status. Available values: Active, Inactive, Deleted. (required).</param>
        /// <param name="control">This allows users to specify whether this a protected Account that prevents direct manual journal adjustment. Default value: Manual. Available values: Manual, System..</param>
        ...
        /// </summary>
        /// <value>The Account type. Available values: Asset, Liabilities, Income, Expense, Capital, Revenue.</value>
        ...
        /// </summary>
        /// <value>This allows users to specify whether this a protected Account that prevents direct manual journal adjustment. Default value: Manual. Available values: Manual, System.</value>
