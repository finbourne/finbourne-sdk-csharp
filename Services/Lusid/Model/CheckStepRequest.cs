...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CheckStepRequest : ComplianceStepRequest, IEquatable<CheckStepRequest>, IValidatableObject
    {
        ...
        public CheckStepRequest(string label = default(string), ComplianceStepTypeRequestEnum complianceStepTypeRequest = default(ComplianceStepTypeRequestEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceStepTypeRequest is a required property for CheckStepRequest and must be a defined value");
            }
