...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class InstrumentListComplianceParameter : ComplianceParameter, IEquatable<InstrumentListComplianceParameter>, IValidatableObject
    {
        ...
        public InstrumentListComplianceParameter(ResourceId value = default(ResourceId), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for InstrumentListComplianceParameter and must be a defined value");
            }
