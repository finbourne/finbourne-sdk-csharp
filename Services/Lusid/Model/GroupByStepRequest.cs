...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// GroupByStepRequest
    /// </summary>
    [DataContract(Name = "GroupByStepRequest")]
    [JsonConverter(typeof(JsonSubtypes), "ComplianceStepTypeRequest")]
    public partial class GroupByStepRequest : ComplianceStepRequest, IEquatable<GroupByStepRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupByStepRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupByStepRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupByStepRequest" /> class.
        /// </summary>
        ...
        public GroupByStepRequest(string label = default(string), ComplianceStepTypeRequestEnum complianceStepTypeRequest = default(ComplianceStepTypeRequestEnum)) : base()
        {
            // to ensure "label" is required (not null)
            if (label == null)
            {
                throw new ArgumentNullException("label is a required property for GroupByStepRequest and cannot be null");
            }
            this.Label = label;
            ...
            {
                throw new ArgumentException("complianceStepTypeRequest is a required property for GroupByStepRequest and must be a defined value");
            }
        ...
        {
            return this.Equals(input as GroupByStepRequest);
        }

        /// <summary>
        /// Returns true if GroupByStepRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupByStepRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupByStepRequest input)
        {
            if (input == null)
            {
                return false;
