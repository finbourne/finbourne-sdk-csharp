...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CashFlowEvent : InstrumentEvent, IEquatable<CashFlowEvent>, IValidatableObject
    {
        ...
        public CashFlowEvent(CashFlowValue cashFlowValue = default(CashFlowValue), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for CashFlowEvent and must be a defined value");
            }
