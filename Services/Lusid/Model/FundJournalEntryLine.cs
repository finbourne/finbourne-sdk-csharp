...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "FundJournalEntryLine")]
    public partial class FundJournalEntryLine : IEquatable<FundJournalEntryLine>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FundJournalEntryLine" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected FundJournalEntryLine() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="FundJournalEntryLine" /> class.
        /// </summary>
        ...
        public FundJournalEntryLine(DateTimeOffset accountingDate = default(DateTimeOffset), DateTimeOffset activityDate = default(DateTimeOffset), ResourceId portfolioId = default(ResourceId), string instrumentId = default(string), string instrumentScope = default(string), Dictionary<string, PerpetualProperty> subHoldingKeys = default(Dictionary<string, PerpetualProperty>), string taxLotId = default(string), string generalLedgerAccountCode = default(string), CurrencyAndAmount local = default(CurrencyAndAmount), CurrencyAndAmount varBase = default(CurrencyAndAmount), decimal units = default(decimal), string postingModuleCode = default(string), string postingRule = default(string), DateTimeOffset asAtDate = default(DateTimeOffset), string activitiesDescription = default(string), string sourceType = default(string), string sourceId = default(string), Dictionary<string, Property> properties = default(Dictionary<string, Property>), string movementName = default(string), string holdingType = default(string), string economicBucket = default(string), string economicBucketComponent = default(string), string economicBucketVariant = default(string), List<string> levels = default(List<string>), List<string> sourceLevels = default(List<string>), string movementSign = default(string), string holdingSign = default(string), string ledgerColumn = default(string), string journalEntryLineType = default(string), List<JournalEntryLineShareClassBreakdown> shareClassBreakdowns = default(List<JournalEntryLineShareClassBreakdown>), List<Link> links = default(List<Link>))
        {
            ...
            if (portfolioId == null)
            {
                throw new ArgumentNullException("portfolioId is a required property for FundJournalEntryLine and cannot be null");
            }
            this.PortfolioId = portfolioId;
            // to ensure "instrumentId" is required (not null)
            if (instrumentId == null)
            {
                throw new ArgumentNullException("instrumentId is a required property for FundJournalEntryLine and cannot be null");
            }
            this.InstrumentId = instrumentId;
            // to ensure "instrumentScope" is required (not null)
            if (instrumentScope == null)
            {
                throw new ArgumentNullException("instrumentScope is a required property for FundJournalEntryLine and cannot be null");
            }
            this.InstrumentScope = instrumentScope;
            // to ensure "generalLedgerAccountCode" is required (not null)
            if (generalLedgerAccountCode == null)
            {
                throw new ArgumentNullException("generalLedgerAccountCode is a required property for FundJournalEntryLine and cannot be null");
            }
            this.GeneralLedgerAccountCode = generalLedgerAccountCode;
            // to ensure "local" is required (not null)
            if (local == null)
            {
                throw new ArgumentNullException("local is a required property for FundJournalEntryLine and cannot be null");
            }
            this.Local = local;
            ...
            if (sourceType == null)
            {
                throw new ArgumentNullException("sourceType is a required property for FundJournalEntryLine and cannot be null");
            }
            this.SourceType = sourceType;
            // to ensure "sourceId" is required (not null)
            if (sourceId == null)
            {
                throw new ArgumentNullException("sourceId is a required property for FundJournalEntryLine and cannot be null");
            }
            this.SourceId = sourceId;
            // to ensure "holdingType" is required (not null)
            if (holdingType == null)
            {
                throw new ArgumentNullException("holdingType is a required property for FundJournalEntryLine and cannot be null");
            }
            this.HoldingType = holdingType;
            // to ensure "economicBucket" is required (not null)
            if (economicBucket == null)
            {
                throw new ArgumentNullException("economicBucket is a required property for FundJournalEntryLine and cannot be null");
            }
        ...
        /// </summary>
        /// <value>Share Class breakdown data for this Journal Entry Line.</value>
        [DataMember(Name = "shareClassBreakdowns", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as FundJournalEntryLine);
        }

        /// <summary>
        /// Returns true if FundJournalEntryLine instances are equal
        /// </summary>
        /// <param name="input">Instance of FundJournalEntryLine to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FundJournalEntryLine input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.ShareClassBreakdowns == input.ShareClassBreakdowns ||
                    this.ShareClassBreakdowns != null &&
                    input.ShareClassBreakdowns != null &&
