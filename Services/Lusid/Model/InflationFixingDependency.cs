...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class InflationFixingDependency : EconomicDependency, IEquatable<InflationFixingDependency>, IValidatableObject
    {
        ...
        public InflationFixingDependency(string type = default(string), string code = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base()
        {
