...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class StringComplianceParameter : ComplianceParameter, IEquatable<StringComplianceParameter>, IValidatableObject
    {
        ...
        public StringComplianceParameter(string value = default(string), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
