...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class GroupBySelectorComplianceParameter : ComplianceParameter, IEquatable<GroupBySelectorComplianceParameter>, IValidatableObject
    {
        ...
        public GroupBySelectorComplianceParameter(string value = default(string), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for GroupBySelectorComplianceParameter and must be a defined value");
            }
