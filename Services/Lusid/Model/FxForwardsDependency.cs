...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class FxForwardsDependency : EconomicDependency, IEquatable<FxForwardsDependency>, IValidatableObject
    {
        ...
        public FxForwardsDependency(string domesticCurrency = default(string), string foreignCurrency = default(string), string curveType = default(string), DateTimeOffset date = default(DateTimeOffset), DependencyTypeEnum dependencyType = default(DependencyTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("dependencyType is a required property for FxForwardsDependency and must be a defined value");
            }
