...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CleardownModuleRequest")]
    public partial class CleardownModuleRequest : IEquatable<CleardownModuleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CleardownModuleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CleardownModuleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CleardownModuleRequest" /> class.
        /// </summary>
        /// <param name="code">The code of the Cleardown Module. (required).</param>
        ...
        public CleardownModuleRequest(string code = default(string), string displayName = default(string), string description = default(string), List<CleardownModuleRule> rules = default(List<CleardownModuleRule>))
        {
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for CleardownModuleRequest and cannot be null");
            }
            this.Code = code;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for CleardownModuleRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as CleardownModuleRequest);
        }

        /// <summary>
        /// Returns true if CleardownModuleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CleardownModuleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CleardownModuleRequest input)
        {
            if (input == null)
            {
                return false;
