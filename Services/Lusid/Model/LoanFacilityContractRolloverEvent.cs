...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class LoanFacilityContractRolloverEvent : InstrumentEvent, IEquatable<LoanFacilityContractRolloverEvent>, IValidatableObject
    {
        ...
        public LoanFacilityContractRolloverEvent(DateTimeOffset date = default(DateTimeOffset), List<RolloverConstituent> rolloverConstituents = default(List<RolloverConstituent>), bool withInterest = default(bool), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
