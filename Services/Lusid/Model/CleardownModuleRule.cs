...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CleardownModuleRule : IEquatable<CleardownModuleRule>, IValidatableObject
    {
        ...
        /// <param name="ruleFilter">The filter syntax for the Cleardown Rule. See https://support.lusid.com/knowledgebase/article/KA-02140 for more information on filter syntax. (required).</param>
        ...
        /// </summary>
        /// <value>The filter syntax for the Cleardown Rule. See https://support.lusid.com/knowledgebase/article/KA-02140 for more information on filter syntax.</value>
