...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ReconcileNumericRule : ReconciliationRule, IEquatable<ReconcileNumericRule>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>Available values: Exact, AbsoluteDifference, RelativeDifference.</value>
        ...
        /// Initializes a new instance of the <see cref="ReconcileNumericRule" /> class.
        /// </summary>
        /// <param name="comparisonType">Available values: Exact, AbsoluteDifference, RelativeDifference. (required).</param>
        ...
        public ReconcileNumericRule(ComparisonTypeEnum comparisonType = default(ComparisonTypeEnum), decimal tolerance = default(decimal), AggregateSpec appliesTo = default(AggregateSpec), RuleTypeEnum ruleType = default(RuleTypeEnum)) : base()
        {
            
            // to ensure "comparisonType" is a defined enum value
            if (!System.Enum.IsDefined(typeof(ComparisonTypeEnum), comparisonType))
            {
                throw new ArgumentException("comparisonType is a required property for ReconcileNumericRule and must be a defined value");
            }
            ...
            {
                throw new ArgumentException("ruleType is a required property for ReconcileNumericRule and must be a defined value");
            }
