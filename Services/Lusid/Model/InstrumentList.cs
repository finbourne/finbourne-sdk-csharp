...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// InstrumentList
    /// </summary>
    [DataContract(Name = "InstrumentList")]
    [JsonConverter(typeof(JsonSubtypes), "ReferenceListType")]
    public partial class InstrumentList : ReferenceList, IEquatable<InstrumentList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InstrumentList" /> class.
        /// </summary>
        ...
        public InstrumentList(List<string> values = default(List<string>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum)) : base()
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for InstrumentList and cannot be null");
            }
            this.Values = values;
            ...
            {
                throw new ArgumentException("referenceListType is a required property for InstrumentList and must be a defined value");
            }
        ...
        {
            return this.Equals(input as InstrumentList);
        }

        /// <summary>
        /// Returns true if InstrumentList instances are equal
        /// </summary>
        /// <param name="input">Instance of InstrumentList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InstrumentList input)
        {
            if (input == null)
            {
                return false;
