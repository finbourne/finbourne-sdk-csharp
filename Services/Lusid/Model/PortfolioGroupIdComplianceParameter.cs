...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PortfolioGroupIdComplianceParameter : ComplianceParameter, IEquatable<PortfolioGroupIdComplianceParameter>, IValidatableObject
    {
        ...
        public PortfolioGroupIdComplianceParameter(ResourceId value = default(ResourceId), ComplianceParameterTypeEnum complianceParameterType = default(ComplianceParameterTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceParameterType is a required property for PortfolioGroupIdComplianceParameter and must be a defined value");
            }
