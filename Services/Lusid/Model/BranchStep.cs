...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class BranchStep : ComplianceStep, IEquatable<BranchStep>, IValidatableObject
    {
        ...
        public BranchStep(string label = default(string), List<ComplianceTemplateParameter> parameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("complianceStepType is a required property for BranchStep and must be a defined value");
            }
