...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpsertStructuredDataResponse")]
    public partial class UpsertStructuredDataResponse : IEquatable<UpsertStructuredDataResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertStructuredDataResponse" /> class.
        /// </summary>
        ...
        public UpsertStructuredDataResponse(string href = default(string), Dictionary<string, DateTimeOffset> values = default(Dictionary<string, DateTimeOffset>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), List<Link> links = default(List<Link>))
        {
            this.Href = href;
            this.Values = values;
            this.Failed = failed;
        ...
        {
            return this.Equals(input as UpsertStructuredDataResponse);
        }

        /// <summary>
        /// Returns true if UpsertStructuredDataResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of UpsertStructuredDataResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpsertStructuredDataResponse input)
        {
            if (input == null)
            {
                return false;
