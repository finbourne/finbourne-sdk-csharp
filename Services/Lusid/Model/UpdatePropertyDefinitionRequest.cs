...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class UpdatePropertyDefinitionRequest : IEquatable<UpdatePropertyDefinitionRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdatePropertyDefinitionRequest(string displayName = default(string), string propertyDescription = default(string), List<string> customEntityTypes = default(List<string>), string valueFormat = default(string))
        {
            ...
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for UpdatePropertyDefinitionRequest and cannot be null");
            }
