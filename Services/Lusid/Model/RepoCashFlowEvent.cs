...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class RepoCashFlowEvent : InstrumentEvent, IEquatable<RepoCashFlowEvent>, IValidatableObject
    {
        ...
        public RepoCashFlowEvent(DateTimeOffset entitlementDate = default(DateTimeOffset), DateTimeOffset settlementDate = default(DateTimeOffset), decimal cashFlowPerUnit = default(decimal), string currency = default(string), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for RepoCashFlowEvent and must be a defined value");
            }
