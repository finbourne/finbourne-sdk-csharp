...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class InvestorIdentifier : IEquatable<InvestorIdentifier>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="InvestorIdentifier" /> class.
        /// </summary>
        /// <param name="investorType">The type of the investor of the Investor Record. Available values: Person, LegalEntity, Nominee. (required).</param>
        ...
        /// </summary>
        /// <value>The type of the investor of the Investor Record. Available values: Person, LegalEntity, Nominee.</value>
