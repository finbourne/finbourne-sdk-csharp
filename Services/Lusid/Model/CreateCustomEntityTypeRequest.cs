...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateCustomEntityTypeRequest")]
    public partial class CreateCustomEntityTypeRequest : IEquatable<CreateCustomEntityTypeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCustomEntityTypeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateCustomEntityTypeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCustomEntityTypeRequest" /> class.
        /// </summary>
        ...
        public CreateCustomEntityTypeRequest(string entityTypeName = default(string), string displayName = default(string), string description = default(string), List<CustomEntityFieldDefinition> fieldSchema = default(List<CustomEntityFieldDefinition>))
        {
            // to ensure "entityTypeName" is required (not null)
            if (entityTypeName == null)
            {
                throw new ArgumentNullException("entityTypeName is a required property for CreateCustomEntityTypeRequest and cannot be null");
            }
            this.EntityTypeName = entityTypeName;
            // to ensure "displayName" is required (not null)
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for CreateCustomEntityTypeRequest and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for CreateCustomEntityTypeRequest and cannot be null");
            }
            this.Description = description;
            // to ensure "fieldSchema" is required (not null)
            if (fieldSchema == null)
            {
                throw new ArgumentNullException("fieldSchema is a required property for CreateCustomEntityTypeRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as CreateCustomEntityTypeRequest);
        }

        /// <summary>
        /// Returns true if CreateCustomEntityTypeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCustomEntityTypeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCustomEntityTypeRequest input)
        {
            if (input == null)
            {
                return false;
