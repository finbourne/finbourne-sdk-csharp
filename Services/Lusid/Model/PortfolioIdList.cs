...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PortfolioIdList : ReferenceList, IEquatable<PortfolioIdList>, IValidatableObject
    {
        ...
        public PortfolioIdList(List<ResourceId> values = default(List<ResourceId>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("referenceListType is a required property for PortfolioIdList and must be a defined value");
            }
