...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ReverseStockSplitEvent : InstrumentEvent, IEquatable<ReverseStockSplitEvent>, IValidatableObject
    {
        ...
        public ReverseStockSplitEvent(DateTimeOffset paymentDate = default(DateTimeOffset), DateTimeOffset exDate = default(DateTimeOffset), UnitsRatio unitsRatio = default(UnitsRatio), DateTimeOffset? recordDate = default(DateTimeOffset?), DateTimeOffset? announcementDate = default(DateTimeOffset?), string fractionalUnitsCashCurrency = default(string), decimal? fractionalUnitsCashPrice = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
