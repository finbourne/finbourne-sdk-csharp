...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class MasteredInstrument : LusidInstrument, IEquatable<MasteredInstrument>, IValidatableObject
    {
        ...
        public MasteredInstrument(Dictionary<string, string> identifiers = default(Dictionary<string, string>), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base()
        {
        ...
        /// </summary>
        /// <value>Asset class of the underlying mastered instrument - read only field    Supported string (enumeration) values are: [InterestRates, FX, Inflation, Equities, Credit, Commodities, Money].  Defaults to \&quot;Unknown\&quot; if not set.</value>
