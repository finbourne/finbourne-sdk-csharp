...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateSimplePositionPortfolioRequest")]
    public partial class CreateSimplePositionPortfolioRequest : IEquatable<CreateSimplePositionPortfolioRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSimplePositionPortfolioRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateSimplePositionPortfolioRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSimplePositionPortfolioRequest" /> class.
        /// </summary>
        /// <param name="displayName">The name of the simple position portfolio. (required).</param>
        ...
        /// <param name="properties">A set of unique portfolio properties to add custom data to the simple position portfolio. Each property must be from the &#39;Portfolio&#39; domain and identified by a key in the format {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. Note these properties must be pre-defined..</param>
        /// <param name="instrumentScopes">The resolution strategy used to resolve instruments of holdings upserted to this portfolio..</param>
        ...
        public CreateSimplePositionPortfolioRequest(string displayName = default(string), string description = default(string), string code = default(string), DateTimeOffset? created = default(DateTimeOffset?), string baseCurrency = default(string), ResourceId corporateActionSourceId = default(ResourceId), AccountingMethodEnum ?accountingMethod = default(AccountingMethodEnum?), List<string> subHoldingKeys = default(List<string>), Dictionary<string, Property> properties = default(Dictionary<string, Property>), List<string> instrumentScopes = default(List<string>), string amortisationMethod = default(string), string transactionTypeScope = default(string), string cashGainLossCalculationDate = default(string), InstrumentEventConfiguration instrumentEventConfiguration = default(InstrumentEventConfiguration), ResourceId amortisationRuleSetId = default(ResourceId))
        {
            ...
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for CreateSimplePositionPortfolioRequest and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for CreateSimplePositionPortfolioRequest and cannot be null");
            }
            this.Code = code;
            // to ensure "baseCurrency" is required (not null)
            if (baseCurrency == null)
            {
                throw new ArgumentNullException("baseCurrency is a required property for CreateSimplePositionPortfolioRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>The name of the simple position portfolio.</value>
        ...
        /// </summary>
        /// <value>A description for the simple position portfolio.</value>
        ...
        /// </summary>
        /// <value>The code of the simple position portfolio. Together with the scope this uniquely identifies the simple position portfolio.</value>
        ...
        /// </summary>
        /// <value>The base currency of the simple position portfolio in ISO 4217 currency code format.</value>
        ...
        /// </summary>
        /// <value>A set of unique portfolio properties to add custom data to the simple position portfolio. Each property must be from the &#39;Portfolio&#39; domain and identified by a key in the format {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. Note these properties must be pre-defined.</value>
        ...
        /// </summary>
        /// <value>The resolution strategy used to resolve instruments of holdings upserted to this portfolio.</value>
        ...
        /// </summary>
        /// <value>The option when the Cash Gain Loss to be calulated. Default value: SettlementDate. Available values: Default, SettlementDate, TransactionDate.</value>
        ...
        {
            return this.Equals(input as CreateSimplePositionPortfolioRequest);
        }

        /// <summary>
        /// Returns true if CreateSimplePositionPortfolioRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateSimplePositionPortfolioRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSimplePositionPortfolioRequest input)
        {
            if (input == null)
            {
                return false;
