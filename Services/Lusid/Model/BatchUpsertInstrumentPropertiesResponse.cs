...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "BatchUpsertInstrumentPropertiesResponse")]
    public partial class BatchUpsertInstrumentPropertiesResponse : IEquatable<BatchUpsertInstrumentPropertiesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchUpsertInstrumentPropertiesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BatchUpsertInstrumentPropertiesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BatchUpsertInstrumentPropertiesResponse" /> class.
        /// </summary>
        ...
        public BatchUpsertInstrumentPropertiesResponse(Dictionary<string, List<Property>> values = default(Dictionary<string, List<Property>>), Dictionary<string, ErrorDetail> failed = default(Dictionary<string, ErrorDetail>), DateTimeOffset asAtDate = default(DateTimeOffset), List<Link> links = default(List<Link>))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for BatchUpsertInstrumentPropertiesResponse and cannot be null");
            }
            this.Values = values;
        ...
        public Dictionary<string, List<Property>> Values { get; set; }
        ...
        {
            return this.Equals(input as BatchUpsertInstrumentPropertiesResponse);
        }

        /// <summary>
        /// Returns true if BatchUpsertInstrumentPropertiesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of BatchUpsertInstrumentPropertiesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BatchUpsertInstrumentPropertiesResponse input)
        {
            if (input == null)
            {
                return false;
