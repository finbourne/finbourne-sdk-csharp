...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class MbsInterestShortfallEvent : InstrumentEvent, IEquatable<MbsInterestShortfallEvent>, IValidatableObject
    {
        ...
        /// <param name="paymentDate">The payment date of the interest.</param>
        ...
        public MbsInterestShortfallEvent(DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), string currency = default(string), decimal? interestPerUnit = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for MbsInterestShortfallEvent and must be a defined value");
            }
