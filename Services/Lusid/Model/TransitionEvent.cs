...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class TransitionEvent : InstrumentEvent, IEquatable<TransitionEvent>, IValidatableObject
    {
        ...
        public TransitionEvent(DateTimeOffset announcementDate = default(DateTimeOffset), DateTimeOffset exDate = default(DateTimeOffset), DateTimeOffset recordDate = default(DateTimeOffset), DateTimeOffset paymentDate = default(DateTimeOffset), InputTransition inputTransition = default(InputTransition), List<OutputTransition> outputTransitions = default(List<OutputTransition>), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for TransitionEvent and must be a defined value");
            }
