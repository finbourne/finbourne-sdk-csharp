...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// CustomEntityEntity
    /// </summary>
    [DataContract(Name = "CustomEntityEntity")]
    public partial class CustomEntityEntity : IEquatable<CustomEntityEntity>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEntityEntity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomEntityEntity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomEntityEntity" /> class.
        /// </summary>
        ...
        public CustomEntityEntity(string href = default(string), string entityUniqueId = default(string), int? asAtVersionNumber = default(int?), string status = default(string), DateTimeOffset? asAtDeleted = default(DateTimeOffset?), string userIdDeleted = default(string), string requestIdDeleted = default(string), DateTimeOffset? effectiveAtCreated = default(DateTimeOffset?), CustomEntityResponse prevailingCustomEntity = default(CustomEntityResponse), CustomEntityResponse deletedCustomEntity = default(CustomEntityResponse), string previewedStatus = default(string), CustomEntityResponse previewedCustomEntity = default(CustomEntityResponse), List<Link> links = default(List<Link>))
        {
            ...
            if (href == null)
            {
                throw new ArgumentNullException("href is a required property for CustomEntityEntity and cannot be null");
            }
            this.Href = href;
            // to ensure "entityUniqueId" is required (not null)
            if (entityUniqueId == null)
            {
                throw new ArgumentNullException("entityUniqueId is a required property for CustomEntityEntity and cannot be null");
            }
            this.EntityUniqueId = entityUniqueId;
            // to ensure "status" is required (not null)
            if (status == null)
            {
                throw new ArgumentNullException("status is a required property for CustomEntityEntity and cannot be null");
            }
            this.Status = status;
        ...
        /// </summary>
        [DataMember(Name = "prevailingCustomEntity", EmitDefaultValue = false)]
        public CustomEntityResponse PrevailingCustomEntity { get; set; }

        /// <summary>
        /// Gets or Sets DeletedCustomEntity
        /// </summary>
        [DataMember(Name = "deletedCustomEntity", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "previewedCustomEntity", EmitDefaultValue = false)]
        public CustomEntityResponse PreviewedCustomEntity { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  PrevailingCustomEntity: ").Append(PrevailingCustomEntity).Append("\n");
            sb.Append("  DeletedCustomEntity: ").Append(DeletedCustomEntity).Append("\n");
            sb.Append("  PreviewedStatus: ").Append(PreviewedStatus).Append("\n");
            sb.Append("  PreviewedCustomEntity: ").Append(PreviewedCustomEntity).Append("\n");
        ...
        {
            return this.Equals(input as CustomEntityEntity);
        }

        /// <summary>
        /// Returns true if CustomEntityEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of CustomEntityEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CustomEntityEntity input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.PrevailingCustomEntity == input.PrevailingCustomEntity ||
                    (this.PrevailingCustomEntity != null &&
                    this.PrevailingCustomEntity.Equals(input.PrevailingCustomEntity))
                ) && 
                (
                    this.DeletedCustomEntity == input.DeletedCustomEntity ||
                    (this.DeletedCustomEntity != null &&
                    this.DeletedCustomEntity.Equals(input.DeletedCustomEntity))
                ) && 
                (
                ...
                (
                    this.PreviewedCustomEntity == input.PreviewedCustomEntity ||
                    (this.PreviewedCustomEntity != null &&
                    this.PreviewedCustomEntity.Equals(input.PreviewedCustomEntity))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrevailingCustomEntity != null)
                {
                    hashCode = (hashCode * 59) + this.PrevailingCustomEntity.GetHashCode();
                }
                if (this.DeletedCustomEntity != null)
                {
                    hashCode = (hashCode * 59) + this.DeletedCustomEntity.GetHashCode();
                }
                if (this.PreviewedStatus != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedStatus.GetHashCode();
                }
                if (this.PreviewedCustomEntity != null)
                {
                    hashCode = (hashCode * 59) + this.PreviewedCustomEntity.GetHashCode();
                }
                if (this.Links != null)
                {
