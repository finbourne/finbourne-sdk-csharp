...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class ExpiryEvent : InstrumentEvent, IEquatable<ExpiryEvent>, IValidatableObject
    {
        ...
        public ExpiryEvent(DateTimeOffset expiryDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for ExpiryEvent and must be a defined value");
            }
