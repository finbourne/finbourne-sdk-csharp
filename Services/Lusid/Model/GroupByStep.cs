...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// GroupByStep
    /// </summary>
    [DataContract(Name = "GroupByStep")]
    [JsonConverter(typeof(JsonSubtypes), "ComplianceStepType")]
    public partial class GroupByStep : ComplianceStep, IEquatable<GroupByStep>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupByStep" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupByStep() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupByStep" /> class.
        /// </summary>
        ...
        public GroupByStep(string label = default(string), List<ComplianceTemplateParameter> parameters = default(List<ComplianceTemplateParameter>), ComplianceStepTypeEnum complianceStepType = default(ComplianceStepTypeEnum)) : base()
        {
            // to ensure "label" is required (not null)
            if (label == null)
            {
                throw new ArgumentNullException("label is a required property for GroupByStep and cannot be null");
            }
            this.Label = label;
            // to ensure "parameters" is required (not null)
            if (parameters == null)
            {
                throw new ArgumentNullException("parameters is a required property for GroupByStep and cannot be null");
            }
            ...
            {
                throw new ArgumentException("complianceStepType is a required property for GroupByStep and must be a defined value");
            }
        ...
        {
            return this.Equals(input as GroupByStep);
        }

        /// <summary>
        /// Returns true if GroupByStep instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupByStep to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupByStep input)
        {
            if (input == null)
            {
                return false;
