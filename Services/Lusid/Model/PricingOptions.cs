...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class PricingOptions : IEquatable<PricingOptions>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>When true, Holding/Units on both legs of an instrument-booked FxForward valued with  ProduceSeparateResultForLinearOtcLegs reports the number of forward contracts held (the  non-split holding units), so that Holding/Units * Valuation/InstrumentPV &#x3D;&#x3D; Valuation/PV  holds on each leg. When false (default), the foreign leg reports  &lt;non-split units&gt; * (fgnAmount / domAmount).</value>
        [DataMember(Name = "fxForwardContractsAsUnitsInBothLegs", EmitDefaultValue = true)]
        public bool FxForwardContractsAsUnitsInBothLegs { get; set; }
        ...
        /// </summary>
        /// <value>When performing lookthrough portfolio expansion with ScalingMethodology set to \&quot;Sum\&quot; or \&quot;AbsoluteSum\&quot;,  the quantity specified here will be conserved and apportioned to lookthrough constituents.  For example, an equal-weighting index with 100 constituents can be modelled as a reference portfolio with 1% weights on each equity.  When expanding a $9000 holding of that index into its constituents while conserving PV, we end up with $90 of each equity.  The number of units of each equity held is then implied.  Note that conservation of one quantity may imply non-conservation of others, especially when some constituents are OTCs.                Allowed values are: \&quot;PV\&quot; (default), \&quot;Exposure\&quot;. Available values: PV, Exposure.</value>
        ...
        /// </summary>
        /// <value>When enabled, an SRS InstrumentAccrued override is multiplied by the instrument contractSize (legacy behaviour).  By default this is disabled, and the override is treated as the accrued for a single unit, keeping the  holding-level identity PV &#x3D; CleanPv + Accrued consistent.</value>
        [DataMember(Name = "scaleInstrumentAccruedOverrideByContractSize", EmitDefaultValue = true)]
        ...
        public bool Equals(PricingOptions input)
        {
            ...
            return 
                ...
                (
                    this.FxForwardContractsAsUnitsInBothLegs == input.FxForwardContractsAsUnitsInBothLegs ||
                    this.FxForwardContractsAsUnitsInBothLegs.Equals(input.FxForwardContractsAsUnitsInBothLegs)
                ) && 
                (
