...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfPropertyDefinition")]
    public partial class ResourceListOfPropertyDefinition : IEquatable<ResourceListOfPropertyDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfPropertyDefinition(List<PropertyDefinition> values = default(List<PropertyDefinition>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfPropertyDefinition and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
