...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class Cash : LusidInstrument, IEquatable<Cash>, IValidatableObject
    {
        ...
        public Cash(string domCcy = default(string), decimal amount = default(decimal), InstrumentTypeEnum instrumentType = default(InstrumentTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentType is a required property for Cash and must be a defined value");
            }
