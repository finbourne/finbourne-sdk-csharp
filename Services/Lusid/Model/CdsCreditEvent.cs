...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CdsCreditEvent")]
    [JsonConverter(typeof(JsonSubtypes), "InstrumentEventType")]
    public partial class CdsCreditEvent : InstrumentEvent, IEquatable<CdsCreditEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CdsCreditEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CdsCreditEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CdsCreditEvent" /> class.
        /// </summary>
        ...
        public CdsCreditEvent(DateTimeOffset effectiveDate = default(DateTimeOffset), DateTimeOffset? auctionDate = default(DateTimeOffset?), decimal? recoveryRate = default(decimal?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for CdsCreditEvent and must be a defined value");
            }
        ...
        {
            return this.Equals(input as CdsCreditEvent);
        }

        /// <summary>
        /// Returns true if CdsCreditEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of CdsCreditEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CdsCreditEvent input)
        {
            if (input == null)
            {
                return false;
