...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ResourceListOfGetRecipeResponse")]
    public partial class ResourceListOfGetRecipeResponse : IEquatable<ResourceListOfGetRecipeResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfGetRecipeResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceListOfGetRecipeResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceListOfGetRecipeResponse" /> class.
        /// </summary>
        ...
        public ResourceListOfGetRecipeResponse(List<GetRecipeResponse> values = default(List<GetRecipeResponse>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            // to ensure "values" is required (not null)
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfGetRecipeResponse and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
