...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PropertyValueEquals")]
    [JsonConverter(typeof(JsonSubtypes), "CriterionType")]
    public partial class PropertyValueEquals : MatchCriterion, IEquatable<PropertyValueEquals>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyValueEquals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PropertyValueEquals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PropertyValueEquals" /> class.
        /// </summary>
        ...
        public PropertyValueEquals(string propertyKey = default(string), string value = default(string), CriterionTypeEnum criterionType = default(CriterionTypeEnum)) : base()
        {
            // to ensure "propertyKey" is required (not null)
            if (propertyKey == null)
            {
                throw new ArgumentNullException("propertyKey is a required property for PropertyValueEquals and cannot be null");
            }
            this.PropertyKey = propertyKey;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for PropertyValueEquals and cannot be null");
            }
            this.Value = value;
            ...
            {
                throw new ArgumentException("criterionType is a required property for PropertyValueEquals and must be a defined value");
            }
        ...
        {
            return this.Equals(input as PropertyValueEquals);
        }

        /// <summary>
        /// Returns true if PropertyValueEquals instances are equal
        /// </summary>
        /// <param name="input">Instance of PropertyValueEquals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PropertyValueEquals input)
        {
            if (input == null)
            {
                return false;
