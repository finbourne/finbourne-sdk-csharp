...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class DepositCloseEvent : InstrumentEvent, IEquatable<DepositCloseEvent>, IValidatableObject
    {
        ...
        public DepositCloseEvent(DateTimeOffset effectiveDate = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for DepositCloseEvent and must be a defined value");
            }
