...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateGroupReconciliationComparisonRulesetRequest")]
    public partial class UpdateGroupReconciliationComparisonRulesetRequest : IEquatable<UpdateGroupReconciliationComparisonRulesetRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateGroupReconciliationComparisonRulesetRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateGroupReconciliationComparisonRulesetRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateGroupReconciliationComparisonRulesetRequest" /> class.
        /// </summary>
        ...
        public UpdateGroupReconciliationComparisonRulesetRequest(string displayName = default(string), string reconciliationType = default(string), List<GroupReconciliationCoreAttributeRule> coreAttributeRules = default(List<GroupReconciliationCoreAttributeRule>), List<GroupReconciliationAggregateAttributeRule> aggregateAttributeRules = default(List<GroupReconciliationAggregateAttributeRule>))
        {
            ...
            if (displayName == null)
            {
                throw new ArgumentNullException("displayName is a required property for UpdateGroupReconciliationComparisonRulesetRequest and cannot be null");
            }
            this.DisplayName = displayName;
            // to ensure "reconciliationType" is required (not null)
            if (reconciliationType == null)
            {
                throw new ArgumentNullException("reconciliationType is a required property for UpdateGroupReconciliationComparisonRulesetRequest and cannot be null");
            }
            this.ReconciliationType = reconciliationType;
            // to ensure "coreAttributeRules" is required (not null)
            if (coreAttributeRules == null)
            {
                throw new ArgumentNullException("coreAttributeRules is a required property for UpdateGroupReconciliationComparisonRulesetRequest and cannot be null");
            }
        ...
        {
            return this.Equals(input as UpdateGroupReconciliationComparisonRulesetRequest);
        }

        /// <summary>
        /// Returns true if UpdateGroupReconciliationComparisonRulesetRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateGroupReconciliationComparisonRulesetRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateGroupReconciliationComparisonRulesetRequest input)
        {
            if (input == null)
            {
                return false;
