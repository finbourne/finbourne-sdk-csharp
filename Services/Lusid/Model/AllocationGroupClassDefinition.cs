...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AllocationGroupClassDefinition")]
    public partial class AllocationGroupClassDefinition : IEquatable<AllocationGroupClassDefinition>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AllocationGroupClassDefinition" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AllocationGroupClassDefinition() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AllocationGroupClassDefinition" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AllocationGroupClassDefinition);
        }

        /// <summary>
        /// Returns true if AllocationGroupClassDefinition instances are equal
        /// </summary>
        /// <param name="input">Instance of AllocationGroupClassDefinition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AllocationGroupClassDefinition input)
        {
            if (input == null)
            {
                return false;
