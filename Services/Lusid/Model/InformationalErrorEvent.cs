...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class InformationalErrorEvent : InstrumentEvent, IEquatable<InformationalErrorEvent>, IValidatableObject
    {
        ...
        public InformationalErrorEvent(string errorDetail = default(string), string errorReason = default(string), DateTimeOffset effectiveAt = default(DateTimeOffset), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
