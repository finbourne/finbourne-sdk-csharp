...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class CdxCreditEvent : InstrumentEvent, IEquatable<CdxCreditEvent>, IValidatableObject
    {
        ...
        public CdxCreditEvent(DateTimeOffset effectiveDate = default(DateTimeOffset), DateTimeOffset? auctionDate = default(DateTimeOffset?), decimal? recoveryRate = default(decimal?), decimal constituentWeight = default(decimal), string constituentReference = default(string), DateTimeOffset? paymentDate = default(DateTimeOffset?), InstrumentEventTypeEnum instrumentEventType = default(InstrumentEventTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("instrumentEventType is a required property for CdxCreditEvent and must be a defined value");
            }
