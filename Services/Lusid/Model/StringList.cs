...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    public partial class StringList : ReferenceList, IEquatable<StringList>, IValidatableObject
    {
        ...
        public StringList(List<string> values = default(List<string>), ReferenceListTypeEnum referenceListType = default(ReferenceListTypeEnum)) : base()
        {
            ...
            {
                throw new ArgumentException("referenceListType is a required property for StringList and must be a defined value");
            }
