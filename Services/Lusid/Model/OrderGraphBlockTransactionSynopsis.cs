...
namespace Finbourne.Sdk.Services.Lusid.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OrderGraphBlockTransactionSynopsis")]
    public partial class OrderGraphBlockTransactionSynopsis : IEquatable<OrderGraphBlockTransactionSynopsis>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderGraphBlockTransactionSynopsis" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OrderGraphBlockTransactionSynopsis() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderGraphBlockTransactionSynopsis" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>Identifiers for each transaction in this block.</value>
        [DataMember(Name = "details", IsRequired = true, EmitDefaultValue = true)]
        public List<OrderGraphBlockTransactionDetail> Details { get; set; }
        ...
        {
            return this.Equals(input as OrderGraphBlockTransactionSynopsis);
        }

        /// <summary>
        /// Returns true if OrderGraphBlockTransactionSynopsis instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderGraphBlockTransactionSynopsis to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderGraphBlockTransactionSynopsis input)
        {
            if (input == null)
            {
                return false;
