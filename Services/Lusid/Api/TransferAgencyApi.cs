...
namespace Finbourne.Sdk.Services.Lusid.Api
{
    ...
    public interface ITransferAgencyApiSync : IApiAccessor
    {
        ...
        Finbourne.Sdk.Client.ApiResponse<TransferAgencyOrdersResponse> UpsertTransferAgencyOrdersWithHttpInfo(Dictionary<string, UpsertTransferAgencyOrderRequest> requestBody, int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface ITransferAgencyApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<TransferAgencyOrdersResponse>> UpsertTransferAgencyOrdersWithHttpInfoAsync(Dictionary<string, UpsertTransferAgencyOrderRequest> requestBody, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
    ...
    public partial class TransferAgencyApi : ITransferAgencyApi
    {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<DeleteTransferAgencyOrdersResponse> localVarResponse = DeleteTransferAgencyOrdersWithHttpInfo(requestBody, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of DeleteTransferAgencyOrdersResponse</returns>
        public Finbourne.Sdk.Client.ApiResponse<DeleteTransferAgencyOrdersResponse> DeleteTransferAgencyOrdersWithHttpInfo(Dictionary<string, DeleteTransferAgencyOrderRequest> requestBody, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
            {
                throw new ArgumentNullException("Missing required parameter 'requestBody' when calling TransferAgencyApi->DeleteTransferAgencyOrders");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<DeleteTransferAgencyOrdersResponse, AbstractOpenAPISchema>("/api/api/transferagency/orders/$delete", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<DeleteTransferAgencyOrdersResponse> localVarResponse = await DeleteTransferAgencyOrdersWithHttpInfoAsync(requestBody, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<DeleteTransferAgencyOrdersResponse>> DeleteTransferAgencyOrdersWithHttpInfoAsync(Dictionary<string, DeleteTransferAgencyOrderRequest> requestBody, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<DeleteTransferAgencyOrdersResponse, AbstractOpenAPISchema>("/api/api/transferagency/orders/$delete", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<TransferAgencyOrdersResponse> localVarResponse = UpsertTransferAgencyOrdersWithHttpInfo(requestBody, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of TransferAgencyOrdersResponse</returns>
        public Finbourne.Sdk.Client.ApiResponse<TransferAgencyOrdersResponse> UpsertTransferAgencyOrdersWithHttpInfo(Dictionary<string, UpsertTransferAgencyOrderRequest> requestBody, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'requestBody' is set
            if (requestBody == null)
            {
                throw new ArgumentNullException("Missing required parameter 'requestBody' when calling TransferAgencyApi->UpsertTransferAgencyOrders");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<TransferAgencyOrdersResponse, AbstractOpenAPISchema>("/api/api/transferagency/orders", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<TransferAgencyOrdersResponse> localVarResponse = await UpsertTransferAgencyOrdersWithHttpInfoAsync(requestBody, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<TransferAgencyOrdersResponse>> UpsertTransferAgencyOrdersWithHttpInfoAsync(Dictionary<string, UpsertTransferAgencyOrderRequest> requestBody, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<TransferAgencyOrdersResponse, AbstractOpenAPISchema>("/api/api/transferagency/orders", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
