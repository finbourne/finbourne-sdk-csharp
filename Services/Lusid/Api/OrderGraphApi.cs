...
namespace Finbourne.Sdk.Services.Lusid.Api
{
    ...
    public interface IOrderGraphApiSync : IApiAccessor
    {
        ...
        Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphBlock> ListOrderGraphBlocksWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? filter = default(string?), List<string>? propertyKeys = default(List<string>?), bool? useComplianceV2 = default(bool?), int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
        ...
        Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> ListOrderGraphPlacementChildrenWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of PagedResourceListOfOrderGraphPlacement</returns>
        Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> ListOrderGraphPlacementsWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? filter = default(string?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface IOrderGraphApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement>> ListOrderGraphPlacementChildrenWithHttpInfoAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// ListOrderGraphPlacements: Lists placements that pass the filter provided, and builds a summary picture of the state of their associated order entities.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>Task of ApiResponse (PagedResourceListOfOrderGraphPlacement)</returns>
        System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement>> ListOrderGraphPlacementsWithHttpInfoAsync(DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? filter = default(string?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
    ...
    public partial class OrderGraphApi : IOrderGraphApi
    {
        ...
        /// <returns></returns>
        public OrderGraphApi(Finbourne.Sdk.Client.Configuration configuration)
        {
        ...
        public OrderGraphApi(Finbourne.Sdk.Client.ISynchronousClient client, Finbourne.Sdk.Client.IAsynchronousClient asyncClient, Finbourne.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphBlock> localVarResponse = ListOrderGraphBlocksWithHttpInfo(asAt, paginationToken, sortBy, limit, filter, propertyKeys, useComplianceV2, opts: opts);
        ...
        public Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphBlock> ListOrderGraphBlocksWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? filter = default(string?), List<string>? propertyKeys = default(List<string>?), bool? useComplianceV2 = default(bool?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Finbourne.Sdk.Client.ClientUtils.ParameterToMultiMap("", "paginationToken", paginationToken));
            }
            if (sortBy != null)
            {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Finbourne.Sdk.Client.ClientUtils.ParameterToMultiMap("", "useComplianceV2", useComplianceV2));
            }
            ...
            var localVarResponse = this.Client.Get<PagedResourceListOfOrderGraphBlock, AbstractOpenAPISchema>("/api/api/ordergraph/blocks", localVarRequestOptions, this.Configuration);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphBlock> localVarResponse = await ListOrderGraphBlocksWithHttpInfoAsync(asAt, paginationToken, sortBy, limit, filter, propertyKeys, useComplianceV2, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphBlock>> ListOrderGraphBlocksWithHttpInfoAsync(DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? filter = default(string?), List<string>? propertyKeys = default(List<string>?), bool? useComplianceV2 = default(bool?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<PagedResourceListOfOrderGraphBlock, AbstractOpenAPISchema>("/api/api/ordergraph/blocks", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> localVarResponse = ListOrderGraphPlacementChildrenWithHttpInfo(scope, code, asAt, paginationToken, sortBy, limit, propertyKeys, opts: opts);
            return localVarResponse.Data;
        }
        ...
        public Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> ListOrderGraphPlacementChildrenWithHttpInfo(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            if (scope == null)
            {
                throw new ArgumentNullException("Missing required parameter 'scope' when calling OrderGraphApi->ListOrderGraphPlacementChildren");
            }

            // verify the required parameter 'code' is set
            if (code == null)
            {
                throw new ArgumentNullException("Missing required parameter 'code' when calling OrderGraphApi->ListOrderGraphPlacementChildren");
            }
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<PagedResourceListOfOrderGraphPlacement, AbstractOpenAPISchema>("/api/api/ordergraph/placementchildren/{scope}/{code}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> localVarResponse = await ListOrderGraphPlacementChildrenWithHttpInfoAsync(scope, code, asAt, paginationToken, sortBy, limit, propertyKeys, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement>> ListOrderGraphPlacementChildrenWithHttpInfoAsync(string scope, string code, DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<PagedResourceListOfOrderGraphPlacement, AbstractOpenAPISchema>("/api/api/ordergraph/placementchildren/{scope}/{code}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> localVarResponse = ListOrderGraphPlacementsWithHttpInfo(asAt, paginationToken, sortBy, limit, filter, propertyKeys, opts: opts);
            return localVarResponse.Data;
        }
        ...
        public Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> ListOrderGraphPlacementsWithHttpInfo(DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? filter = default(string?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<PagedResourceListOfOrderGraphPlacement, AbstractOpenAPISchema>("/api/api/ordergraph/placements", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement> localVarResponse = await ListOrderGraphPlacementsWithHttpInfoAsync(asAt, paginationToken, sortBy, limit, filter, propertyKeys, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<PagedResourceListOfOrderGraphPlacement>> ListOrderGraphPlacementsWithHttpInfoAsync(DateTimeOffset? asAt = default(DateTimeOffset?), string? paginationToken = default(string?), List<string>? sortBy = default(List<string>?), int? limit = default(int?), string? filter = default(string?), List<string>? propertyKeys = default(List<string>?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<PagedResourceListOfOrderGraphPlacement, AbstractOpenAPISchema>("/api/api/ordergraph/placements", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
