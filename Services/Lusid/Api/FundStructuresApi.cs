...
namespace Finbourne.Sdk.Services.Lusid.Api
{
    ...
    public interface IFundStructuresApiSync : IApiAccessor
    {
        ...
        /// <param name="filter">Expression to filter the results. For example, to filter on the Fund Structure code, specify \&quot;id.Code eq &#39;Structure1&#39;\&quot;. For more information about filtering results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid. (optional)</param>
