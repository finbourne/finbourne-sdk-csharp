...
namespace Finbourne.Sdk.Services.Access.Model
{
    ...
    public partial class ResourceListOfPolicyCollectionResponse : IEquatable<ResourceListOfPolicyCollectionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfPolicyCollectionResponse(List<PolicyCollectionResponse> values = default(List<PolicyCollectionResponse>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfPolicyCollectionResponse and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
