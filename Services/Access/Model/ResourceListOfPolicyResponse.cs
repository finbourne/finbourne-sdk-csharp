...
namespace Finbourne.Sdk.Services.Access.Model
{
    ...
    public partial class ResourceListOfPolicyResponse : IEquatable<ResourceListOfPolicyResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfPolicyResponse(List<PolicyResponse> values = default(List<PolicyResponse>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfPolicyResponse and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
