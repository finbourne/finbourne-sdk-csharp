...
namespace Finbourne.Sdk.Services.Access.Model
{
    ...
    public partial class PolicyId : IEquatable<PolicyId>, IValidatableObject
    {
        /// <summary>
        ...
        public PolicyId(string scope = default(string), string code = default(string))
        {
            ...
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for PolicyId and cannot be null");
            }
            this.Code = code;
            this.Scope = scope;
        }
