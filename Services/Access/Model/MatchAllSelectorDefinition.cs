...
namespace Finbourne.Sdk.Services.Access.Model
{
    ...
    public partial class MatchAllSelectorDefinition : IEquatable<MatchAllSelectorDefinition>, IValidatableObject
    {
        /// <summary>
        ...
        public MatchAllSelectorDefinition(List<ActionId> actions = default(List<ActionId>), string name = default(string), string description = default(string))
        {
            ...
            if (actions == null)
            {
                throw new ArgumentNullException("actions is a required property for MatchAllSelectorDefinition and cannot be null");
            }
