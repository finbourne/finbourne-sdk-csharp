...
namespace Finbourne.Sdk.Services.Access.Model
{
    ...
    public partial class TemplateSelection : IEquatable<TemplateSelection>, IValidatableObject
    {
        /// <summary>
        ...
        public TemplateSelection(string scope = default(string), string code = default(string), List<string> selectorTags = default(List<string>))
        {
            ...
            if (scope == null)
            {
                throw new ArgumentNullException("scope is a required property for TemplateSelection and cannot be null");
            }
            this.Scope = scope;
            // to ensure "code" is required (not null)
            if (code == null)
            {
                throw new ArgumentNullException("code is a required property for TemplateSelection and cannot be null");
            }
            this.Code = code;
