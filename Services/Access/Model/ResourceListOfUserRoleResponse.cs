...
namespace Finbourne.Sdk.Services.Access.Model
{
    ...
    public partial class ResourceListOfUserRoleResponse : IEquatable<ResourceListOfUserRoleResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfUserRoleResponse(List<UserRoleResponse> values = default(List<UserRoleResponse>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfUserRoleResponse and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
