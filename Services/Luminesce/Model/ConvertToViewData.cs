...
namespace Finbourne.Sdk.Services.Luminesce.Model
{
    ...
    public partial class ConvertToViewData : IEquatable<ConvertToViewData>, IValidatableObject
    {
        /// <summary>
        ...
        public ConvertToViewData(string query = default(string), string name = default(string), string description = default(string), string documentationLink = default(string), List<ViewParameter> viewParameters = default(List<ViewParameter>), Dictionary<string, string> otherParameters = default(Dictionary<string, string>), string startingVariableName = default(string))
        {
            ...
            if (query == null)
            {
                throw new ArgumentNullException("query is a required property for ConvertToViewData and cannot be null");
            }
            this.Query = query;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ConvertToViewData and cannot be null");
            }
            this.Name = name;
