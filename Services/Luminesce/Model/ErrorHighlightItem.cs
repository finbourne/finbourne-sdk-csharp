...
namespace Finbourne.Sdk.Services.Luminesce.Model
{
    ...
    public partial class ErrorHighlightItem : IEquatable<ErrorHighlightItem>, IValidatableObject
    {
        /// <summary>
        ...
        public ErrorHighlightItem(CursorPosition start = default(CursorPosition), CursorPosition stop = default(CursorPosition), CursorPosition noViableAlternativeStart = default(CursorPosition), int length = default(int), string message = default(string))
        {
            ...
            if (start == null)
            {
                throw new ArgumentNullException("start is a required property for ErrorHighlightItem and cannot be null");
            }
            this.Start = start;
