...
namespace Finbourne.Sdk.Services.Luminesce.Model
{
    ...
    public partial class IntellisenseItem : IEquatable<IntellisenseItem>, IValidatableObject
    {
        ...
        public IntellisenseItem(string caption = default(string), string value = default(string), string meta = default(string), int score = default(int), string docHTML = default(string), IntellisenseType ?type = default(IntellisenseType?))
        {
            ...
            if (caption == null)
            {
                throw new ArgumentNullException("caption is a required property for IntellisenseItem and cannot be null");
            }
            this.Caption = caption;
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for IntellisenseItem and cannot be null");
            }
            this.Value = value;
            this.Meta = meta;
            this.Score = score;
