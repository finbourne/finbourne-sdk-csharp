...
namespace Finbourne.Sdk.Services.Luminesce.Api
{
    ...
    public interface IBinaryDownloadingApiSync : IApiAccessor
    {
        ...
        Finbourne.Sdk.Client.ApiResponse<System.IO.Stream> DownloadBinaryWithHttpInfo(LuminesceBinaryType? type = default(LuminesceBinaryType?), string? version = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null);
        /// <summary>
        ...
        Finbourne.Sdk.Client.ApiResponse<List<string>> GetBinaryVersionsWithHttpInfo(LuminesceBinaryType? type = default(LuminesceBinaryType?), int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface IBinaryDownloadingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<System.IO.Stream>> DownloadBinaryWithHttpInfoAsync(LuminesceBinaryType? type = default(LuminesceBinaryType?), string? version = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
        /// <summary>
        /// GetBinaryVersions: List available versions of binaries
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<List<string>>> GetBinaryVersionsWithHttpInfoAsync(LuminesceBinaryType? type = default(LuminesceBinaryType?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
    ...
    public partial class BinaryDownloadingApi : IBinaryDownloadingApi
    {
        ...
        /// <returns></returns>
        public BinaryDownloadingApi(Finbourne.Sdk.Client.Configuration configuration)
        {
        ...
        public BinaryDownloadingApi(Finbourne.Sdk.Client.ISynchronousClient client, Finbourne.Sdk.Client.IAsynchronousClient asyncClient, Finbourne.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        /// <summary>
        /// DownloadBinary: Download a Luminesce Binary you may run on-site  Downloads the latest version (or specific if needs be) of the specified Luminesce Binary, given the required entitlements.  &gt; This endpoint is an alternative to time-consuming manual distribution via Drive or Email. &gt; it relies on an underlying datastore that is not quite as \&quot;Highly Available\&quot; to the degree  &gt; that FINBOURNE services generally are.   &gt; Thus it is not subject to the same SLAs as other API endpoints are. &gt; *If you perceive an outage, please try again later.*  Once a file has been downloaded the following steps can be used to install it (for the dotnet tools at least):  (1) Open a terminal and cd to the directory you downloaded it to  (2) Install / extract files from that package via:  &#x60;&#x60;&#x60; dotnet tool install NameOfFileWithoutVersionNumberOrExtension -g - -add-source \&quot;.\&quot; &#x60;&#x60;&#x60; e.g. &#x60;&#x60;&#x60; dotnet tool install Finbourne.Luminesce.DbProviders.Oracle_Snowflake -g - -add-source \&quot;.\&quot; &#x60;&#x60;&#x60; More information on the installations can be found [here](https://support.lusid.com/docs/how-do-i-use-the-luminesce-cli).  (3) Execute them (see documentation for specific binary, e.g. [Sql.Db.Mine](https://support.lusid.com/docs/readwrite-to-sql-databases-sqldbmine) or [CLI](https://support.lusid.com/docs/how-do-i-use-the-luminesce-cli)).  The installed binaries can then be found in - Windows - &#x60;%USERPROFILE%\\.dotnet\\tools\\.store\\&#x60; - Linux/macOS - &#x60;$HOME/.dotnet/tools/.store/&#x60;  Note that the binaries all require the dotnet runtime to be installed. - &#x60;dotnet8&#x60; is required for all versions &#x60;1.18.X+&#x60; - &#x60;dotnet6&#x60; is required for all versions &#x60;1.17.X-&#x60; *Please upgrade if still running these*  The following error codes are to be anticipated with standard Problem Detail reports: - 400 BadRequest - binary file is not available for some reason (e.g. permissions or invalid version) - 401 Unauthorized - 403 Forbidden 
        /// </summary>
        /// <exception cref="Finbourne.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Type of binary to download (each requires separate licenses and entitlements) (optional)</param>
        /// <param name="version">An explicit version of the binary.  Leave blank to get the latest version (recommended) (optional)</param>
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<System.IO.Stream> localVarResponse = DownloadBinaryWithHttpInfo(type, version, opts: opts);
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public Finbourne.Sdk.Client.ApiResponse<System.IO.Stream> DownloadBinaryWithHttpInfo(LuminesceBinaryType? type = default(LuminesceBinaryType?), string? version = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            ...
            localVarRequestOptions.Operation = "BinaryDownloadingApi.DownloadBinary";
            ...
            var localVarResponse = this.Client.Get<System.IO.Stream, AbstractOpenAPISchema>("/honeycomb/api/Download/download", localVarRequestOptions, this.Configuration);
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<System.IO.Stream> localVarResponse = await DownloadBinaryWithHttpInfoAsync(type, version, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<System.IO.Stream>> DownloadBinaryWithHttpInfoAsync(LuminesceBinaryType? type = default(LuminesceBinaryType?), string? version = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<System.IO.Stream, AbstractOpenAPISchema>("/honeycomb/api/Download/download", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// GetBinaryVersions: List available versions of binaries  Gets all available versions of a given binary type (from newest to oldest) This does not mean you are entitled to download them.
        /// </summary>
        /// <exception cref="Finbourne.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Type of binary to fetch available versions of (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<List<string>> localVarResponse = GetBinaryVersionsWithHttpInfo(type, opts: opts);
            return localVarResponse.Data;
        }
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public Finbourne.Sdk.Client.ApiResponse<List<string>> GetBinaryVersionsWithHttpInfo(LuminesceBinaryType? type = default(LuminesceBinaryType?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            Finbourne.Sdk.Client.RequestOptions localVarRequestOptions = new Finbourne.Sdk.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "BinaryDownloadingApi.GetBinaryVersions";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<string>, AbstractOpenAPISchema>("/honeycomb/api/Download/versions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<List<string>> localVarResponse = await GetBinaryVersionsWithHttpInfoAsync(type, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<List<string>>> GetBinaryVersionsWithHttpInfoAsync(LuminesceBinaryType? type = default(LuminesceBinaryType?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null)
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<string>, AbstractOpenAPISchema>("/honeycomb/api/Download/versions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
