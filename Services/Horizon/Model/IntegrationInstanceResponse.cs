...
namespace Finbourne.Sdk.Services.Horizon.Model
{
    ...
    public partial class IntegrationInstanceResponse : IEquatable<IntegrationInstanceResponse>, IValidatableObject
    {
        ...
        protected IntegrationInstanceResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IntegrationInstanceResponse" /> class.
        /// </summary>
        ...
        public IntegrationInstanceResponse(string id = default(string), string integrationType = default(string), string name = default(string), string description = default(string), bool enabled = default(bool), List<Trigger> triggers = default(List<Trigger>), Object details = default(Object), List<PostProcessTask> postProcessTasks = default(List<PostProcessTask>))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for IntegrationInstanceResponse and cannot be null");
            }
            this.Id = id;
            // to ensure "integrationType" is required (not null)
            if (integrationType == null)
            {
                throw new ArgumentNullException("integrationType is a required property for IntegrationInstanceResponse and cannot be null");
            }
            this.IntegrationType = integrationType;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for IntegrationInstanceResponse and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for IntegrationInstanceResponse and cannot be null");
            }
            ...
            if (triggers == null)
            {
                throw new ArgumentNullException("triggers is a required property for IntegrationInstanceResponse and cannot be null");
            }
            this.Triggers = triggers;
            // to ensure "details" is required (not null)
            if (details == null)
            {
                throw new ArgumentNullException("details is a required property for IntegrationInstanceResponse and cannot be null");
            }
            this.Details = details;
            // to ensure "postProcessTasks" is required (not null)
            if (postProcessTasks == null)
            {
                throw new ArgumentNullException("postProcessTasks is a required property for IntegrationInstanceResponse and cannot be null");
            }
        ...
        {
            return this.Equals(input as IntegrationInstanceResponse);
        }

        /// <summary>
        /// Returns true if IntegrationInstanceResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IntegrationInstanceResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IntegrationInstanceResponse input)
        {
            if (input == null)
            {
                return false;
