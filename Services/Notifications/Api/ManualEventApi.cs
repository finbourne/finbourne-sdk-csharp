...
namespace Finbourne.Sdk.Services.Notifications.Api
{
    ...
    public interface IManualEventApiSync : IApiAccessor
    {
        ...
        Finbourne.Sdk.Client.ApiResponse<ManualEvent> TriggerManualEventWithHttpInfo(ManualEventRequest manualEventRequest, int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface IManualEventApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<ManualEvent>> TriggerManualEventWithHttpInfoAsync(ManualEventRequest manualEventRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
    ...
    public partial class ManualEventApi : IManualEventApi
    {
        ...
        /// <returns></returns>
        public ManualEventApi(Finbourne.Sdk.Client.Configuration configuration)
        {
        ...
        public ManualEventApi(Finbourne.Sdk.Client.ISynchronousClient client, Finbourne.Sdk.Client.IAsynchronousClient asyncClient, Finbourne.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ManualEvent> localVarResponse = TriggerManualEventWithHttpInfo(manualEventRequest, opts: opts);
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of ManualEvent</returns>
        public Finbourne.Sdk.Client.ApiResponse<ManualEvent> TriggerManualEventWithHttpInfo(ManualEventRequest manualEventRequest, int operationIndex = 0, ConfigurationOptions? opts = null)
        {
            // verify the required parameter 'manualEventRequest' is set
            if (manualEventRequest == null)
            {
                throw new ArgumentNullException("Missing required parameter 'manualEventRequest' when calling ManualEventApi->TriggerManualEvent");
            }
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ManualEvent> localVarResponse = await TriggerManualEventWithHttpInfoAsync(manualEventRequest, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
