...
namespace Finbourne.Sdk.Services.Notifications.Api
{
    ...
    public interface IDeliveriesApiSync : IApiAccessor
    {
        ...
        Finbourne.Sdk.Client.ApiResponse<ResourceListOfDelivery> ListDeliveriesWithHttpInfo(string? page = default(string?), int? limit = default(int?), string? filter = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null);
    ...
    public interface IDeliveriesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<Finbourne.Sdk.Client.ApiResponse<ResourceListOfDelivery>> ListDeliveriesWithHttpInfoAsync(string? page = default(string?), int? limit = default(int?), string? filter = default(string?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken), ConfigurationOptions? opts = null);
    ...
    public partial class DeliveriesApi : IDeliveriesApi
    {
        ...
        /// <returns></returns>
        public DeliveriesApi(Finbourne.Sdk.Client.Configuration configuration)
        {
        ...
        public DeliveriesApi(Finbourne.Sdk.Client.ISynchronousClient client, Finbourne.Sdk.Client.IAsynchronousClient asyncClient, Finbourne.Sdk.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ResourceListOfDelivery> localVarResponse = ListDeliveriesWithHttpInfo(page, limit, filter, opts: opts);
        ...
        /// <param name="opts">Options for this request.</param>
        /// <returns>ApiResponse of ResourceListOfDelivery</returns>
        public Finbourne.Sdk.Client.ApiResponse<ResourceListOfDelivery> ListDeliveriesWithHttpInfo(string? page = default(string?), int? limit = default(int?), string? filter = default(string?), int operationIndex = 0, ConfigurationOptions? opts = null)
        {
        ...
        {
            Finbourne.Sdk.Client.ApiResponse<ResourceListOfDelivery> localVarResponse = await ListDeliveriesWithHttpInfoAsync(page, limit, filter, operationIndex, cancellationToken, opts).ConfigureAwait(false);
            return localVarResponse.Data;
        }
