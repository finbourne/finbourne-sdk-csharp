...
namespace Finbourne.Sdk.Services.Configuration.Model
{
    ...
    public partial class ResourceListOfConfigurationItem : IEquatable<ResourceListOfConfigurationItem>, IValidatableObject
    {
        /// <summary>
        ...
        public ResourceListOfConfigurationItem(List<ConfigurationItem> values = default(List<ConfigurationItem>), string href = default(string), List<Link> links = default(List<Link>), string nextPage = default(string), string previousPage = default(string))
        {
            ...
            if (values == null)
            {
                throw new ArgumentNullException("values is a required property for ResourceListOfConfigurationItem and cannot be null");
            }
            this.Values = values;
            this.Href = href;
            this.Links = links;
