# Finbourne.Sdk.Workflow.Api.ApplicationMetadataApi
...
|--------|--------------|-------------|
| [**ListAccessControlledResources**](#listaccesscontrolledresources) | **GET** `/workflow/api/metadata/access/resources` | ListAccessControlledResources: Get resources available for access control |
