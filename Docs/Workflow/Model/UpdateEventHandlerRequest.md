# Finbourne.Sdk.Workflow.Model.UpdateEventHandlerRequest
...
var instance = new UpdateEventHandlerRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<UpdateEventHandlerRequest>(json);
```
