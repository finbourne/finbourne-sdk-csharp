# Finbourne.Sdk.Workflow.Model.UpdateMatchingTasksActivityResponse
...
|------|------|----------|-------------|
| **Type** | **string** | Optional | The type of task activity |
| **Filter** | **string** | Optional | The filter that matches on existing tasks |
| **Trigger** | **string** | Optional | Trigger to supply to all tasks that have been matched |
...
var instance = new UpdateMatchingTasksActivityResponse(
    type: "...",  // optional — The type of task activity
    filter: "...",  // optional — The filter that matches on existing tasks
    trigger: "...",  // optional — Trigger to supply to all tasks that have been matched
...
```csharp
var instance = JsonConvert.DeserializeObject<UpdateMatchingTasksActivityResponse>(json);
```
