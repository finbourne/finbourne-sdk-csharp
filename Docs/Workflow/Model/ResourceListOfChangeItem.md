# Finbourne.Sdk.Workflow.Model.ResourceListOfChangeItem
...
var instance = new ResourceListOfChangeItem(
    values: new List<ChangeItem>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfChangeItem>(json);
```
