# Finbourne.Sdk.Workflow.Model.BatchUpsertWorkflowPropertiesResponse
...
var instance = new BatchUpsertWorkflowPropertiesResponse(
...
```csharp
var instance = JsonConvert.DeserializeObject<BatchUpsertWorkflowPropertiesResponse>(json);
```
