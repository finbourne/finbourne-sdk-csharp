# Finbourne.Sdk.Insights.Model.ResourceListWithHistogramOfVendorLog
...
var instance = new ResourceListWithHistogramOfVendorLog(
    histogram: new Histogram(...),  // optional
    values: new List<VendorLog>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListWithHistogramOfVendorLog>(json);
```
