# Finbourne.Sdk.Insights.Model.ResourceListOfTraceEventLog
...
var instance = new ResourceListOfTraceEventLog(
    values: new List<TraceEventLog>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfTraceEventLog>(json);
```
