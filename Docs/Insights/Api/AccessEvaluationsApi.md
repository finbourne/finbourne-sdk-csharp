# Finbourne.Sdk.Insights.Api.AccessEvaluationsApi
...
|--------|--------------|-------------|
| [**GetAccessEvaluationLog**](#getaccessevaluationlog) | **GET** `/insights/api/access/{id}` | [EARLY ACCESS] GetAccessEvaluationLog: Get the log for a specific access evaluation. This endpoint will be deprecated in the near future. |
| [**ListAccessEvaluationLogs**](#listaccessevaluationlogs) | **GET** `/insights/api/access` | [EARLY ACCESS] ListAccessEvaluationLogs: List the logs for access evaluations. |
...
|------|------|----|----------|-------------|
| **id** | **string** | path | **required** | The identifier of the access evaluation to obtain the log for. |
...
<details>
<summary>Using the GetAccessEvaluationLogWithHttpInfo variant</summary>
...
| Name | Type | In | Required | Description |
|------|------|----|----------|-------------|
| **startAt** | **DateTimeOffset?** | query | optional | Start date from which point to fetch logs. |
| **endAt** | **DateTimeOffset?** | query | optional | End date to which point to fetch logs. |
...
| **histogramInterval** | **string?** | query | optional | The interval for an included histogram of the logs |
...
<details>
<summary>Using the ListAccessEvaluationLogsWithHttpInfo variant</summary>
