# Finbourne.Sdk.Access.Api.ApplicationMetadataApi
...
|--------|--------------|-------------|
| [**ListAccessControlledResources**](#listaccesscontrolledresources) | **GET** `/access/api/metadata/access/resources` | ListAccessControlledResources: Get resources available for access control |
