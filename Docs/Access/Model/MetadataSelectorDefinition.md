# Finbourne.Sdk.Access.Model.MetadataSelectorDefinition
...
var instance = new MetadataSelectorDefinition(
    expressions: new List<MetadataExpression>(),  // required
...
```csharp
var instance = JsonConvert.DeserializeObject<MetadataSelectorDefinition>(json);
```
