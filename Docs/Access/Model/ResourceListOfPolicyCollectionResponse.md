# Finbourne.Sdk.Access.Model.ResourceListOfPolicyCollectionResponse
...
var instance = new ResourceListOfPolicyCollectionResponse(
    values: new List<PolicyCollectionResponse>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfPolicyCollectionResponse>(json);
```
