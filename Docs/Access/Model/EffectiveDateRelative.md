# Finbourne.Sdk.Access.Model.EffectiveDateRelative
...
var instance = new EffectiveDateRelative(
    date: ,  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<EffectiveDateRelative>(json);
```
