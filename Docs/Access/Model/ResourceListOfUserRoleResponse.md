# Finbourne.Sdk.Access.Model.ResourceListOfUserRoleResponse
...
var instance = new ResourceListOfUserRoleResponse(
    values: new List<UserRoleResponse>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfUserRoleResponse>(json);
```
