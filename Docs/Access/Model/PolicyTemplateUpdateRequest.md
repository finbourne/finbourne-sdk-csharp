# Finbourne.Sdk.Access.Model.PolicyTemplateUpdateRequest
...
var instance = new PolicyTemplateUpdateRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<PolicyTemplateUpdateRequest>(json);
```
