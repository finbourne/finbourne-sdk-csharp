# Finbourne.Sdk.Configuration.Api.ApplicationMetadataApi
...
|--------|--------------|-------------|
| [**ListAccessControlledResources**](#listaccesscontrolledresources) | **GET** `/configuration/api/metadata/access/resources` | [EARLY ACCESS] ListAccessControlledResources: Get resources available for access control |
