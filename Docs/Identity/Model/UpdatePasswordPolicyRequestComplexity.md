# Finbourne.Sdk.Identity.Model.UpdatePasswordPolicyRequestComplexity
...
var instance = new UpdatePasswordPolicyRequestComplexity(
...
```csharp
var instance = JsonConvert.DeserializeObject<UpdatePasswordPolicyRequestComplexity>(json);
```
