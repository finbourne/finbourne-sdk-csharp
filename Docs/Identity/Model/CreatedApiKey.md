# Finbourne.Sdk.Identity.Model.CreatedApiKey
...
var instance = new CreatedApiKey(
    key: "...",  // required — The API Key value
...
```csharp
var instance = JsonConvert.DeserializeObject<CreatedApiKey>(json);
```
