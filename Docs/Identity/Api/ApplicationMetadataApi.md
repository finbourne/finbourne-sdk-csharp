# Finbourne.Sdk.Identity.Api.ApplicationMetadataApi
...
|--------|--------------|-------------|
| [**ListAccessControlledResources**](#listaccesscontrolledresources) | **GET** `/identity/api/metadata/access/resources` | ListAccessControlledResources: Get resources available for access control |
