# Finbourne.Sdk.Notifications.Api.ManualEventApi
...
```csharp
var apiInstance = ApiFactoryBuilder.Build(secretsFilename).Api<ManualEventApi>();
var manualEventRequest = new ManualEventRequest(); // ManualEventRequest
...
<details>
<summary>Using the TriggerManualEventWithHttpInfo variant</summary>
