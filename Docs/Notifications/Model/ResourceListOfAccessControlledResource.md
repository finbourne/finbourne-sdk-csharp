# Finbourne.Sdk.Notifications.Model.ResourceListOfAccessControlledResource
...
var instance = new ResourceListOfAccessControlledResource(
    values: new List<AccessControlledResource>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfAccessControlledResource>(json);
```
