# Finbourne.Sdk.Notifications.Model.ResourceListOfNotification
...
var instance = new ResourceListOfNotification(
    values: new List<Notification>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfNotification>(json);
```
