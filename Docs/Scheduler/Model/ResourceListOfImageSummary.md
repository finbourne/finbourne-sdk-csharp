# Finbourne.Sdk.Scheduler.Model.ResourceListOfImageSummary
...
var instance = new ResourceListOfImageSummary(
    values: new List<ImageSummary>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfImageSummary>(json);
```
