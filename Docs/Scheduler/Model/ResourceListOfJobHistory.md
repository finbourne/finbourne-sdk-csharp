# Finbourne.Sdk.Scheduler.Model.ResourceListOfJobHistory
...
var instance = new ResourceListOfJobHistory(
    values: new List<JobHistory>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfJobHistory>(json);
```
