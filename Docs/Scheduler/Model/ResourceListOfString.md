# Finbourne.Sdk.Scheduler.Model.ResourceListOfString
...
var instance = new ResourceListOfString(
    values: ,  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfString>(json);
```
