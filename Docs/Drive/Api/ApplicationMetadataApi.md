# Finbourne.Sdk.Drive.Api.ApplicationMetadataApi
...
|--------|--------------|-------------|
| [**ListAccessControlledResources**](#listaccesscontrolledresources) | **GET** `/drive/api/metadata/access/resources` | [EARLY ACCESS] ListAccessControlledResources: Get resources available for access control |
