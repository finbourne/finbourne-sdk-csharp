...
| **limit** | **int?** | query | optional | When paginating, limit the results to this number. |
| **filter** | **string?** | query | optional | Expression to filter the result set. Defaults to filtering out inactive instruments               (that is, those that have been deleted). For more information about filtering results,               see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid. Default: `&quot;State eq &#39;Active&#39;&quot;` |
