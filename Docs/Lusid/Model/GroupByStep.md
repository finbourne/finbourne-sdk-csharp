# Finbourne.Sdk.Lusid.Model.GroupByStep
...
| **ComplianceStepType** | **string** | Required | The type of the compliance step. Available values: FilterStep, GroupByStep, GroupFilterStep, BranchStep, RecombineStep, CheckStep, PercentCheckStep. Default: `ComplianceStepTypeEnum.GroupByStep` |
...
```csharp
var instance = JsonConvert.DeserializeObject<GroupByStep>(json);
```
