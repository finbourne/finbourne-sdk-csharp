# Finbourne.Sdk.Lusid.Model.ShareClassDefinition
...
var instance = new ShareClassDefinition(
...
```csharp
var instance = JsonConvert.DeserializeObject<ShareClassDefinition>(json);
```
