...
| **InstrumentIdType** | **string** | Optional | The type of instrument identifier used to uniquely identify the instrument that the quote is for. |
...
var instance = new QuoteAccessMetadataRuleId(
    ...
    instrumentIdType: "...",  // optional — The type of instrument identifier used to uniquely identify the instrument that the quote is for.
