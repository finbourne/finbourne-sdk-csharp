# Finbourne.Sdk.Lusid.Model.ComplianceSummaryRuleResult
...
| **RuleBreakdown** | [List&lt;ComplianceRuleBreakdown&gt;](ComplianceRuleBreakdown.md) | Required | *No description available.* |
...
var instance = new ComplianceSummaryRuleResult(
    ...
    ruleBreakdown: new List<ComplianceRuleBreakdown>()  // required
);
```
### Serializing to JSON
...
```csharp
var instance = JsonConvert.DeserializeObject<ComplianceSummaryRuleResult>(json);
```
