...
| **SettlementConfiguration** | [NavSettlementConfiguration](NavSettlementConfiguration.md) | Required | *No description available.* |
...
var instance = new NavType(
    ...
    settlementConfiguration: new NavSettlementConfiguration(...),  // required
