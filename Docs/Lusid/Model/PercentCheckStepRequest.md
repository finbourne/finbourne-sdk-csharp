...
| **ComplianceStepTypeRequest** | **string** | Required | The type of the compliance step. Available values: FilterStepRequest, GroupByStepRequest, GroupFilterStepRequest, BranchStepRequest, CheckStepRequest, PercentCheckStepRequest. Default: `ComplianceStepTypeRequestEnum.PercentCheckStepRequest` |
