# Finbourne.Sdk.Lusid.Model.DeleteInstrumentResponse
...
var instance = new DeleteInstrumentResponse(
...
```csharp
var instance = JsonConvert.DeserializeObject<DeleteInstrumentResponse>(json);
```
