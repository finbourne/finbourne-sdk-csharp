# Finbourne.Sdk.Lusid.Model.DepositInterestPaymentEvent
...
var instance = new DepositInterestPaymentEvent(
...
```csharp
var instance = JsonConvert.DeserializeObject<DepositInterestPaymentEvent>(json);
```
