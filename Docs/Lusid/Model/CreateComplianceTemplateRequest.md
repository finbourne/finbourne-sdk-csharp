# Finbourne.Sdk.Lusid.Model.CreateComplianceTemplateRequest
...
var instance = new CreateComplianceTemplateRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<CreateComplianceTemplateRequest>(json);
```
