# Finbourne.Sdk.Lusid.Model.AccumulationEvent
...
| **DividendCurrency** | **string** | Required | Payment currency |
| **DividendRate** | **decimal** | Required | Dividend rate or payment rate as a percentage.  i.e. 5% is written as 0.05 |
...
var instance = new AccumulationEvent(
    announcementDate: DateTimeOffset.Now,  // optional — Date on which the dividend was announced / declared.
    dividendCurrency: "...",  // required — Payment currency
    dividendRate: 0.0d,  // required — Dividend rate or payment rate as a percentage.  i.e. 5% is written as 0.05
...
```csharp
var instance = JsonConvert.DeserializeObject<AccumulationEvent>(json);
```
