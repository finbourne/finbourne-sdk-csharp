# Finbourne.Sdk.Lusid.Model.ResourceListOfTransactionSettlementInstruction
...
var instance = new ResourceListOfTransactionSettlementInstruction(
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfTransactionSettlementInstruction>(json);
```
