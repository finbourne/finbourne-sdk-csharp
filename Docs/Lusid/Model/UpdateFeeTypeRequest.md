# Finbourne.Sdk.Lusid.Model.UpdateFeeTypeRequest
...
var instance = new UpdateFeeTypeRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<UpdateFeeTypeRequest>(json);
```
