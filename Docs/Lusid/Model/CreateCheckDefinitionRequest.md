# Finbourne.Sdk.Lusid.Model.CreateCheckDefinitionRequest
...
var instance = new CreateCheckDefinitionRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<CreateCheckDefinitionRequest>(json);
```
