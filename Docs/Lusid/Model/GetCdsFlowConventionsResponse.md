# Finbourne.Sdk.Lusid.Model.GetCdsFlowConventionsResponse
...
| **Value** | [CdsFlowConventions](CdsFlowConventions.md) | Optional | *No description available.* |
...
var instance = new GetCdsFlowConventionsResponse(
    href: "...",  // optional — The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime.
    value: new CdsFlowConventions(...),  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<GetCdsFlowConventionsResponse>(json);
```
