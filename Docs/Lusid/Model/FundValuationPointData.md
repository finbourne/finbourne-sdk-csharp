...
| **Dealing** | [Dictionary&lt;string, FundAmount&gt;](FundAmount.md) | Required | Bucket of detail for any &#39;Dealing&#39; that has occurred inside the queried period. |
...
var instance = new FundValuationPointData(
    ...
    dealing: new FundAmount(...),  // required — Bucket of detail for any &#39;Dealing&#39; that has occurred inside the queried period.
