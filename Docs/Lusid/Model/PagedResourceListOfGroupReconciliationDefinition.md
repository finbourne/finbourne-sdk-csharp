# Finbourne.Sdk.Lusid.Model.PagedResourceListOfGroupReconciliationDefinition
...
var instance = new PagedResourceListOfGroupReconciliationDefinition(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<GroupReconciliationDefinition>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfGroupReconciliationDefinition>(json);
```
