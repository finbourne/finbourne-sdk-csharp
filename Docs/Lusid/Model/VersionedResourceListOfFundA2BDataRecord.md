# Finbourne.Sdk.Lusid.Model.VersionedResourceListOfFundA2BDataRecord
...
var instance = new VersionedResourceListOfFundA2BDataRecord(
    varVersion: new ModelVersion(...),  // required
    values: new List<FundA2BDataRecord>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<VersionedResourceListOfFundA2BDataRecord>(json);
```
