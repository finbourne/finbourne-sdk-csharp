# Finbourne.Sdk.Lusid.Model.FilterStep
...
| **ComplianceStepType** | **string** | Required | The type of the compliance step. Available values: FilterStep, GroupByStep, GroupFilterStep, BranchStep, RecombineStep, CheckStep, PercentCheckStep. Default: `ComplianceStepTypeEnum.FilterStep` |
...
```csharp
var instance = JsonConvert.DeserializeObject<FilterStep>(json);
```
