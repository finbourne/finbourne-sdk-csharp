# Finbourne.Sdk.Lusid.Model.AllocationGroup
...
var instance = new AllocationGroup(
    classes: new List<AllocationGroupClass>(),  // optional — An optional list of share classes that belong to this group. Each entry must reference a ShareClass already present on the Fund. You can provide this or the Formula, but not both.
...
```csharp
var instance = JsonConvert.DeserializeObject<AllocationGroup>(json);
```
