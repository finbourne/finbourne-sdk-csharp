# Finbourne.Sdk.Lusid.Model.HoldingsAdjustmentHeader
...
var instance = new HoldingsAdjustmentHeader(
...
```csharp
var instance = JsonConvert.DeserializeObject<HoldingsAdjustmentHeader>(json);
```
