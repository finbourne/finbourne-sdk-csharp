# Finbourne.Sdk.Lusid.Model.CreateRecDefinitionRequest
...
var instance = new CreateRecDefinitionRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<CreateRecDefinitionRequest>(json);
```
