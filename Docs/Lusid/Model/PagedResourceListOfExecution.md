# Finbourne.Sdk.Lusid.Model.PagedResourceListOfExecution
...
var instance = new PagedResourceListOfExecution(
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfExecution>(json);
```
