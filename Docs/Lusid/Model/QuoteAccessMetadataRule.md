# Finbourne.Sdk.Lusid.Model.QuoteAccessMetadataRule
...
var instance = new QuoteAccessMetadataRule(
...
```csharp
var instance = JsonConvert.DeserializeObject<QuoteAccessMetadataRule>(json);
```
