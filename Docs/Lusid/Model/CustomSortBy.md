...
| **RemainderOrder** | **string** | Required | The sorting direction for the remaining field values. Either ascending (ASC) or descending (DESC). Available values: ASC, DESC. |
...
var instance = new CustomSortBy(
    ...
    remainderOrder: "..."  // required — The sorting direction for the remaining field values. Either ascending (ASC) or descending (DESC). Available values: ASC, DESC.
);
```
### Serializing to JSON
