# Finbourne.Sdk.Lusid.Model.ValuationPointResourceListOfFundCashStatementRow
...
| **Values** | [List&lt;FundCashStatementRow&gt;](FundCashStatementRow.md) | Required | *No description available.* |
...
var instance = new ValuationPointResourceListOfFundCashStatementRow(
    startValuationPoint: new DiaryEntry(...),  // optional
    varVersion: new ModelVersion(...),  // required
    values: new List<FundCashStatementRow>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ValuationPointResourceListOfFundCashStatementRow>(json);
```
...
- [FundCashStatementRow](FundCashStatementRow.md)
- [Link](Link.md)
