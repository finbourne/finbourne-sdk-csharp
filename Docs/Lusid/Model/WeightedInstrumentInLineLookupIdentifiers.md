# Finbourne.Sdk.Lusid.Model.WeightedInstrumentInLineLookupIdentifiers
...
var instance = new WeightedInstrumentInLineLookupIdentifiers(
...
```csharp
var instance = JsonConvert.DeserializeObject<WeightedInstrumentInLineLookupIdentifiers>(json);
```
