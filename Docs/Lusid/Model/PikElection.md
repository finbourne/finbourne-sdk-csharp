# Finbourne.Sdk.Lusid.Model.PikElection
...
|------|------|----------|-------------|
| **ElectionKey** | **string** | Required | Unique key associated to this election (the PIK type) |
...
var instance = new PikElection(
    electionKey: "...",  // required — Unique key associated to this election (the PIK type)
...
```csharp
var instance = JsonConvert.DeserializeObject<PikElection>(json);
```
