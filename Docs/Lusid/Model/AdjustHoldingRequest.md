# Finbourne.Sdk.Lusid.Model.AdjustHoldingRequest
...
var instance = new AdjustHoldingRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<AdjustHoldingRequest>(json);
```
