# Finbourne.Sdk.Lusid.Model.FxVolSurfaceData
...
var instance = new FxVolSurfaceData(
...
```csharp
var instance = JsonConvert.DeserializeObject<FxVolSurfaceData>(json);
```
