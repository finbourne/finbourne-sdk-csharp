# Finbourne.Sdk.Lusid.Model.PagedResourceListOfAllocation
...
var instance = new PagedResourceListOfAllocation(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<Allocation>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfAllocation>(json);
```
