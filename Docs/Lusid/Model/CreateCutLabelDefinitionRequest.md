# Finbourne.Sdk.Lusid.Model.CreateCutLabelDefinitionRequest
...
var instance = new CreateCutLabelDefinitionRequest(
    code: "...",  // required
...
```csharp
var instance = JsonConvert.DeserializeObject<CreateCutLabelDefinitionRequest>(json);
```
