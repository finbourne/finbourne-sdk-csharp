# Finbourne.Sdk.Lusid.Model.EquityShiftDefinition
...
var instance = new EquityShiftDefinition(
    instrument: "...",  // required
...
```csharp
var instance = JsonConvert.DeserializeObject<EquityShiftDefinition>(json);
```
