...
| **LapseElections** | [List&lt;LapseElection&gt;](LapseElection.md) | Optional | List of possible lapse elections for this merger event (NOAC). |
| **UnknownProceedsElections** | [List&lt;UnknownProceedsElection&gt;](UnknownProceedsElection.md) | Optional | List of possible unknown-proceeds elections for this merger event (UNKNOWN) — the outturn is not yet known. |
...
var instance = new MergerEvent(
    ...
    lapseElections: new List<LapseElection>(),  // optional — List of possible lapse elections for this merger event (NOAC).
    unknownProceedsElections: new List<UnknownProceedsElection>(),  // optional — List of possible unknown-proceeds elections for this merger event (UNKNOWN) — the outturn is not yet known.
