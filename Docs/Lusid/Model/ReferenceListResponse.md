# Finbourne.Sdk.Lusid.Model.ReferenceListResponse
...
var instance = new ReferenceListResponse(
...
```csharp
var instance = JsonConvert.DeserializeObject<ReferenceListResponse>(json);
```
