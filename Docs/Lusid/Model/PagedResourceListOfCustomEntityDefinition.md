# Finbourne.Sdk.Lusid.Model.PagedResourceListOfCustomEntityDefinition
...
var instance = new PagedResourceListOfCustomEntityDefinition(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<CustomEntityDefinition>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfCustomEntityDefinition>(json);
```
