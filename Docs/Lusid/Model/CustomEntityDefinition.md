# Finbourne.Sdk.Lusid.Model.CustomEntityDefinition
...
var instance = new CustomEntityDefinition(
...
```csharp
var instance = JsonConvert.DeserializeObject<CustomEntityDefinition>(json);
```
