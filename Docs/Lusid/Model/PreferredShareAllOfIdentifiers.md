# Finbourne.Sdk.Lusid.Model.PreferredShareAllOfIdentifiers
...
var instance = new PreferredShareAllOfIdentifiers(
...
```csharp
var instance = JsonConvert.DeserializeObject<PreferredShareAllOfIdentifiers>(json);
```
