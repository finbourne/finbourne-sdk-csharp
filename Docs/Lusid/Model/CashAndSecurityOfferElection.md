# Finbourne.Sdk.Lusid.Model.CashAndSecurityOfferElection
...
var instance = new CashAndSecurityOfferElection(
...
```csharp
var instance = JsonConvert.DeserializeObject<CashAndSecurityOfferElection>(json);
```
