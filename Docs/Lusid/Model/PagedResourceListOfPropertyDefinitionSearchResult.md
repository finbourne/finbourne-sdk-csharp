# Finbourne.Sdk.Lusid.Model.PagedResourceListOfPropertyDefinitionSearchResult
...
var instance = new PagedResourceListOfPropertyDefinitionSearchResult(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<PropertyDefinitionSearchResult>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfPropertyDefinitionSearchResult>(json);
```
