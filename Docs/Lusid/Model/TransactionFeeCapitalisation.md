...
|------|------|----------|-------------|
| **Capitalisation** | **string** | Optional | Whether the transaction fee should be capitalised, not capitalised, or conditionally capitalised. The allowed values are Capitalised, NonCapitalised, Conditional. |
