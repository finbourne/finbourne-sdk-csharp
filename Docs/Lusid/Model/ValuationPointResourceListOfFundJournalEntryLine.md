# Finbourne.Sdk.Lusid.Model.ValuationPointResourceListOfFundJournalEntryLine
...
var instance = new ValuationPointResourceListOfFundJournalEntryLine(
    startValuationPoint: new DiaryEntry(...),  // optional
    varVersion: new ModelVersion(...),  // required
    values: new List<FundJournalEntryLine>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ValuationPointResourceListOfFundJournalEntryLine>(json);
```
