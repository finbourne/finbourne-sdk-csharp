# Finbourne.Sdk.Lusid.Model.ValuationPointResourceListOfUnsettledTransaction
...
var instance = new ValuationPointResourceListOfUnsettledTransaction(
    startValuationPoint: new DiaryEntry(...),  // optional
    varVersion: new ModelVersion(...),  // required
    values: new List<UnsettledTransaction>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ValuationPointResourceListOfUnsettledTransaction>(json);
```
...
- [UnsettledTransaction](UnsettledTransaction.md)
- [Link](Link.md)
