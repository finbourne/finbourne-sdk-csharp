# Finbourne.Sdk.Lusid.Model.ResourceListOfProperty
...
var instance = new ResourceListOfProperty(
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfProperty>(json);
```
