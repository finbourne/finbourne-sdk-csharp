# Finbourne.Sdk.Lusid.Model.CustomDataModelPropertySpecification
...
var instance = new CustomDataModelPropertySpecification(
...
```csharp
var instance = JsonConvert.DeserializeObject<CustomDataModelPropertySpecification>(json);
```
