# Finbourne.Sdk.Lusid.Model.ResourceListOfAllocation
...
var instance = new ResourceListOfAllocation(
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfAllocation>(json);
```
