# Finbourne.Sdk.Lusid.Model.PagedResourceListOfFee
...
var instance = new PagedResourceListOfFee(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<Fee>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfFee>(json);
```
