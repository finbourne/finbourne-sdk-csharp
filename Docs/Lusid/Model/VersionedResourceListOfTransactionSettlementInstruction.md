# Finbourne.Sdk.Lusid.Model.VersionedResourceListOfTransactionSettlementInstruction
...
var instance = new VersionedResourceListOfTransactionSettlementInstruction(
    varVersion: new ModelVersion(...),  // required
    values: new List<TransactionSettlementInstruction>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<VersionedResourceListOfTransactionSettlementInstruction>(json);
```
