...
| **MarketDataType** | **string** | Required | Available values: AppendFxForwardCurveByQuoteReference, AppendFxForwardCurveData, AppendFxForwardPipsCurveData, AppendFxForwardTenorCurveData, AppendFxForwardTenorPipsCurveData. Default: `MarketDataTypeEnum.AppendFxForwardCurveByQuoteReference` |
