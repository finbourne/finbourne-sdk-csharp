# Finbourne.Sdk.Lusid.Model.PagedResourceListOfParticipation
...
var instance = new PagedResourceListOfParticipation(
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfParticipation>(json);
```
