...
|------|------|----------|-------------|
| **ComparisonType** | **string** | Required | Available values: Exact, Contains, CaseInsensitive, ContainsAnyCase, IsOneOf, IsOneOfCaseInsensitive. |
...
| **RuleType** | **string** | Required | Available values: ReconcileNumericRule, ReconcileDateTimeRule, ReconcileStringRule, ReconcileExact. Default: `RuleTypeEnum.ReconcileStringRule` |
...
var instance = new ReconcileStringRule(
    comparisonType: "...",  // required — Available values: Exact, Contains, CaseInsensitive, ContainsAnyCase, IsOneOf, IsOneOfCaseInsensitive.
