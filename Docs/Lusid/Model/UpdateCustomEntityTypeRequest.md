# Finbourne.Sdk.Lusid.Model.UpdateCustomEntityTypeRequest
...
var instance = new UpdateCustomEntityTypeRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<UpdateCustomEntityTypeRequest>(json);
```
