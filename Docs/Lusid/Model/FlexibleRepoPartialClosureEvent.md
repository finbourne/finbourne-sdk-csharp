...
| **AmountType** | **string** | Required | AmountType of the cash amount to be exchanged as part of a partial closure of the repurchase agreement.  Either percentage or absolute cash amount. Available values: Percentage, Units. |
...
var instance = new FlexibleRepoPartialClosureEvent(
    ...
    amountType: "...",  // required — AmountType of the cash amount to be exchanged as part of a partial closure of the repurchase agreement.  Either percentage or absolute cash amount. Available values: Percentage, Units.
