# Finbourne.Sdk.Lusid.Model.PagedResourceListOfPortfolioGroupSearchResult
...
var instance = new PagedResourceListOfPortfolioGroupSearchResult(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<PortfolioGroupSearchResult>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfPortfolioGroupSearchResult>(json);
```
