# Finbourne.Sdk.Lusid.Model.Barrier
...
| **Type** | **string** | Required | Supported string (enumeration) values are: [Knockin, Knockout]. |
...
var instance = new Barrier(
    ...
    type: "..."  // required — Supported string (enumeration) values are: [Knockin, Knockout].
);
```
### Serializing to JSON
...
```csharp
var instance = JsonConvert.DeserializeObject<Barrier>(json);
```
