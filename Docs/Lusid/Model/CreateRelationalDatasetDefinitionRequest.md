# Finbourne.Sdk.Lusid.Model.CreateRelationalDatasetDefinitionRequest
...
var instance = new CreateRelationalDatasetDefinitionRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<CreateRelationalDatasetDefinitionRequest>(json);
```
