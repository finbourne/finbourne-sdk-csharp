# Finbourne.Sdk.Lusid.Model.ResourceListOfTransaction
...
var instance = new ResourceListOfTransaction(
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfTransaction>(json);
```
