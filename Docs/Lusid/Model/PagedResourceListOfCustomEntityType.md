# Finbourne.Sdk.Lusid.Model.PagedResourceListOfCustomEntityType
...
var instance = new PagedResourceListOfCustomEntityType(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<CustomEntityType>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfCustomEntityType>(json);
```
