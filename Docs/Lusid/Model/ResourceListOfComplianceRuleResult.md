# Finbourne.Sdk.Lusid.Model.ResourceListOfComplianceRuleResult
...
var instance = new ResourceListOfComplianceRuleResult(
    values: new List<ComplianceRuleResult>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfComplianceRuleResult>(json);
```
