# Finbourne.Sdk.Lusid.Model.CreateStagingRuleSetRequest
...
var instance = new CreateStagingRuleSetRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<CreateStagingRuleSetRequest>(json);
```
