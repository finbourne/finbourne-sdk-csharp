# Finbourne.Sdk.Lusid.Model.UnknownProceedsElection
...
var instance = new UnknownProceedsElection(
...
```csharp
var instance = JsonConvert.DeserializeObject<UnknownProceedsElection>(json);
```
