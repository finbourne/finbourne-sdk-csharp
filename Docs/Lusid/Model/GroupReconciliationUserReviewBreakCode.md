# Finbourne.Sdk.Lusid.Model.GroupReconciliationUserReviewBreakCode

## Properties

| Name | Type | Required | Description |
|------|------|----------|-------------|
| **BreakCode** | **string** | Required | The break code of the reconciliation result. |
...
var instance = new GroupReconciliationUserReviewBreakCode(
    breakCode: "...",  // required — The break code of the reconciliation result.
...
```csharp
var instance = JsonConvert.DeserializeObject<GroupReconciliationUserReviewBreakCode>(json);
```
