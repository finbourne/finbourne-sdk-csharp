# Finbourne.Sdk.Lusid.Model.UpdateReconciliationRequest
...
var instance = new UpdateReconciliationRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<UpdateReconciliationRequest>(json);
```
