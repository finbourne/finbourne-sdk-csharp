# Finbourne.Sdk.Lusid.Model.CustomDataModelIdentifierTypeSpecification
...
var instance = new CustomDataModelIdentifierTypeSpecification(
...
```csharp
var instance = JsonConvert.DeserializeObject<CustomDataModelIdentifierTypeSpecification>(json);
```
