...
|------|------|----------|-------------|
| **ComparisonType** | **string** | Required | Available values: Exact, AbsoluteDifference, RelativeDifference. |
...
| **RuleType** | **string** | Required | Available values: ReconcileNumericRule, ReconcileDateTimeRule, ReconcileStringRule, ReconcileExact. Default: `RuleTypeEnum.ReconcileNumericRule` |
...
var instance = new ReconcileNumericRule(
    comparisonType: "...",  // required — Available values: Exact, AbsoluteDifference, RelativeDifference.
