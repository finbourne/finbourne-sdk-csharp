# Finbourne.Sdk.Lusid.Model.ValuationPointResourceListOfAccountedQuote
...
| **Values** | [List&lt;AccountedQuote&gt;](AccountedQuote.md) | Required | *No description available.* |
...
var instance = new ValuationPointResourceListOfAccountedQuote(
    startValuationPoint: new DiaryEntry(...),  // optional
    varVersion: new ModelVersion(...),  // required
    values: new List<AccountedQuote>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ValuationPointResourceListOfAccountedQuote>(json);
```
...
- [AccountedQuote](AccountedQuote.md)
- [Link](Link.md)
