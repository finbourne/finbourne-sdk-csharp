# Finbourne.Sdk.Lusid.Model.ResourceListOfNavActivityAdjustmentResponse
...
var instance = new ResourceListOfNavActivityAdjustmentResponse(
    values: new List<NavActivityAdjustmentResponse>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfNavActivityAdjustmentResponse>(json);
```
