# Finbourne.Sdk.Lusid.Model.IntermediateSecuritiesDistributionEvent
...
var instance = new IntermediateSecuritiesDistributionEvent(
...
```csharp
var instance = JsonConvert.DeserializeObject<IntermediateSecuritiesDistributionEvent>(json);
```
