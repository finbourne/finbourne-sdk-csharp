# Finbourne.Sdk.Lusid.Model.CustomEntityDefinitionRequest
...
var instance = new CustomEntityDefinitionRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<CustomEntityDefinitionRequest>(json);
```
