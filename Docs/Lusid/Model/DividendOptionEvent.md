# Finbourne.Sdk.Lusid.Model.DividendOptionEvent
...
var instance = new DividendOptionEvent(
...
```csharp
var instance = JsonConvert.DeserializeObject<DividendOptionEvent>(json);
```
