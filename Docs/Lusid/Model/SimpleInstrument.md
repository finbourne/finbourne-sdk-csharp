...
| **AssetClass** | **string** | Required | Available values: InterestRates, FX, Inflation, Equities, Credit, Commodities, Money, Unknown, RealEstate. |
...
var instance = new SimpleInstrument(
    ...
    assetClass: "...",  // required — Available values: InterestRates, FX, Inflation, Equities, Credit, Commodities, Money, Unknown, RealEstate.
