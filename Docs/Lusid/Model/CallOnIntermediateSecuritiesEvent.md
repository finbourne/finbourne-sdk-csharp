...
| **OversubscribeElections** | [List&lt;OversubscribeElection&gt;](OversubscribeElection.md) | Optional | List of possible oversubscribe elections for this event (OVER) — subscribe for more than the entitled amount. |
| **SellEntitlementElections** | [List&lt;SellEntitlementElection&gt;](SellEntitlementElection.md) | Optional | List of possible sell-entitlement elections for this event (SLLE) — sell the intermediate securities rather than exercise. |
...
var instance = new CallOnIntermediateSecuritiesEvent(
    ...
    oversubscribeElections: new List<OversubscribeElection>(),  // optional — List of possible oversubscribe elections for this event (OVER) — subscribe for more than the entitled amount.
    sellEntitlementElections: new List<SellEntitlementElection>(),  // optional — List of possible sell-entitlement elections for this event (SLLE) — sell the intermediate securities rather than exercise.
...
- [OversubscribeElection](OversubscribeElection.md) — used in `OversubscribeElections`
- [SellEntitlementElection](SellEntitlementElection.md) — used in `SellEntitlementElections`
