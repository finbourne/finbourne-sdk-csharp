# Finbourne.Sdk.Lusid.Model.OversubscribeElection
...
var instance = new OversubscribeElection(
...
```csharp
var instance = JsonConvert.DeserializeObject<OversubscribeElection>(json);
```
