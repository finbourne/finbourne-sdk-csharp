# Finbourne.Sdk.Lusid.Model.FundA2BMovementRecord
...
var instance = new FundA2BMovementRecord(
...
```csharp
var instance = JsonConvert.DeserializeObject<FundA2BMovementRecord>(json);
```
