# Finbourne.Sdk.Lusid.Model.ResourceListOfLegalEntity
...
var instance = new ResourceListOfLegalEntity(
...
```csharp
var instance = JsonConvert.DeserializeObject<ResourceListOfLegalEntity>(json);
```
