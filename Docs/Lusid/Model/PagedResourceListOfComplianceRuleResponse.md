# Finbourne.Sdk.Lusid.Model.PagedResourceListOfComplianceRuleResponse
...
var instance = new PagedResourceListOfComplianceRuleResponse(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<ComplianceRuleResponse>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfComplianceRuleResponse>(json);
```
