# Finbourne.Sdk.Lusid.Model.TenderOfferElection
...
|------|------|----------|-------------|
| **TenderOfferCurrency** | **string** | Required | Currency of the cash offer |
| **TenderOfferPrice** | **decimal** | Required | Price per share of the cash offer |
...
var instance = new TenderOfferElection(
    tenderOfferCurrency: "...",  // required — Currency of the cash offer
    tenderOfferPrice: 0.0d,  // required — Price per share of the cash offer
...
```csharp
var instance = JsonConvert.DeserializeObject<TenderOfferElection>(json);
```
