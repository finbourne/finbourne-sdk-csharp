# Finbourne.Sdk.Lusid.Model.Timeline
...
| **DisplayName** | **string** | Optional | The name of the Timeline. |
...
var instance = new Timeline(
    ...
    displayName: "...",  // optional — The name of the Timeline.
...
```csharp
var instance = JsonConvert.DeserializeObject<Timeline>(json);
```
