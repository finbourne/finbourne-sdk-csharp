# Finbourne.Sdk.Lusid.Model.ConsentAndExchangeElection
...
var instance = new ConsentAndExchangeElection(
...
```csharp
var instance = JsonConvert.DeserializeObject<ConsentAndExchangeElection>(json);
```
