...
| **RoundingTarget** | **string** | Optional | The target of the rounding convention.    Default value: All. Available values: All, AccruedInterest, Cashflows. |
| **RoundingType** | **string** | Optional | The type of rounding.  Default value: Nearest. Available values: None, Down, Up, Nearest. |
...
var instance = new RoundingConvention(
    ...
    roundingTarget: "...",  // optional — The target of the rounding convention.    Default value: All. Available values: All, AccruedInterest, Cashflows.
    roundingType: "..."  // optional — The type of rounding.  Default value: Nearest. Available values: None, Down, Up, Nearest.
);
```
### Serializing to JSON
