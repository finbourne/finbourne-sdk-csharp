# Finbourne.Sdk.Lusid.Model.PagedResourceListOfComplianceRunInfoV2
...
var instance = new PagedResourceListOfComplianceRunInfoV2(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<ComplianceRunInfoV2>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfComplianceRunInfoV2>(json);
```
