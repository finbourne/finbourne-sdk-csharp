# Finbourne.Sdk.Lusid.Model.ConsentDeniedElection
...
var instance = new ConsentDeniedElection(
...
```csharp
var instance = JsonConvert.DeserializeObject<ConsentDeniedElection>(json);
```
