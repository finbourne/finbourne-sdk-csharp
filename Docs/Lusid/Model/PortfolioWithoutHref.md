# Finbourne.Sdk.Lusid.Model.PortfolioWithoutHref
...
var instance = new PortfolioWithoutHref(
...
```csharp
var instance = JsonConvert.DeserializeObject<PortfolioWithoutHref>(json);
```
