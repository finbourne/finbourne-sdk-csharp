# Finbourne.Sdk.Lusid.Model.FundValuationSchedule
...
| **DiaryEntry** | **string** | Optional | The diary entry to use for the valuation schedule. This is used to determine the date on which the valuation should be performed. |
| **Variant** | **string** | Optional | The diary entry variant to use, together with the diary entry to be used for the valuation schedule. |
...
var instance = new FundValuationSchedule(
    ...
    diaryEntry: "...",  // optional — The diary entry to use for the valuation schedule. This is used to determine the date on which the valuation should be performed.
...
```csharp
var instance = JsonConvert.DeserializeObject<FundValuationSchedule>(json);
```
