# Finbourne.Sdk.Lusid.Model.UpdateCustomDataModelRequest
...
var instance = new UpdateCustomDataModelRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<UpdateCustomDataModelRequest>(json);
```
