# Finbourne.Sdk.Lusid.Model.CalendarDate
...
| **DateIdentifier** | **string** | Required | *No description available.* |
| **FromUtc** | **DateTimeOffset** | Required | *No description available.* |
| **ToUtc** | **DateTimeOffset** | Required | *No description available.* |
| **LocalDate** | **string** | Required | *No description available.* |
| **Timezone** | **string** | Required | *No description available.* |
...
var instance = new CalendarDate(
    href: "...",  // optional
    dateIdentifier: "...",  // required
...
```csharp
var instance = JsonConvert.DeserializeObject<CalendarDate>(json);
```
