...
| **FeeCode** | **string** | Optional | The code of the Fee. |
...
| **NavTypeCode** | **string** | Optional | When provided runs against the specified NAV Type, otherwise the Primary NAV Type will be used. |
...
var instance = new Fee(
    href: "...",  // optional — The specific Uniform Resource Identifier (URI) for this resource at the requested effective and asAt datetime.
    feeCode: "...",  // optional — The code of the Fee.
    ...
    navTypeCode: "...",  // optional — When provided runs against the specified NAV Type, otherwise the Primary NAV Type will be used.
...
```csharp
var instance = JsonConvert.DeserializeObject<Fee>(json);
```
