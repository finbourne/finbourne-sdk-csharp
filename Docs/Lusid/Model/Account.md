...
| **Type** | **string** | Required | The Account type. Available values: Asset, Liabilities, Income, Expense, Capital, Revenue. |
| **Status** | **string** | Required | The Account status. Available values: Active, Inactive, Deleted. |
| **Control** | **string** | Optional | This allows users to specify whether this a protected Account that prevents direct manual journal adjustment. Default value: Manual. Available values: Manual, System. |
...
var instance = new Account(
    ...
    type: "...",  // required — The Account type. Available values: Asset, Liabilities, Income, Expense, Capital, Revenue.
    status: "...",  // required — The Account status. Available values: Active, Inactive, Deleted.
    control: "...",  // optional — This allows users to specify whether this a protected Account that prevents direct manual journal adjustment. Default value: Manual. Available values: Manual, System.
