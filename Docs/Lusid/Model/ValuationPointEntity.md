# Finbourne.Sdk.Lusid.Model.ValuationPointEntity
...
| **PrevailingValuationPoint** | [FundCalendarEntry](FundCalendarEntry.md) | Optional | *No description available.* |
| **DeletedValuationPoint** | [FundCalendarEntry](FundCalendarEntry.md) | Optional | *No description available.* |
| **PreviewedStatus** | **string** | Optional | The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist. |
| **PreviewedValuationPoint** | [FundCalendarEntry](FundCalendarEntry.md) | Optional | *No description available.* |
...
var instance = new ValuationPointEntity(
    ...
    prevailingValuationPoint: new FundCalendarEntry(...),  // optional
    deletedValuationPoint: new FundCalendarEntry(...),  // optional
    previewedStatus: "...",  // optional — The status of the previewed entity. Available values: Prevailing, Deleted, DoesNotExist.
    previewedValuationPoint: new FundCalendarEntry(...),  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ValuationPointEntity>(json);
```
