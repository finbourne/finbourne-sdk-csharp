...
| **Schedule** | **string** | Required | Whether the compliance run was pre or post trade. Available values: PreTrade, PostTrade, PreAndPostTrade. |
...
var instance = new ComplianceRunInfo(
    ...
    schedule: "...",  // required — Whether the compliance run was pre or post trade. Available values: PreTrade, PostTrade, PreAndPostTrade.
