# Finbourne.Sdk.Lusid.Model.CashDividendEvent
...
var instance = new CashDividendEvent(
    ...
    announcementDate: DateTimeOffset.Now,  // optional — Date on which the dividend is announced by the company.
...
```csharp
var instance = JsonConvert.DeserializeObject<CashDividendEvent>(json);
```
