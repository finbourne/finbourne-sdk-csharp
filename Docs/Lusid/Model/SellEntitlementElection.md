# Finbourne.Sdk.Lusid.Model.SellEntitlementElection
...
var instance = new SellEntitlementElection(
...
```csharp
var instance = JsonConvert.DeserializeObject<SellEntitlementElection>(json);
```
