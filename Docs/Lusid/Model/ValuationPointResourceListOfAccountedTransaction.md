# Finbourne.Sdk.Lusid.Model.ValuationPointResourceListOfAccountedTransaction
...
| **Values** | [List&lt;AccountedTransaction&gt;](AccountedTransaction.md) | Required | *No description available.* |
...
var instance = new ValuationPointResourceListOfAccountedTransaction(
    startValuationPoint: new DiaryEntry(...),  // optional
    varVersion: new ModelVersion(...),  // required
    values: new List<AccountedTransaction>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ValuationPointResourceListOfAccountedTransaction>(json);
```
...
- [AccountedTransaction](AccountedTransaction.md)
- [Link](Link.md)
