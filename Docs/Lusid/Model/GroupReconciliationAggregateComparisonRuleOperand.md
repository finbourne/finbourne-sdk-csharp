# Finbourne.Sdk.Lusid.Model.GroupReconciliationAggregateComparisonRuleOperand
...
var instance = new GroupReconciliationAggregateComparisonRuleOperand(
...
```csharp
var instance = JsonConvert.DeserializeObject<GroupReconciliationAggregateComparisonRuleOperand>(json);
```
