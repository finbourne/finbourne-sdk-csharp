# Finbourne.Sdk.Lusid.Model.ValuationPointResourceListOfFundCashStatementLocalCurrency
...
| **Values** | [List&lt;FundCashStatementLocalCurrency&gt;](FundCashStatementLocalCurrency.md) | Required | *No description available.* |
...
var instance = new ValuationPointResourceListOfFundCashStatementLocalCurrency(
    startValuationPoint: new DiaryEntry(...),  // optional
    varVersion: new ModelVersion(...),  // required
    values: new List<FundCashStatementLocalCurrency>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ValuationPointResourceListOfFundCashStatementLocalCurrency>(json);
```
...
- [FundCashStatementLocalCurrency](FundCashStatementLocalCurrency.md)
- [Link](Link.md)
