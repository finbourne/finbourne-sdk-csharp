# Finbourne.Sdk.Lusid.Model.OptionExerciseElection
...
var instance = new OptionExerciseElection(
...
```csharp
var instance = JsonConvert.DeserializeObject<OptionExerciseElection>(json);
```
