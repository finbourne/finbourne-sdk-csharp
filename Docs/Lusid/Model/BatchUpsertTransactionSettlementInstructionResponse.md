# Finbourne.Sdk.Lusid.Model.BatchUpsertTransactionSettlementInstructionResponse
...
var instance = new BatchUpsertTransactionSettlementInstructionResponse(
...
```csharp
var instance = JsonConvert.DeserializeObject<BatchUpsertTransactionSettlementInstructionResponse>(json);
```
