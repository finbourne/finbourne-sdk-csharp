# Finbourne.Sdk.Lusid.Model.CreateMatchingRulesetRequest
...
var instance = new CreateMatchingRulesetRequest(
...
```csharp
var instance = JsonConvert.DeserializeObject<CreateMatchingRulesetRequest>(json);
```
