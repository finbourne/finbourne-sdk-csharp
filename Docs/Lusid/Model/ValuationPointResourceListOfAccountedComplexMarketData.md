# Finbourne.Sdk.Lusid.Model.ValuationPointResourceListOfAccountedComplexMarketData
...
| **Values** | [List&lt;AccountedComplexMarketData&gt;](AccountedComplexMarketData.md) | Required | *No description available.* |
...
var instance = new ValuationPointResourceListOfAccountedComplexMarketData(
    startValuationPoint: new DiaryEntry(...),  // optional
    varVersion: new ModelVersion(...),  // required
    values: new List<AccountedComplexMarketData>(),  // required
    href: "...",  // optional
    nextPage: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<ValuationPointResourceListOfAccountedComplexMarketData>(json);
```
