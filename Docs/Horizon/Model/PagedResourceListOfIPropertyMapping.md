# Finbourne.Sdk.Horizon.Model.PagedResourceListOfIPropertyMapping
...
var instance = new PagedResourceListOfIPropertyMapping(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<IPropertyMapping>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfIPropertyMapping>(json);
```
