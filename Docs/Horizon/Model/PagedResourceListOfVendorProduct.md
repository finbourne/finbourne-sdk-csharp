# Finbourne.Sdk.Horizon.Model.PagedResourceListOfVendorProduct
...
var instance = new PagedResourceListOfVendorProduct(
    nextPage: "...",  // optional
    previousPage: "...",  // optional
    values: new List<VendorProduct>(),  // required
    href: "...",  // optional
...
```csharp
var instance = JsonConvert.DeserializeObject<PagedResourceListOfVendorProduct>(json);
```
