# Finbourne.Sdk.Luminesce.Api.HistoricallyExecutedQueriesApi
...
|--------|--------------|-------------|
| [**CancelHistory**](#cancelhistory) | **DELETE** `/honeycomb/api/History/{executionId}` | CancelHistory: Cancel / Clear data from a history search |
| [**FetchHistoryResultHistogram**](#fetchhistoryresulthistogram) | **GET** `/honeycomb/api/History/{executionId}/histogram` | FetchHistoryResultHistogram: Make a histogram of results of a history search |
| [**FetchHistoryResultJson**](#fetchhistoryresultjson) | **GET** `/honeycomb/api/History/{executionId}/json` | FetchHistoryResultJson: Fetch JSON results from a query history search |
| [**GetHistory**](#gethistory) | **GET** `/honeycomb/api/History` | GetHistory: Start a background history search |
| [**GetProgressOfHistory**](#getprogressofhistory) | **GET** `/honeycomb/api/History/{executionId}` | GetProgressOfHistory: View progress of a history search |
...
<details>
<summary>Using the CancelHistoryWithHttpInfo variant</summary>
...
<details>
<summary>Using the FetchHistoryResultHistogramWithHttpInfo variant</summary>
...
<details>
<summary>Using the FetchHistoryResultJsonWithHttpInfo variant</summary>
...
| Name | Type | In | Required | Description |
|------|------|----|----------|-------------|
| **startAt** | **DateTimeOffset?** | query | optional | Date time to start the search from.  Will default to Now - 1 Day |
| **endAt** | **DateTimeOffset?** | query | optional | Date time to end the search at.  Defaults to now. |
| **freeTextSearch** | **string?** | query | optional | Some test that must be in at least one field returned. |
| **showAll** | **bool?** | query | optional | For users with extra permissions, they may optionally see other users&#39; queries. Default: `false` |
...
<details>
<summary>Using the GetProgressOfHistoryWithHttpInfo variant</summary>
